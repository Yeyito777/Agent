...
for (var n = {}, t = {}, e = [], u = 0; u < 64; )
  e[u] = 0 | (4294967296 * Math.sin(++u % Math.PI));
const i = r(
  Object.freeze(
    Object.defineProperty(
      {
        ...
        default: function (r) {
          var n,
            t,
            i,
            o = [(n = 1732584193), (t = 4023233417), ~n, ~t],
            f = [],
            a = unescape(encodeURI(r)) + "",
            c = a.length;
          for (r = (--c / 4 + 2) | 15, f[--r] = 8 * c; ~c; )
            f[c >> 2] |= a.charCodeAt(c) << (8 * c--);
          for (u = a = 0; u < r; u += 16) {
            for (
              c = o;
              a < 64;
  ...
  return (
    o ||
      ...
      (Mt.exports = function (r, n, t, e, u) {
        for (n = n.split ? n.split(".") : n, e = 0; e < n.length; e++)
          r = r ? r[n[e]] : u;
        return r === u ? t : r;
      })),
    Mt.exports
 ...
 */ function Lt() {
  ...
  var r = (function () {
    ...
    C = 1;
    var r =
      "function" == typeof Object.defineProperty ? Object.defineProperty : null;
    return (x = r);
  })();
  /**
   * @license Apache-2.0
  ...
  var r,
    ...
    e = (function () {
      ...
      var r = Object.prototype,
        n = r.toString,
        t = r.__defineGetter__,
        e = r.__defineSetter__,
        u = r.__lookupGetter__,
      ...
      return (D = function (o, f, a) {
        ...
        return (
          s && t && t.call(o, f, a.get),
          v && e && e.call(o, f, a.set),
          o
        );
      });
    })();
 ...
 */ function Rt() {
  ...
  var r = (function () {
    ...
    return (B = function (n, t, e) {
      r(n, t, { configurable: !1, enumerable: !1, writable: !1, value: e });
    });
  })();
  /**
   * @license Apache-2.0
 ...
 */ function Wt() {
  ...
  var r = (function () {
    ...
    var r = Vt()();
    return ($ = function () {
      return r && "symbol" == typeof Symbol.toStringTag;
    });
  })();
  /**
   * @license Apache-2.0
 ...
 */ function Yt() {
  ...
  return (pr = function (e) {
    ...
    return ((o = t.call(e)), u ? (e[n] = i) : delete e[n], o);
  });
}
/**
 * @license Apache-2.0
 ...
 */ function zt() {
  ...
  var r = (function () {
    ...
    gr = 1;
    var r = qt(),
      n = "function" == typeof Uint32Array;
    return (br = function (t) {
      return (n && t instanceof Uint32Array) || "[object Uint32Array]" === r(t);
    });
  })();
  /**
   * @license Apache-2.0
 ...
 */ function Zt() {
  ...
  var r = (function () {
    ...
    Cr = 1;
    var r = qt(),
      n = "function" == typeof Float64Array;
    return (xr = function (t) {
      return (
        (n && t instanceof Float64Array) || "[object Float64Array]" === r(t)
      );
    });
  })();
  /**
 ...
 */ function ne() {
  ...
  var r = (function () {
    ...
    return (Xr = function (t) {
      return (n && t instanceof Uint8Array) || "[object Uint8Array]" === r(t);
    });
  })();
  /**
   * @license Apache-2.0
 ...
 */ function ue() {
  ...
  var r = (function () {
    ...
    bn = 1;
    var r = qt(),
      n = "function" == typeof Uint16Array;
    return (hn = function (t) {
      return (n && t instanceof Uint16Array) || "[object Uint16Array]" === r(t);
    });
  })();
  /**
   * @license Apache-2.0
 ...
 */ function ce() {
  ...
  return (Rn = function (r, n, t, f) {
    return ((e[0] = r), (n[f] = u[i]), (n[f + t] = u[o]), n);
  });
}
/**
 * @license Apache-2.0
 ...
 */ function be() {
  if (bt) return ht;
  bt = 1;
  var r = st ? lt : ((st = 1), (lt = 22250738585072014e-324)),
    n = Gt(),
    t = Jt(),
    e = he();
  return (ht = function (u, i, o, f) {
    return t(u) || n(u)
      ? ((i[f] = u), (i[f + o] = 0), i)
      : 0 !== u && e(u) < r
        ? ((i[f] = 4503599627370496 * u), (i[f + o] = -52), i)
        : ((i[f] = u), (i[f + o] = 0), i);
  });
}
/**
        ...
        (h += l((d = p[0]))) < i
          ...
          : h > e
            ? d < 0
              ? n
              : r
            : (h <= u ? ((h += 52), (g = 2220446049250313e-31)) : (g = 1),
              s(y, d),
              (b = y[0]),
              (b &= 2148532223),
              g * v((b |= (h + t) << 20), y[1])));
...
function Se() {
  ...
  function l(r, n, t) {
    Object.entries(n).forEach(function (n) {
      var u = n[0],
        i = n[1],
        o = function (r) {
          "object" == typeof r && null !== r && t(r, i);
        },
        f = "" === u ? r : (0, e.default)(r, u);
      Array.isArray(f) ? f.forEach(o) : o(f);
    });
  }
  function s(r, n) {
    ...
    for (var u in n.map)
      if (n.map.hasOwnProperty(u)) {
        ...
        if (
          (a.length > 1
            ? (a.pop(), (c = (0, e.default)(t, a.join("."))))
            : (c = r),
          "object" == typeof c)
        ) {
          if (i.copy) {
            var l = (0, e.default)(t, i.copy);
            void 0 !== l && (0, o.dset)(r, u, l);
          } else if (i.move) {
            var s = (0, e.default)(t, i.move);
            (void 0 !== s && (0, o.dset)(r, u, s), (0, f.unset)(r, i.move));
          } else i.hasOwnProperty("set") && (0, o.dset)(r, u, i.set);
          if (i.to_string) {
            var v = (0, e.default)(r, u);
            if ("string" == typeof v || ("object" == typeof v && null !== v))
              continue;
            void 0 !== v
        ...
        (t.sample.path
          ? (function (r, t) {
              var i = (0, e.default)(r, t.sample.path),
                o = (0, n.default)(JSON.stringify(i)),
                f = -64,
                a = [];
              p(o.slice(0, 8), a);
              for (var c = 0, l = 0; l < 64 && 1 !== a[l]; l++) c++;
              if (0 !== c) {
                var s = [];
                (p(o.slice(9, 16), s),
                  (f -= c),
  ...
  function p(r, n) {
    for (var t = 0; t < 8; t++)
      for (var e = r[t], u = 128; u >= 1; u /= 2)
        e - u >= 0 ? ((e -= u), n.push(1)) : n.push(0);
  }
  return (
    (t.default = function (r, n) {
      for (var t = r, e = 0, u = n; e < u.length; e++) {
        var i = u[e];
        switch (i.type) {
          case "drop":
            return null;
          ...
          default:
            throw new Error(
              'Transformer of type "'.concat(i.type, '" is unsupported.'),
            );
        }
      }
      return t;
...
function Ue() {
  ...
  var n = r(Ft());
  function t(r, n) {
    if (!Array.isArray(r)) return !0 === e(r, n);
    var f = r[0];
    switch (f) {
      case "!":
        return !t(r[1], n);
      case "or":
        for (var a = 1; a < r.length; a++) if (t(r[a], n)) return !0;
        return !1;
      case "and":
        for (a = 1; a < r.length; a++) if (!t(r[a], n)) return !1;
        return !0;
      case "=":
      case "!=":
        return (function (r, n, e, i) {
          ...
          "object" == typeof r &&
            "object" == typeof n &&
            ((r = JSON.stringify(r)), (n = JSON.stringify(n)));
          switch (e) {
            case "=":
              return r === n;
            case "!=":
      ...
      case ">=":
        return (function (r, n, e, i) {
          u(r) && (r = t(r, i));
          u(n) && (n = t(n, i));
          if ("number" != typeof r || "number" != typeof n) return !1;
          switch (e) {
            case "<=":
              return r <= n;
            case ">=":
      ...
      case "contains":
        return (function (r, n) {
          if ("string" != typeof r || "string" != typeof n) return !1;
                ...
                if (u)
                  for (var v = 0; v < n.length; v++) {
                    if (
                      ...
                      if (0 === r.length && c.length > 0) continue;
                      n = c;
                      continue r;
                    }
                    if (s) return !1;
      ...
      case "lowercase":
        var c = e(r[1], n);
        return "string" != typeof c ? null : c.toLowerCase();
      case "typeof":
        return typeof e(r[1], n);
      case "length":
        return (function (r) {
          if (null === r) return 0;
          if (!Array.isArray(r) && "string" != typeof r) return NaN;
          return r.length;
        })(e(r[1], n));
      default:
        throw new Error("FQL IR could not evaluate for token: ".concat(f));
    }
  }
  function e(r, t) {
  ...
  function u(r) {
    return (
      !!Array.isArray(r) &&
      ((("lowercase" === r[0] || "length" === r[0] || "typeof" === r[0]) &&
        2 === r.length) ||
  ...
  function i(r) {
    for (
      var n = { star: !1, chunk: "", pattern: "" };
      r.length > 0 && "*" === r[0];
    )
      ((r = r.slice(1)), (n.star = !0));
    var t,
      e = !1;
    ...
    return ((n.chunk = r.slice(0, t)), (n.pattern = r.slice(t)), n);
  }
  function o(r, n) {
    for (var t, e, u = { t: "", ok: !1, err: !1 }; r.length > 0; ) {
      ...
      switch (r[0]) {
        case "[":
          ...
          for (var a = !1, c = 0; ; ) {
            ...
            var l,
              s = "";
            if (((l = (t = f(r)).char), (r = t.newChunk), t.err)) return u;
            if (
              ((s = l),
              "-" === r[0] &&
          ...
          break;
        case "?":
          ((n = n.slice(1)), (r = r.slice(1)));
          break;
        case "\\":
          if (0 === (r = r.slice(1)).length) return ((u.err = !0), u);
        default:
          if (r[0] !== n[0]) return u;
          ((n = n.slice(1)), (r = r.slice(1)));
      }
    }
    return ((u.t = n), (u.ok = !0), (u.err = !1), u);
  }
  function f(r) {
    var n = { char: "", newChunk: "", err: !1 };
    return 0 === r.length ||
      "-" === r[0] ||
      "]" === r[0] ||
      ("\\" === r[0] && 0 === (r = r.slice(1)).length)
      ? ((n.err = !0), n)
      : ((n.char = r[0]),
        (n.newChunk = r.slice(1)),
        0 === n.newChunk.length && (n.err = !0),
        n);
  }
  return (
    (Ee.default = function (r, n) {
      if (!n) throw new Error("No matcher supplied!");
      switch (n.type) {
        case "all":
          return !0;
        case "fql":
        ...
        default:
          throw new Error("Matcher of type ".concat(n.type, " unsupported."));
      }
    }),
    Ee
  );
...
var Fe =
    (Pe ||
      ...
      (function (r) {
        ...
        var i = (function () {
          if (Ie) return Me;
          ((Ie = 1), Object.defineProperty(Me, "__esModule", { value: !0 }));
          var r = (function () {
            function r(r) {
            ...
            return (
              (r.prototype.getRulesByDestinationName = function (r) {
                for (var n = [], t = 0, e = this.rules; t < e.length; t++) {
                  var u = e[t];
                  (u.destinationName !== r && void 0 !== u.destinationName) ||
                    n.push(u);
                }
                return n;
              }),
      ...
      (new Fe.Store(r).getRulesByDestinationName(e).forEach(function (r) {
        for (var n = r.matchers, e = r.transformers, i = 0; i < n.length; i++)
          if (
            ...
            ((t.obj = Fe.transform(t.obj, e[i])), null === t.obj)
          )
            return u(null);
      }),
        u(t));
