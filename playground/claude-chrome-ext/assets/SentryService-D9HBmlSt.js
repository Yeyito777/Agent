...
import { c as o, g as a } from "./index-BVS4T5_D.js";
var c =
...
function f(t, e, n, r) {
  var i;
  void 0 === r && (r = !1);
  var s = (m[p] = null !== (i = m[p]) && void 0 !== i ? i : { version: u });
  if (!r && s[t]) {
    var o = new Error(
  ...
  return (
    (s[t] = e),
    n.debug(
      "@opentelemetry/api: Registered a global for " + t + " v" + u + ".",
    ),
    !0
  );
}
function g(t) {
  var e,
    n,
    r = null === (e = m[p]) || void 0 === e ? void 0 : e.version;
  if (r && d(r)) return null === (n = m[p]) || void 0 === n ? void 0 : n[t];
}
function _(t, e) {
  e.debug(
    "@opentelemetry/api: Unregistering a global for " + t + " v" + u + ".",
  );
  var n = m[p];
  n && delete n[t];
}
  ...
  y = (function () {
    ...
    return (
      (t.prototype.debug = function () {
        ...
        return w("debug", this._namespace, t);
      }),
      (t.prototype.error = function () {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        return w("error", this._namespace, t);
      }),
      (t.prototype.info = function () {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        return w("info", this._namespace, t);
      }),
      (t.prototype.warn = function () {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        return w("warn", this._namespace, t);
      }),
      (t.prototype.verbose = function () {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        return w("verbose", this._namespace, t);
      }),
      t
    );
  })();
...
var S = (function () {
    function t() {
      ...
      ((e.setLogger = function (t, n) {
        var r, i, s;
        if ((void 0 === n && (n = { logLevel: v.INFO }), t === e)) {
          var o = new Error(
            "Cannot use diag as the logger for itself. Please use a DiagLogger implementation like ConsoleDiagLogger or a custom implementation",
          );
          return (
            e.error(null !== (r = o.stack) && void 0 !== r ? r : o.message),
            !1
          );
        }
        ...
        var a = g("diag"),
          c = (function (t, e) {
            ...
            return (
              t < v.NONE ? (t = v.NONE) : t > v.ALL && (t = v.ALL),
              (e = e || {}),
              {
          ...
          })(null !== (i = n.logLevel) && void 0 !== i ? i : v.INFO, t);
  ...
  T = S.instance();
function A(t) {
  return (void 0 === t && (t = {}), new x(new Map(Object.entries(t))));
}
function C(t) {
  return Symbol.for(t);
}
var P,
  ...
  M = (function () {
    return function () {
      ...
      for (var e = 0; e < L.length; e++) this[L[e].n] = t(L[e].c);
    };
  })(),
  R = (function () {
    var t = function (e, n) {
  ...
  D = (function (t) {
    ...
    return (R(e, t), (e.prototype.add = function (t, e) {}), e);
  })(I),
  U = (function (t) {
    function e() {
      return (null !== t && t.apply(this, arguments)) || this;
  ...
  $ = (function (t) {
    ...
    return (R(e, t), (e.prototype.record = function (t, e) {}), e);
  })(I),
  j = (function (t) {
    function e() {
      return (null !== t && t.apply(this, arguments)) || this;
  ...
  Y = new G(),
  J = new z();
(((O = P || (P = {}))[(O.INT = 0)] = "INT"), (O[(O.DOUBLE = 1)] = "DOUBLE"));
var Q,
  Z,
  tt = {
    get: function (t, e) {
  ...
  st = (function () {
    ...
    return (
      ...
      (t.prototype.disable = function () {
        (this._getContextManager().disable(), _(rt, S.instance()));
      }),
      t
    );
  })();
(((Z = Q || (Q = {}))[(Z.NONE = 0)] = "NONE"),
  (Z[(Z.SAMPLED = 1)] = "SAMPLED"));
var ot = "0000000000000000",
  at = "00000000000000000000000000000000",
  ct = { traceId: at, spanId: ot, traceFlags: Q.NONE },
  ut = (function () {
    function t(t) {
      (void 0 === t && (t = ct), (this._spanContext = t));
    }
    return (
  ...
  lt = C("OpenTelemetry Context Key SPAN");
function dt(t) {
  return t.getValue(lt) || void 0;
}
function ht() {
  return dt(st.getInstance().active());
}
function pt(t, e) {
...
function ft(t, e) {
  return pt(t, new ut(e));
}
function gt(t) {
  var e;
  return null === (e = dt(t)) || void 0 === e ? void 0 : e.spanContext();
}
var _t = /^([0-9a-f]{32})$/i,
  vt = /^[0-9a-f]{16}$/i;
function bt(t) {
...
function yt(t) {
  return bt(t.traceId) && ((e = t.spanId), vt.test(e) && e !== ot);
  var e;
}
function wt(t) {
  return new ut(t);
}
var St = st.getInstance(),
  xt = (function () {
    function t() {}
    return (
      (t.prototype.startSpan = function (t, e, n) {
        if (
          (void 0 === n && (n = St.active()),
        ...
        if (!(arguments.length < 2)) {
          2 === arguments.length
            ...
            : 3 === arguments.length
              ? ((i = e), (o = n))
              : ((i = e), (s = n), (o = r));
          var a = null != s ? s : St.active(),
            c = this.startSpan(t, i, a),
            u = pt(a, c);
          return St.with(u, o, void 0, c);
        }
      }),
      t
    );
  ...
  Lt = (function () {
    ...
    return (
      ...
      (t.prototype._getTracer = function () {
        ...
        return t ? ((this._delegate = t), this._delegate) : kt;
      }),
      t
    );
  })(),
  ...
  Rt = (function () {
    ...
    return (
      ...
      (t.prototype.getDelegate = function () {
        var t;
        return null !== (t = this._delegate) && void 0 !== t ? t : Mt;
      }),
...
(((Tt = Et || (Et = {}))[(Tt.NOT_RECORD = 0)] = "NOT_RECORD"),
  (Tt[(Tt.RECORD = 1)] = "RECORD"),
  (Tt[(Tt.RECORD_AND_SAMPLED = 2)] = "RECORD_AND_SAMPLED"),
  ((Ct = At || (At = {}))[(Ct.INTERNAL = 0)] = "INTERNAL"),
  (Ct[(Ct.SERVER = 1)] = "SERVER"),
  (Ct[(Ct.CLIENT = 2)] = "CLIENT"),
  (Ct[(Ct.PRODUCER = 3)] = "PRODUCER"),
  (Ct[(Ct.CONSUMER = 4)] = "CONSUMER"),
  ((Ot = Pt || (Pt = {}))[(Ot.UNSET = 0)] = "UNSET"),
  (Ot[(Ot.OK = 1)] = "OK"),
  (Ot[(Ot.ERROR = 2)] = "ERROR"));
var Nt = st.getInstance(),
  It = S.instance(),
  Dt = new ((function () {
    function t() {}
    return (
  ...
  Bt = C("OpenTelemetry Baggage Key");
function Ft(t) {
  return t.getValue(Bt) || void 0;
}
function Gt() {
  return Ft(st.getInstance().active());
}
function zt(t, e) {
...
var Ht = "propagation",
  ...
  qt = (function () {
    function t() {
      ((this.createBaggage = A),
        (this.getBaggage = Ft),
        (this.getActiveBaggage = Gt),
        (this.setBaggage = zt),
        (this.deleteBaggage = Vt));
    }
    return (
      (t.getInstance = function () {
        return (this._instance || (this._instance = new t()), this._instance);
  ...
  Xt = (function () {
    function t() {
      ((this._proxyTracerProvider = new Rt()),
        (this.wrapSpanContext = wt),
        (this.isSpanContextValid = yt),
        (this.deleteSpan = mt),
        (this.getSpan = dt),
        (this.getActiveSpan = ht),
...
let Zt = class {
    ...
    _getLogger() {
      ...
      return t ? ((this._delegate = t), this._delegate) : Jt;
    }
  },
  te = class {
    getLogger(t, e, n) {
    ...
    getDelegate() {
      var t;
      return null !== (t = this._delegate) && void 0 !== t ? t : Qt;
    }
    setDelegate(t) {
      this._delegate = t;
    }
      ...
      : "object" == typeof self
        ...
        : "object" == typeof window
          ...
          : "object" == typeof global
            ? global
            : {},
  ne = Symbol.for("io.opentelemetry.js.api.logs"),
  re = ee;
const ie = class t {
  constructor() {
    this._proxyLoggerProvider = new te();
  }
  static getInstance() {
    return (this._instance || (this._instance = new t()), this._instance);
  }
  ...
  getLoggerProvider() {
    var t, e;
    return null !==
      (e = null === (t = re[ne]) || void 0 === t ? void 0 : t.call(re, 1)) &&
      void 0 !== e
      ? e
  ...
  disable() {
    (delete re[ne], (this._proxyLoggerProvider = new te()));
  }
}.getInstance();
const se = "service.name",
  oe = "telemetry.sdk.language",
  ae = "telemetry.sdk.name",
  ce = "telemetry.sdk.version",
  ue = "process.runtime.name",
  le = { [ae]: "opentelemetry", [ue]: "browser", [oe]: "webjs", [ce]: "2.0.1" };
const de = (t) =>
...
class he {
  ...
  static FromAttributeList(t) {
    const e = new he({});
    return (
      (e._rawAttributes = ge(t)),
      (e._asyncAttributesPending = t.filter(([t, e]) => de(e)).length > 0),
      e
    );
  }
  constructor(t) {
    ...
    ((this._rawAttributes = Object.entries(e).map(
      ([t, e]) => (de(e) && (this._asyncAttributesPending = !0), [t, e]),
    )),
      (this._rawAttributes = ge(this._rawAttributes)));
  }
  ...
  async waitForAsyncAttributes() {
    if (this.asyncAttributesPending) {
      for (let t = 0; t < this._rawAttributes.length; t++) {
        ...
        this._rawAttributes[t] = [e, de(n) ? await n : n];
      }
  ...
  get attributes() {
    ...
    for (const [e, n] of this._rawAttributes)
      de(n)
        ? It.debug(`Unsettled resource attribute ${e} skipped`)
        : null != n && (t[e] ??= n);
...
function pe(t) {
  return he.FromAttributeList(Object.entries(t));
}
function me() {
  return pe({});
}
  ...
  return t.map(([t, e]) =>
    de(e)
      ? [
          t,
          e.catch((e) => {
            It.debug("promise rejection for resource attribute: %s - %s", t, e);
          }),
        ]
      : [t, e],
  );
...
const _e = (t = {}) =>
    (t.detectors || [])
      .map((e) => {
        try {
          const r = ((n = e.detect(t)), new he(n));
          return (It.debug(`${e.constructor.name} found resource.`, r), r);
        } catch (r) {
          return (It.debug(`${e.constructor.name} failed: ${r.message}`), me());
        }
        var n;
      })
      .reduce((t, e) => t.merge(e), me()),
  ve = C("OpenTelemetry SDK Context Key SUPPRESS_TRACING");
function be(t) {
  const e = {};
    ...
    ye(n)
      ? we(r)
        ? Array.isArray(r)
          ? (e[n] = r.slice())
          : (e[n] = r)
        : It.warn(`Invalid attribute value set for key: ${n}`)
      : It.warn(`Invalid attribute key: ${n}`);
  return e;
}
function ye(t) {
...
const Te = performance,
  Ae = "exception.message",
  Ce = "exception.type";
const Pe = Math.pow(10, 6),
  Oe = Math.pow(10, 9);
function ke(t) {
  const e = t / 1e3;
  return [Math.trunc(e), Math.round((t % 1e3) * Pe)];
}
function Le() {
  let t = Te.timeOrigin;
  if ("number" != typeof t) {
...
function Re(t) {
  return Me(t) || "number" == typeof t || t instanceof Date;
}
function Ne(t, e) {
  const n = [t[0] + e[0], t[1] + e[1]];
  return (n[1] >= Oe && ((n[1] -= Oe), (n[0] += 1)), n);
}
var Ie, De;
(((De = Ie || (Ie = {}))[(De.SUCCESS = 0)] = "SUCCESS"),
  (De[(De.FAILED = 1)] = "FAILED"));
const Ue = "[object Null]",
  $e = "[object Undefined]",
...
function We(t) {
  if (
    ...
    "[object Object]" !==
      (function (t) {
        if (null == t) return void 0 === t ? $e : Ue;
        return Ve && Ve in Object(t)
          ? (function (t) {
              const e = ze.call(t, Ve),
                n = t[Ve];
              let r = !1;
              try {
                ((t[Ve] = void 0), (r = !0));
  ...
  const e = Fe(t);
  if (null === e) return !0;
  const n = ze.call(e, "constructor") && e.constructor;
  return "function" == typeof n && n instanceof n && je.call(n) === Be;
}
function qe(t) {
  return Ye(t) ? t.slice() : t;
}
function Ke(t, e, n = 0, r) {
  let i;
  if (!(n > 20)) {
    if ((n++, Ze(t) || Ze(e) || Je(e))) i = qe(e);
    else if (Ye(t)) {
      if (((i = t.slice()), Ye(e)))
        for (let t = 0, n = e.length; t < n; t++) i.push(qe(e[t]));
      else if (Qe(e)) {
      ...
      if (Qe(e)) {
        ...
        for (let o = 0, a = s.length; o < a; o++) {
          const a = s[o],
            c = e[a];
          if (Ze(c)) void 0 === c ? delete i[a] : (i[a] = c);
          else {
            const s = i[a],
              o = c;
            if (Xe(t, a, r) || Xe(e, a, r)) delete i[a];
            else {
              if (Qe(s) && Qe(o)) {
                const n = r.get(s) || [],
                  i = r.get(o) || [];
...
function Qe(t) {
  return !Ze(t) && !Ye(t) && !Je(t) && "object" == typeof t;
}
function Ze(t) {
  return (
    "string" == typeof t ||
...
class nn {
  ...
  constructor(t) {
    ...
    ((this._spanContext = t.spanContext),
      (this._performanceStartTime = Te.now()),
  ...
  setAttribute(t, e) {
    ...
    if (0 === t.length) return (It.warn(`Invalid attribute key: ${t}`), this);
    if (!we(e))
      return (It.warn(`Invalid attribute value set for key: ${t}`), this);
  ...
  addEvent(t, e, n) {
    ...
    if (0 === r)
      return (It.warn("No events allowed."), this._droppedEventsCount++, this);
    (void 0 !== r &&
      this.events.length >= r &&
      (0 === this._droppedEventsCount && It.debug("Dropping extra events."),
      this.events.shift(),
      this._droppedEventsCount++),
      Re(e) && (Re(n) || (n = e), (e = void 0)));
    const i = be(e);
    return (
      this.events.push({
        name: t,
  ...
  _getTime(t) {
    if ("number" == typeof t && t <= Te.now())
      return (
        (e = t + this._performanceOffset),
        Ne(ke(Le()), ke("number" == typeof e ? e : Te.now()))
      );
    var e;
    if ("number" == typeof t) return ke(t);
    if (t instanceof Date) return ke(t.getTime());
    if (Me(t)) return t;
    if (this._startTimeProvided) return ke(Date.now());
    const n = Te.now() - this._performanceStartTime;
    return Ne(this.startTime, ke(n));
  }
  isRecording() {
  ...
  recordException(t, e) {
    ...
    ("string" == typeof t
      ? (n[Ae] = t)
      : t &&
        (t.code ? (n[Ce] = t.code.toString()) : t.name && (n[Ce] = t.name),
        t.message && (n[Ae] = t.message),
        t.stack && (n["exception.stacktrace"] = t.stack)),
      n[Ce] || n[Ae]
        ? this.addEvent("exception", n, e)
        : It.warn(`Failed to record an exception ${t}`));
  }
  get duration() {
  ...
  _truncateToSize(t) {
    ...
    return e <= 0
      ? (It.warn(`Attribute value limit must be positive, got ${e}`), t)
      : "string" == typeof t
...
class on {
  shouldSample() {
    return { decision: rn.RECORD_AND_SAMPLED };
  }
  toString() {
  ...
  constructor(t) {
    ((this._root = t.root),
      this._root ||
        ...
        (this._root = new on())),
      (this._remoteParentSampled = t.remoteParentSampled ?? new on()),
      (this._remoteParentNotSampled = t.remoteParentNotSampled ?? new sn()),
      (this._localParentSampled = t.localParentSampled ?? new on()),
      (this._localParentNotSampled = t.localParentNotSampled ?? new sn()));
  }
  shouldSample(t, e, n, r, i, s) {
    const o = Xt.getSpanContext(t);
    return o && yt(o)
      ? o.isRemote
        ? o.traceFlags & Q.SAMPLED
          ? this._remoteParentSampled.shouldSample(t, e, n, r, i, s)
          : this._remoteParentNotSampled.shouldSample(t, e, n, r, i, s)
        : o.traceFlags & Q.SAMPLED
          ? this._localParentSampled.shouldSample(t, e, n, r, i, s)
          : this._localParentNotSampled.shouldSample(t, e, n, r, i, s)
      : this._root.shouldSample(t, e, n, r, i, s);
  }
  toString() {
...
class cn {
  ...
  shouldSample(t, e) {
    return {
      decision:
        bt(e) && this._accumulate(e) < this._upperBound
          ? rn.RECORD_AND_SAMPLED
          : rn.NOT_RECORD,
    };
  }
  toString() {
...
function ln() {
  ...
  switch (t) {
    ...
    case "parentbased_always_on":
      return new an({ root: new on() });
    case "parentbased_always_off":
      return new an({ root: new sn() });
    case "traceidratio":
      return new cn(dn());
    case "parentbased_traceidratio":
      return new an({ root: new cn(dn()) });
    default:
      return (
        It.error(
...
function dn() {
  return (It.error("OTEL_TRACES_SAMPLER_ARG is blank, defaulting to 1."), 1);
}
const hn = 1 / 0;
class pn {
  _exporter;
    ...
    ((this._exporter = t),
      ...
      (this._exportTimeoutMillis =
        "number" == typeof e?.exportTimeoutMillis
          ...
          : 3e4),
      (this._shutdownOnce = new en(this._shutdown, this)),
  ...
  onEnd(t) {
    this._shutdownOnce.isCalled ||
      (0 !== (t.spanContext().traceFlags & Q.SAMPLED) && this._addToBuffer(t));
  }
  shutdown() {
    ...
    if (this._finishedSpans.length >= this._maxQueueSize)
      return (
        0 === this._droppedSpansCount &&
          It.debug("maxQueueSize reached, dropping spans"),
    ...
    return (
      ...
      0 === this._finishedSpans.length
        ...
        : new Promise((t, e) => {
            ...
            Nt.with(Nt.active().setValue(ve, !0), () => {
              let r;
              ...
              for (let t = 0, e = r.length; t < e; t++) {
                ...
                e.resource.asyncAttributesPending &&
                  ...
                  ((s ??= []), s.push(e.resource.waitForAsyncAttributes()));
              }
              null === s
                ? i()
...
function _n(t) {
  return function () {
    for (let e = 0; e < 2 * t; e++)
      ((gn[e] = Math.floor(16 * Math.random()) + 48),
        gn[e] >= 58 && (gn[e] += 39));
    return String.fromCharCode.apply(null, gn.slice(0, 2 * t));
  };
}
class vn {
  _sampler;
  ...
  constructor(t, e, n, r) {
    ...
    ((this._sampler = i.sampler),
      ...
      (this._idGenerator = e.idGenerator || new fn()),
      (this._resource = n),
      (this._spanProcessor = r),
      (this.instrumentationScope = t));
  }
  startSpan(t, e = {}, n = Nt.active()) {
    e.root && (n = Xt.deleteSpan(n));
    const r = Xt.getSpan(n);
    if (!0 === n.getValue(ve)) {
      It.debug("Instrumentation suppressed, returning Noop Span");
      return Xt.wrapSpanContext(ct);
    }
    const i = r?.spanContext(),
      s = this._idGenerator.generateSpanId();
    let o, a, c;
    i && Xt.isSpanContextValid(i)
      ? ((a = i.traceId), (c = i.traceState), (o = i))
      : (a = this._idGenerator.generateTraceId());
    const u = e.kind ?? At.INTERNAL,
      l = (e.links ?? []).map((t) => ({
        context: t.context,
        attributes: be(t.attributes),
      })),
      d = be(e.attributes),
      h = this._sampler.shouldSample(n, a, t, u, d, l);
    c = h.traceState ?? c;
    const p = {
      traceId: a,
      spanId: s,
      traceFlags: h.decision === Et.RECORD_AND_SAMPLED ? Q.SAMPLED : Q.NONE,
      traceState: c,
    };
    if (h.decision === Et.NOT_RECORD) {
      It.debug("Recording is off, propagating context in a non-recording span");
      return Xt.wrapSpanContext(p);
    }
    const m = be(Object.assign(d, h.attributes));
    return new nn({
  ...
  forceFlush() {
    ...
    return new Promise((e) => {
      Promise.all(t)
        ...
        .catch((t) => {
          (Ee(t || new Error("MultiSpanProcessor: forceFlush failed")), e());
        });
    });
  }
  onStart(t, e) {
...
var yn, wn;
(((wn = yn || (yn = {}))[(wn.resolved = 0)] = "resolved"),
  (wn[(wn.timeout = 1)] = "timeout"),
  (wn[(wn.error = 2)] = "error"),
  (wn[(wn.unresolved = 3)] = "unresolved"));
class Sn {
  _config;
  _tracers = new Map();
  _resource;
  ...
  constructor(t = {}) {
    const e = (function (...t) {
      let e = t.shift();
      const n = new WeakMap();
      for (; t.length > 0; ) e = Ke(e, t.shift(), 0, n);
      return e;
    })(
      {},
      un(),
  ...
  forceFlush() {
        ...
        (e) =>
          new Promise((n) => {
            ...
            e.forceFlush()
              .then(() => {
                (clearTimeout(i),
                  r !== yn.timeout && ((r = yn.resolved), n(r)));
              })
              .catch((t) => {
                (clearTimeout(i), (r = yn.error), n(t));
              });
          }),
      );
    return new Promise((t, n) => {
      Promise.all(e)
        .then((e) => {
          const r = e.filter((t) => t !== yn.resolved);
          r.length > 0 ? n(r) : t();
        })
        .catch((t) => n([t]));
    });
...
class xn {
  ...
  disable() {
    return ((this._currentContext = k), (this._enabled = !1), this);
  }
  enable() {
    return (
      this._enabled || ((this._enabled = !0), (this._currentContext = k)),
      this
    );
  }
  with(t, e, n, ...r) {
    const i = this._currentContext;
    this._currentContext = t || k;
    try {
      return e.call(n, ...r);
    } finally {
...
const En = C("OpenTelemetry SDK Context Key SUPPRESS_TRACING");
function Tn(t) {
  return !0 === t.getValue(En);
}
const An = "baggage";
function Cn(t) {
  const e = t.split(";");
    ...
    return (
      i.split(",").forEach((t) => {
        ...
        if (e) {
          ...
          (e.metadata && (t.metadata = e.metadata), (s[e.key] = t));
        }
      }),
      0 === Object.entries(s).length ? t : qt.setBaggage(t, qt.createBaggage(s))
    );
  }
  fields() {
    return [An];
...
const kn = "[_0-9a-z-*/]",
  Ln = new RegExp(
    `^(?:${`[a-z]${kn}{0,255}`}|${`[a-z0-9]${kn}{0,240}@[a-z]${kn}{0,13}`})$`,
  ),
  Mn = /^[ -~]{0,255}[!-~]$/,
  Rn = /,|=/;
class Nn {
    ...
    t.length > 512 ||
      ((this._internalState = t
        ...
        .reduce((t, e) => {
          ...
          if (-1 !== r) {
            const i = n.slice(0, r),
              s = n.slice(r + 1, e.length);
            (function (t) {
              return Ln.test(t);
            })(i) &&
              (function (t) {
                return Mn.test(t) && !Rn.test(t);
              })(s) &&
              t.set(i, s);
          }
          return t;
...
class $n {
  inject(t, e, n) {
    const r = Xt.getSpanContext(t);
    if (!r || Tn(t) || !yt(r)) return;
    const i = `00-${r.traceId}-${r.spanId}-0${Number(r.traceFlags || Q.NONE).toString(16)}`;
    (n.set(e, In, i), r.traceState && n.set(e, Dn, r.traceState.serialize()));
  }
  extract(t, e, n) {
    const r = n.get(e, In);
    if (!r) return t;
    ...
    if (o) {
      ...
      s.traceState = new Nn("string" == typeof t ? t : void 0);
    }
    return Xt.setSpanContext(t, s);
  }
  fields() {
    return [In, Dn];
  }
...
class jn extends Sn {
  ...
  register(t = {}) {
    var e;
    (Xt.setGlobalTracerProvider(this),
      null !== (e = t.propagator) &&
        (void 0 !== e
          ? qt.setGlobalPropagator(e)
          : qt.setGlobalPropagator(
              new On({ propagators: [new $n(), new Pn()] }),
            )),
      (function (t) {
        if (null !== t) {
          if (void 0 === t) {
            const t = new xn();
            return (t.enable(), void Nt.setGlobalContextManager(t));
          }
          (t.enable(), Nt.setGlobalContextManager(t));
        }
      })(t.contextManager));
  }
}
const Bn = "exception.message",
  Fn = "exception.stacktrace",
  Gn = "exception.type",
  zn = "service.name",
  Vn = "service.version",
  Hn = "user_agent.original",
  Wn = "browser.platform",
  qn = "browser.brands",
  Kn = "browser.mobile",
  Xn = "browser.language",
  Yn = "browser.user_agent";
const Jn = new (class {
    detect(t) {
      if (!("undefined" != typeof navigator)) return me();
      const e = (function () {
        const t = {},
          e = navigator.userAgentData;
        e
          ? ((t[Wn] = e.platform),
            (t[qn] = e.brands.map((t) => `${t.brand} ${t.version}`)),
            (t[Kn] = e.mobile))
          : (t[Yn] = navigator.userAgent);
        return ((t[Xn] = navigator.language), t);
      })();
  ...
  Qn = C("OpenTelemetry SDK Context Key SUPPRESS_TRACING");
function Zn(t) {
  return (
    null == t ||
    (Array.isArray(t)
...
const rr = performance;
const ir = Math.pow(10, 6),
  sr = Math.pow(10, 9);
function or(t) {
  const e = t / 1e3;
  return [Math.trunc(e), Math.round((t % 1e3) * ir)];
}
function ar() {
  let t = rr.timeOrigin;
  if ("number" != typeof t) {
...
function cr(t) {
  return (function (t, e) {
    ...
    n[1] >= sr && ((n[1] -= sr), (n[0] += 1));
    return n;
  })(or(ar()), or("number" == typeof t ? t : rr.now()));
}
function ur(t) {
  if (
    ((e = t),
    ...
    return t;
  if ("number" == typeof t) return t < ar() ? cr(t) : or(t);
  if (t instanceof Date) return or(t.getTime());
...
const hr = "[object Null]",
  pr = "[object Undefined]",
  mr = Function.prototype.toString,
  fr = mr.call(Object),
  gr = Object.getPrototypeOf,
  _r = Object.prototype,
  vr = _r.hasOwnProperty,
  br = Symbol ? Symbol.toStringTag : void 0,
  yr = _r.toString;
function wr(t) {
  if (
    !(function (t) {
    ...
    "[object Object]" !==
      (function (t) {
        if (null == t) return void 0 === t ? pr : hr;
        return br && br in Object(t)
          ? (function (t) {
              const e = vr.call(t, br),
                n = t[br];
              let r = !1;
              try {
                ((t[br] = void 0), (r = !0));
  ...
  const e = gr(t);
  if (null === e) return !0;
  const n = vr.call(e, "constructor") && e.constructor;
  return "function" == typeof n && n instanceof n && mr.call(n) === fr;
}
function Sr(t) {
  return Tr(t) ? t.slice() : t;
}
function xr(t, e, n = 0, r) {
  let i;
  if (!(n > 20)) {
    if ((n++, Pr(t) || Pr(e) || Ar(e))) i = Sr(e);
    else if (Tr(t)) {
      if (((i = t.slice()), Tr(e)))
        for (let t = 0, n = e.length; t < n; t++) i.push(Sr(e[t]));
      else if (Cr(e)) {
        const t = Object.keys(e);
        for (let n = 0, r = t.length; n < r; n++) {
          const r = t[n];
      ...
      if (Cr(e)) {
        ...
        for (let o = 0, a = s.length; o < a; o++) {
          const a = s[o],
            c = e[a];
          if (Pr(c)) void 0 === c ? delete i[a] : (i[a] = c);
          else {
            const s = i[a],
              o = c;
            if (Er(t, a, r) || Er(e, a, r)) delete i[a];
            else {
              if (Cr(s) && Cr(o)) {
                const n = r.get(s) || [],
                  i = r.get(o) || [];
...
function Cr(t) {
  return !Pr(t) && !Tr(t) && !Ar(t) && "object" == typeof t;
}
function Pr(t) {
  return (
    "string" == typeof t ||
...
const Mr = {
    _export: function (t, e) {
      return new Promise((n) => {
        Nt.with(Nt.active().setValue(Qn, !0), () => {
          t.export(e, (t) => {
            n(t);
          });
        });
...
var Dr,
  Ur = (function () {
    ...
    function i(r, i, s) {
      if (r && r[i]) {
        if (!s) return (e("no wrapper function"), void e(new Error().stack));
        if (t(r[i]) && t(s)) {
          var o = r[i],
            a = s(o, i);
          return (
        ...
        if (t) {
          ...
          ((e.noConflict = function () {
            ...
            (e.report = (function () {
              ...
              function h(t, r, i, o, a) {
                if (l)
                  (e.computeStackTrace.augmentStackTraceWithInitialElement(
                    ...
                    m());
                else if (a) d(e.computeStackTrace(a), !0, a);
                else {
                  var c,
                    u = { url: r, line: i, column: o },
                    h = t;
                  ...
                  ((u.func = e.computeStackTrace.guessFunctionName(
                    ...
                    d(
                      { name: c, message: h, mode: "onerror", stack: [u] },
                      !0,
                      null,
                    ));
                }
              ...
              function p(t) {
                d(e.computeStackTrace(t.reason), !0, t.reason);
              }
              function m() {
                var t = l,
                  e = u;
                ((l = null), (u = null), d(t, !1, e));
              }
              function f(t) {
                if (l) {
                  if (u === t) return;
              ...
              return (
                (f.subscribe = function (e) {
                  (!0 !== r && ((n = t.onerror), (t.onerror = h), (r = !0)),
                    !0 !== a &&
            ...
            (e.computeStackTrace = (function () {
              ...
              function c(t, n) {
                ...
                var s = [],
                  o = Math.floor(e.linesOfContext / 2),
                  c = o + (e.linesOfContext % 2),
                  u = Math.max(0, n - o - 1),
                  l = Math.min(i.length, n + c - 1);
                n -= 1;
                for (var d = u; d < l; ++d) a(i[d]) || s.push(i[d]);
              ...
              function h(t, e, n) {
                ...
                return (
                  (n -= 1),
                  s && s.length > n && (i = o.exec(s[n])) ? i.index : null
                );
              }
              function p(e) {
                if (!a(t && t.document)) {
                  ...
                  } else r = new RegExp(u(h).replace(/\s+/g, "\\s+"));
                  if ((s = d(r, o))) return s;
                  if (
                    (i =
                    ...
                    if (
                      ...
                      return s;
                    if ((s = d((r = new RegExp(n)), o))) return s;
                  }
                  return null;
                }
              }
              function m(t) {
                ...
                for (
                  ...
                  if ((n = o.exec(m[_]))) {
                    ...
                    if (!(n = u.exec(m[_]))) continue;
                    (n[3] && n[3].indexOf(" > eval") > -1 && (e = d.exec(n[3]))
                ...
                return f.length
                  ? (f[0] &&
                      ...
                      !f[0].column &&
                      g &&
                      (f[0].column = h(g[1], f[0].url, f[0].line)),
                    {
                      mode: "stack",
                      name: t.name,
                      message: t.message,
                ...
                for (
                  ...
                  if (m !== _ && m !== e.report) {
                    if (
                      ...
                      m.name
                        ? (o.func = m.name)
                        : (r = c.exec(m.toString())) && (o.func = r[1]),
                      void 0 === o.func)
                    )
                      try {
                    ...
                    if ((a = p(m))) {
                      ((o.url = a.url),
                        (o.line = a.line),
                        o.func === i && (o.func = s(o.url, o.line)));
                      var v = / '([^']+)' /.exec(t.message || t.description);
                      v && (o.column = h(v[1], a.url, a.line));
                    }
                    (l["" + m] ? (d = !0) : (l["" + m] = !0), u.push(o));
                  }
                n && u.splice(0, n);
                var b = {
                  mode: "callers",
                      ...
                      if (e) {
                        for (
                          ...
                          if (
                            ...
                            if (
                              (!l.func && l.line && (l.func = s(l.url, l.line)),
                              l.line)
                            )
                              try {
                                l.context = c(l.url, l.line);
                              } catch (d) {}
                            (l.context || (l.context = [o[u + 1]]), a.push(l));
                          }
                        }
                        return a.length
                          ? {
                  ...
                  if (
                    ((i = (function (e) {
                      ...
                      var i,
                        ...
                        f = [];
                      for (var g in m) o(m, g) && !m[g].src && f.push(m[g]);
                      for (var _ = 2; _ < n.length; _ += 2) {
                        ...
                        if ((i = a.exec(n[_])))
                          ...
                          if (y) {
                            ...
                            if (w) {
                              ...
                              S >= 0 &&
                                (v.line =
                                  b + w.substring(0, S).split("\n").length);
                            }
                          }
                        } else if ((i = h.exec(n[_]))) {
                          var x = t.location.href.replace(/#.*$/, ""),
                            E = d(new RegExp(l(n[_ + 1])), [x]);
                          v = {
                            url: x,
                            func: "",
                            args: [],
                        ...
                        if (v) {
                          v.func || (v.func = s(v.url, v.line));
                          var T = c(v.url, v.line),
                            A = T ? T[Math.floor(T.length / 2)] : null;
                          (T &&
              ...
              return (
                (_.augmentStackTraceWithInitialElement = f),
...
function Wr(t, e, n) {
  return {
    timeoutMillis: Vr(t.timeoutMillis ?? e.timeoutMillis ?? n.timeoutMillis),
    concurrencyLimit:
...
function Kr(t) {
  return new qr(t.concurrencyLimit);
}
function Xr() {
  return {
    handleResponse(t) {
...
class Yr {
  ...
  constructor(t, e, n, r, i) {
    ((this._transport = t),
      ...
      (this._timeout = i),
      (this._diagLogger = It.createComponentLogger({
    ...
    null != n
      ? this._promiseQueue.pushPromise(
          this._transport.send(n, this._timeout).then(
            (t) => {
              if ("success" !== t.status)
                "failure" === t.status && t.error
                  ? e({ code: Br.FAILED, error: t.error })
                  : "retryable" === t.status
                    ? e({
                        code: Br.FAILED,
                        error: new zr("Export failed with retryable status"),
                      })
                    : e({
                        code: Br.FAILED,
            ...
            (t) => e({ code: Br.FAILED, error: t }),
          ),
        )
      : e({ code: Br.FAILED, error: new Error("Nothing to send") });
  }
  forceFlush() {
...
function Jr(t, e, n) {
  return (
    (r = { transport: n, serializer: e, promiseHandler: Kr(t) }),
    (i = { timeout: t.timeoutMillis }),
    new Yr(r.transport, r.serializer, Xr(), r.promiseHandler, i.timeout)
  );
  var r, i;
}
const Qr = Math.pow(10, 9);
function Zr(t) {
...
function ti(t) {
  ...
  for (let r = 0; r < t.length; r += 2) {
    const i = Zr(t.charCodeAt(r)),
      s = Zr(t.charCodeAt(r + 1));
    e[n++] = (i << 4) | s;
  }
  return e;
}
...
function si(t) {
  if (void 0 !== t) return ti(t);
}
const oi = {
  encodeHrTime: ni,
  encodeSpanContext: ti,
  encodeOptionalSpanContext: si,
};
function ai(t) {
  ...
  const e = t.useLongBits ?? !0,
    n = t.useHex ?? !1;
  return {
    encodeHrTime: e ? ni : ri,
    encodeSpanContext: n ? ii : ti,
    encodeOptionalSpanContext: n ? ii : si,
  };
}
function ci(t) {
  return { attributes: li(t.attributes), droppedAttributesCount: 0 };
}
function ui(t) {
  return { name: t.name, version: t.version };
}
function li(t) {
  return Object.keys(t).map((e) => di(e, t[e]));
}
function di(t, e) {
  return { key: t, value: hi(e) };
}
function hi(t) {
  const e = typeof t;
  return "string" === e
    ...
    : "number" === e
      ...
      : "boolean" === e
        ...
        : t instanceof Uint8Array
          ? { bytesValue: t }
          : Array.isArray(t)
            ? { arrayValue: { values: t.map(hi) } }
            : "object" === e && null != t
              ? {
                  kvlistValue: {
                    values: Object.entries(t).map(([t, e]) => di(t, e)),
                  },
                }
              : {};
}
function pi(t, e) {
  const n = (function (t) {
    ...
    for (const n of t) {
      const {
        resource: t,
        instrumentationScope: { name: r, version: i = "", schemaUrl: s = "" },
      } = n;
      let o = e.get(t);
      o || ((o = new Map()), e.set(t, o));
      const a = `${r}@${i}:${s}`;
      let c = o.get(a);
      (c || ((c = []), o.set(a, c)), c.push(n));
    }
    return e;
  })(t);
  return Array.from(n, ([t, n]) => ({
    ...
    scopeLogs: Array.from(n, ([, t]) => ({
      scope: ui(t[0].instrumentationScope),
      logRecords: t.map((t) =>
        (function (t, e) {
          return {
...
var fi, gi, _i, vi, bi, yi, wi, Si, xi, Ei;
function Ti(t, e) {
  return Array.from(
    t.map((t) => ({
      scope: ui(t.scope),
        ...
        (function (t, e) {
          const n = {
            ...
            r = (function (t) {
              switch (t) {
                case fi.DELTA:
                  return xi.AGGREGATION_TEMPORALITY_DELTA;
                case fi.CUMULATIVE:
                  return xi.AGGREGATION_TEMPORALITY_CUMULATIVE;
              }
          ...
          switch (t.dataPointType) {
            case bi.SUM:
              ...
              break;
            case bi.GAUGE:
              n.gauge = { dataPoints: Ai(t, e) };
              break;
            case bi.HISTOGRAM:
              n.histogram = { aggregationTemporality: r, dataPoints: Ci(t, e) };
              break;
            case bi.EXPONENTIAL_HISTOGRAM:
  ...
  return {
    resourceMetrics: t.map((t) =>
      (function (t, e) {
        const n = ai(e);
        return {
          resource: ci(t.resource),
          schemaUrl: void 0,
          scopeMetrics: Ti(t.scopeMetrics, n),
        };
      })(t, e),
    ),
  };
...
function ki(t, e) {
  ...
  return {
    ...
    events: t.events.map((t) =>
      (function (t, e) {
        return {
          attributes: t.attributes ? li(t.attributes) : [],
          name: t.name,
...
function Li(t, e) {
  ...
  for (; !s.done; ) {
    ...
    const u = { resource: ci(t), scopeSpans: o, schemaUrl: void 0 };
    (r.push(u), (s = i.next()));
  }
  return r;
}
(((gi = fi || (fi = {}))[(gi.DELTA = 0)] = "DELTA"),
  (gi[(gi.CUMULATIVE = 1)] = "CUMULATIVE"),
  ((vi = _i || (_i = {})).COUNTER = "COUNTER"),
  (vi.GAUGE = "GAUGE"),
  (vi.HISTOGRAM = "HISTOGRAM"),
  (vi.UP_DOWN_COUNTER = "UP_DOWN_COUNTER"),
  (vi.OBSERVABLE_COUNTER = "OBSERVABLE_COUNTER"),
  (vi.OBSERVABLE_GAUGE = "OBSERVABLE_GAUGE"),
  (vi.OBSERVABLE_UP_DOWN_COUNTER = "OBSERVABLE_UP_DOWN_COUNTER"),
  ((yi = bi || (bi = {}))[(yi.HISTOGRAM = 0)] = "HISTOGRAM"),
  (yi[(yi.EXPONENTIAL_HISTOGRAM = 1)] = "EXPONENTIAL_HISTOGRAM"),
  (yi[(yi.GAUGE = 2)] = "GAUGE"),
  (yi[(yi.SUM = 3)] = "SUM"),
  ((Si = wi || (wi = {}))[(Si.DEFAULT = 0)] = "DEFAULT"),
  (Si[(Si.DROP = 1)] = "DROP"),
  (Si[(Si.SUM = 2)] = "SUM"),
  (Si[(Si.LAST_VALUE = 3)] = "LAST_VALUE"),
  (Si[(Si.EXPLICIT_BUCKET_HISTOGRAM = 4)] = "EXPLICIT_BUCKET_HISTOGRAM"),
  (Si[(Si.EXPONENTIAL_HISTOGRAM = 5)] = "EXPONENTIAL_HISTOGRAM"),
  ((Ei = xi || (xi = {}))[(Ei.AGGREGATION_TEMPORALITY_UNSPECIFIED = 0)] =
    "AGGREGATION_TEMPORALITY_UNSPECIFIED"),
  (Ei[(Ei.AGGREGATION_TEMPORALITY_DELTA = 1)] =
    "AGGREGATION_TEMPORALITY_DELTA"),
  (Ei[(Ei.AGGREGATION_TEMPORALITY_CUMULATIVE = 2)] =
    "AGGREGATION_TEMPORALITY_CUMULATIVE"));
const Mi = {
    serializeRequest: (t) => {
      const e = { resourceLogs: pi(t, ai({ useHex: !0, useLongBits: !1 })) };
  ...
  Ni = {
    serializeRequest: (t) => {
      const e = { resourceSpans: Li(t, ai({ useHex: !0, useLongBits: !1 })) };
      return new TextEncoder().encode(JSON.stringify(e));
    },
    deserializeResponse: (t) => {
      if (0 === t.length) return {};
...
class Di {
  ...
  async send(t, e) {
    ...
    for (; "retryable" === r.status && i > 0; ) {
      i--;
      const e = Math.max(Math.min(s, 5e3) + Ii(), 0);
      s *= 1.5;
      ...
      (Object.entries(i).forEach(([t, e]) => {
        ...
        (r.onreadystatechange = () => {
          ...
          r.status >= 200 && r.status <= 299
            ? (It.debug("XHR success"), n({ status: "success" }))
            : r.status && ((t = r.status), [429, 502, 503, 504].includes(t))
              ? n({
                  status: "retryable",
                  retryInMillis: $i(r.getResponseHeader("Retry-After")),
                })
              : 0 !== r.status &&
                n({
                  status: "failure",
  ...
  send(t) {
    return new Promise((e) => {
      navigator.sendBeacon(
        ...
        ? (It.debug("SendBeacon success"), e({ status: "success" }))
...
function Vi(t, e, n, r) {
  ...
  return i
    ? (function (t, e) {
        return Jr(t, e, Ui({ transport: ((n = t), new ji(n)) }));
        var n;
      })(s, e)
    : (function (t, e) {
        return Jr(
...
class Hi extends Gr {
  constructor(t = {}) {
    super(Vi(t, Ni, "v1/traces", { "Content-Type": "application/json" }));
  }
}
var Wi, qi;
(((qi = Wi || (Wi = {}))[(qi.DELTA = 0)] = "DELTA"),
  (qi[(qi.CUMULATIVE = 1)] = "CUMULATIVE"),
  (qi[(qi.LOWMEMORY = 2)] = "LOWMEMORY"));
const Ki = () => fi.CUMULATIVE,
  Xi = (t) => {
    switch (t) {
      case _i.COUNTER:
      case _i.OBSERVABLE_COUNTER:
      case _i.GAUGE:
      case _i.HISTOGRAM:
      case _i.OBSERVABLE_GAUGE:
        return fi.DELTA;
      case _i.UP_DOWN_COUNTER:
      case _i.OBSERVABLE_UP_DOWN_COUNTER:
        return fi.CUMULATIVE;
    }
  },
  Yi = (t) => {
    switch (t) {
...
const Qi = Object.freeze({ type: wi.DEFAULT });
class Zi extends Gr {
  ...
  constructor(t, e) {
    (super(t),
      (this._aggregationSelector = (function (t) {
        return t?.aggregationPreference ?? (() => Qi);
      })(e)),
      (this._aggregationTemporalitySelector = Ji(e?.temporalityPreference)));
  }
  selectAggregation(t) {
...
class ts extends Zi {
  constructor(t) {
    super(
      Vi(t ?? {}, Ri, "v1/metrics", { "Content-Type": "application/json" }),
      t,
    );
  }
}
class es extends Gr {
  constructor(t = {}) {
    super(Vi(t, Mi, "v1/logs", { "Content-Type": "application/json" }));
  }
}
class ns {
  _sessionIdProvider;
...
var os =
  (rs ||
    ...
    (function (t, e) {
        ...
        var i = "function",
          ...
          W = function (t, e) {
            if (typeof t === a)
              return (
                (t = t.replace(/^\s\s*/, "")),
                typeof e === s ? t : t.substring(0, 500)
              );
          },
          q = function (t, e) {
            for (var n, s, a, c, u, l, d = 0; d < e.length && !u; ) {
              var h = e[d],
                p = e[d + 1];
              for (n = s = 0; n < h.length && !u && h[n]; )
                if ((u = h[n++].exec(t)))
                  for (a = 0; a < p.length; a++)
                    ((l = u[++s]),
                      typeof (c = p[a]) === o && c.length > 0
                        ? 2 === c.length
                          ? typeof c[1] == i
            ...
            for (var n in e)
              if (typeof e[n] === o && e[n].length > 0) {
                for (var i = 0; i < e[n].length; i++)
                  if (V(e[n][i], t)) return "?" === n ? r : n;
              } else if (V(e[n], t)) return "?" === n ? r : n;
          ...
          J = function (t, e) {
            ...
            return (
              ...
              (this.getCPU = function () {
                var t = {};
                return ((t[m] = r), q.call(t, v, y.cpu), t);
              }),
              ...
              (this.getEngine = function () {
                var t = {};
                return ((t[l] = r), (t[p] = r), q.call(t, v, y.engine), t);
              }),
              (this.getOS = function () {
                var t = {};
                return (
              ...
              (this.setUA = function (t) {
                return (
                  (v = typeof t === a && t.length > 500 ? W(t, 500) : t),
                  this
                );
              }),
              this.setUA(v),
      ...
      })("object" == typeof window ? window : ss);
    })(is, is.exports)),
  is.exports);
const as = a(os);
var cs, us, ls, ds, hs;
...
class fs extends Error {
  constructor(t) {
    (super(t), Object.setPrototypeOf(this, fs.prototype));
  }
}
function gs(t, e) {
  let n;
...
(((hs = ds || (ds = {}))[(hs.DROP = 0)] = "DROP"),
  (hs[(hs.SUM = 1)] = "SUM"),
  (hs[(hs.LAST_VALUE = 2)] = "LAST_VALUE"),
  (hs[(hs.HISTOGRAM = 3)] = "HISTOGRAM"),
  (hs[(hs.EXPONENTIAL_HISTOGRAM = 4)] = "EXPONENTIAL_HISTOGRAM"));
class bs {
  kind = ds.DROP;
  createAccumulation() {}
  merge(t, e) {}
...
class ws {
  ...
  createAccumulation(t) {
    return new ys(t, this._boundaries, this._recordMinMax);
  }
  merge(t, e) {
    ...
    for (let u = 0; u < i.length; u++) o[u] = i[u] + s[u];
    let a = 1 / 0,
      c = -1 / 0;
    return (
      this._recordMinMax &&
      ...
      new ys(t.startTime, n.buckets.boundaries, this._recordMinMax, {
  ...
  diff(t, e) {
    const n = t.toPointValue(),
      ...
      s = r.buckets.counts,
      o = new Array(i.length);
    for (let a = 0; a < i.length; a++) o[a] = s[a] - i[a];
    return new ys(e.startTime, n.buckets.boundaries, this._recordMinMax, {
      buckets: { boundaries: n.buckets.boundaries, counts: o },
  ...
  toMetricData(t, e, n, r) {
    return {
      ...
      dataPointType: ls.HISTOGRAM,
      dataPoints: n.map(([e, n]) => {
        const i = n.toPointValue(),
          s =
            t.type === us.GAUGE ||
            t.type === us.UP_DOWN_COUNTER ||
            t.type === us.OBSERVABLE_GAUGE ||
            t.type === us.OBSERVABLE_UP_DOWN_COUNTER;
        return {
          attributes: e,
...
class Ss {
  ...
  indexStart;
  indexEnd;
  constructor(t = new xs(), e = 0, n = 0, r = 0) {
    ((this.backing = t),
      (this.indexBase = e),
      (this.indexStart = n),
      (this.indexEnd = r));
...
function Cs(t) {
  ...
  e.setFloat64(0, t);
  return ((2146435072 & e.getUint32(0)) >> 20) - Es;
}
function Ps(t) {
  const e = new DataView(new ArrayBuffer(8));
  e.setFloat64(0, t);
...
class Ls {
  ...
  mapToIndex(t) {
    if (t < As) return this._minNormalLowerBoundaryIndex();
    return (Cs(t) + this._rightShift(Ps(t) - 1, 52)) >> this._shift;
  }
  lowerBoundary(t) {
    const e = this._minNormalLowerBoundaryIndex();
    if (t < e)
      throw new ks(`underflow: ${t} is < minimum lower boundary: ${e}`);
    const n = this._maxNormalLowerBoundaryIndex();
    if (t > n) throw new ks(`overflow: ${t} is > maximum lower boundary: ${n}`);
    return Os(1, t << this._shift);
  }
  get scale() {
...
class Ms {
  ...
  constructor(t) {
    ((this._scale = t),
      (this._scaleFactor = Os(Math.LOG2E, t)),
      (this._inverseFactor = Os(Math.LN2, -t)));
  }
  mapToIndex(t) {
    if (t <= As) return this._minNormalLowerBoundaryIndex() - 1;
    if (0 === Ps(t)) {
      return (Cs(t) << this._scale) - 1;
    }
  ...
  lowerBoundary(t) {
    ...
    if (t >= e) {
      ...
      throw new ks(`overflow: ${t} is > maximum lower boundary: ${e}`);
    }
    ...
    if (t <= n) {
      ...
      throw new ks(`overflow: ${t} is < minimum lower boundary: ${n}`);
    }
...
const Rs = Array.from({ length: 31 }, (t, e) =>
  e > 10 ? new Ms(e - 10) : new Ls(e - 10),
);
function Ns(t) {
  if (t > 20 || t < -10)
    throw new ks(`expected scale >= -10 && <= 20, got: ${t}`);
  return Rs[t + 10];
}
class Is {
  low;
  high;
  static combine(t, e) {
    return new Is(Math.min(t.low, e.low), Math.max(t.high, e.high));
  }
  constructor(t, e) {
...
class Ds {
    ...
    if (
      (0 === t.length
        ...
        : r < t.indexStart && t.indexEnd - r >= this._maxSize
          ? ((i = !0), (o = r), (s = t.indexEnd))
          : r > t.indexEnd &&
            r - t.indexStart >= this._maxSize &&
            ((i = !0), (o = t.indexStart), (s = r)),
      i)
    ) {
  ...
  _highLowAtScale(t, e, n) {
    if (0 === t.length) return new Is(0, -1);
    const r = e - n;
    return new Is(t.indexStart >> r, t.indexEnd >> r);
  }
  ...
  _diffBuckets(t, e, n, r) {
    ...
    for (let o = 0; o < n.length; o++) {
      ...
      (e < 0 && (e += t.backing.length), t.decrementBucket(e, n.at(o)));
    }
    t.trim();
  }
}
class Us {
  _maxSize;
  _recordMinMax;
  kind = ds.EXPONENTIAL_HISTOGRAM;
  constructor(t, e) {
    ((this._maxSize = t), (this._recordMinMax = e));
  }
  createAccumulation(t) {
    return new Ds(t, this._maxSize, this._recordMinMax);
  }
  merge(t, e) {
    const n = e.clone();
    return (n.merge(t), n);
  ...
  toMetricData(t, e, n, r) {
    return {
      descriptor: t,
      aggregationTemporality: e,
      dataPointType: ls.EXPONENTIAL_HISTOGRAM,
      dataPoints: n.map(([e, n]) => {
        const i = n.toPointValue(),
          s =
            t.type === us.GAUGE ||
...
class $s {
  ...
  record(t) {
    ((this._current = t), (this.sampleTime = or(Date.now())));
  }
  setStartTime(t) {
    this.startTime = t;
  }
...
class js {
  ...
  merge(t, e) {
    const n = lr(e.sampleTime) >= lr(t.sampleTime) ? e : t;
    return new $s(t.startTime, n.toPointValue(), n.sampleTime);
  }
  diff(t, e) {
    const n = lr(e.sampleTime) >= lr(t.sampleTime) ? e : t;
    return new $s(e.startTime, n.toPointValue(), n.sampleTime);
  }
  toMetricData(t, e, n, r) {
    return {
      descriptor: t,
      aggregationTemporality: e,
      dataPointType: ls.GAUGE,
...
class Fs {
  ...
  createAccumulation(t) {
    return new Bs(t, this.monotonic);
  }
  merge(t, e) {
    const n = t.toPointValue(),
      r = e.toPointValue();
    return e.reset
      ? new Bs(e.startTime, this.monotonic, r, e.reset)
      : new Bs(t.startTime, this.monotonic, n + r);
  }
  diff(t, e) {
    const n = t.toPointValue(),
      r = e.toPointValue();
    return this.monotonic && n > r
      ? new Bs(e.startTime, this.monotonic, r, !0)
      : new Bs(e.startTime, this.monotonic, r - n);
  }
  toMetricData(t, e, n, r) {
    return {
      descriptor: t,
      aggregationTemporality: e,
      dataPointType: ls.SUM,
      dataPoints: n.map(([t, e]) => ({
        attributes: t,
        startTime: e.startTime,
        endTime: r,
...
class Gs {
  static DEFAULT_INSTANCE = new bs();
  createAggregator(t) {
    return Gs.DEFAULT_INSTANCE;
  }
}
class zs {
  static MONOTONIC_INSTANCE = new Fs(!0);
  static NON_MONOTONIC_INSTANCE = new Fs(!1);
  createAggregator(t) {
    switch (t.type) {
      case us.COUNTER:
      case us.OBSERVABLE_COUNTER:
      case us.HISTOGRAM:
        return zs.MONOTONIC_INSTANCE;
      default:
        return zs.NON_MONOTONIC_INSTANCE;
    }
  }
}
class Vs {
  static DEFAULT_INSTANCE = new js();
  createAggregator(t) {
    return Vs.DEFAULT_INSTANCE;
  }
}
class Hs {
  static DEFAULT_INSTANCE = new ws(
    [0, 5, 10, 25, 50, 75, 100, 250, 500, 750, 1e3, 2500, 5e3, 7500, 1e4],
    !0,
  );
  createAggregator(t) {
    return Hs.DEFAULT_INSTANCE;
  }
}
class Ws {
  _recordMinMax;
...
class qs {
  ...
  createAggregator(t) {
    return new Us(this._maxSize, this._recordMinMax);
  }
}
const Ks = new Gs(),
  Xs = new zs(),
  ...
  Qs = new (class {
    _resolve(t) {
      switch (t.type) {
        case us.COUNTER:
        case us.UP_DOWN_COUNTER:
        case us.OBSERVABLE_COUNTER:
        case us.OBSERVABLE_UP_DOWN_COUNTER:
          return Xs;
        case us.GAUGE:
        case us.OBSERVABLE_GAUGE:
          return Ys;
        case us.HISTOGRAM:
          return t.advice.explicitBucketBoundaries
            ? new Ws(t.advice.explicitBucketBoundaries)
            : Js;
      }
      return (It.warn(`Unable to recognize instrument type: ${t.type}`), Ks);
    }
    createAggregator(t) {
...
function to(t) {
  switch (t.type) {
    ...
    case Zs.LAST_VALUE:
      return Ys;
    case Zs.EXPONENTIAL_HISTOGRAM: {
      const e = t;
      return new qs(e.options?.maxSize, e.options?.recordMinMax);
    }
    case Zs.EXPLICIT_BUCKET_HISTOGRAM: {
      const e = t;
      return null == e.options
        ? Js
        : new Ws(e.options?.boundaries, e.options?.recordMinMax);
    }
    default:
...
class ro {
  ...
  constructor(t) {
    ((this._aggregationSelector = t?.aggregationSelector ?? eo),
      (this._aggregationTemporalitySelector =
        t?.aggregationTemporalitySelector ?? no),
  ...
  async shutdown(t) {
    this._shutdown
      ? It.error("Cannot call shutdown twice.")
      : (null == t?.timeoutMillis
          ? await this.onShutdown()
          : await gs(this.onShutdown(), t.timeoutMillis),
        (this._shutdown = !0));
  }
  async forceFlush(t) {
    this._shutdown
      ? It.warn("Cannot forceFlush on already shutdown MetricReader.")
      : null != t?.timeoutMillis
        ? await gs(this.onForceFlush(), t.timeoutMillis)
...
class io extends ro {
  ...
  async _runOnce() {
    try {
      await gs(this._doRun(), this._exportTimeout);
    } catch (t) {
      if (t instanceof fs)
  ...
  async _doRun() {
    ...
    if (
      ...
      try {
        ...
        (It.debug("Error while resolving async portion of resource: ", r),
          nr(r));
      }
    if (0 === t.scopeMetrics.length) return;
    const n = await Mr._export(this._exporter, t);
    if (n.code !== dr.SUCCESS)
      throw new Error(
...
class so {
  ...
  constructor(t) {
    this._temporalitySelector = t?.temporalitySelector ?? no;
  }
  export(t, e) {
    if (!this._shutdown) return so._sendMetrics(t, e);
    setImmediate(e, { code: dr.FAILED });
  }
  forceFlush() {
    return Promise.resolve();
  }
...
function ao(t, e, n) {
  return (
      ...
      ),
    {
      ...
      unit: n?.unit ?? "",
      valueType: n?.valueType ?? P.DOUBLE,
      advice: n?.advice ?? {},
    }
  );
}
...
class lo {
  ...
  _record(t, e = {}, n = Nt.active()) {
    "number" == typeof t
      ? (this._descriptor.valueType !== P.INT ||
          Number.isInteger(t) ||
          (It.warn(
          ...
          (t = Math.trunc(t)),
          Number.isInteger(t))) &&
        this._writableMetricStorage.record(t, e, n, or(Date.now()))
      : It.warn(
...
class wo {
  ...
  createGauge(t, e) {
    const n = ao(t, us.GAUGE, e),
      r = this._meterSharedState.registerMetricStorage(n);
    return new mo(r, n);
  }
  createHistogram(t, e) {
    const n = ao(t, us.HISTOGRAM, e),
      r = this._meterSharedState.registerMetricStorage(n);
    return new fo(r, n);
  }
  createCounter(t, e) {
    const n = ao(t, us.COUNTER, e),
      r = this._meterSharedState.registerMetricStorage(n);
    return new po(r, n);
  }
  createUpDownCounter(t, e) {
    const n = ao(t, us.UP_DOWN_COUNTER, e),
      r = this._meterSharedState.registerMetricStorage(n);
    return new ho(r, n);
  }
  createObservableGauge(t, e) {
    const n = ao(t, us.OBSERVABLE_GAUGE, e),
      r = this._meterSharedState.registerAsyncMetricStorage(n);
    return new vo(n, r, this._meterSharedState.observableRegistry);
  }
  createObservableCounter(t, e) {
    const n = ao(t, us.OBSERVABLE_COUNTER, e),
      r = this._meterSharedState.registerAsyncMetricStorage(n);
    return new _o(n, r, this._meterSharedState.observableRegistry);
  }
  createObservableUpDownCounter(t, e) {
    const n = ao(t, us.OBSERVABLE_UP_DOWN_COUNTER, e),
      r = this._meterSharedState.registerAsyncMetricStorage(n);
    return new bo(n, r, this._meterSharedState.observableRegistry);
  }
...
class To {
  _aggregator;
  _activeCollectionStorage = new Eo();
  _cumulativeMemoStorage = new Eo();
  _cardinalityLimit;
  ...
  constructor(t, e) {
    ((this._aggregator = t),
      ...
      (this._overflowHashCode = ms(this._overflowAttributes)));
  }
  record(t, e, n, r) {
  ...
  collect() {
    ...
    return ((this._activeCollectionStorage = new Eo()), t);
  }
}
class Ao {
  _aggregator;
  ...
  buildMetrics(t, e, n, r) {
    ...
    if (this._reportHistory.has(t)) {
      ...
      ((s = e.aggregationTemporality),
        (o =
          s === cs.CUMULATIVE
            ? Ao.merge(e.accumulations, i, this._aggregator)
            : Ao.calibrateStartTime(e.accumulations, i, n)));
    } else s = t.selectAggregationTemporality(e.type);
    this._reportHistory.set(t, {
      accumulations: o,
      collectionTime: r,
      aggregationTemporality: s,
    });
    const a = ((c = o), Array.from(c.entries()));
    var c;
    if (0 !== a.length) return this._aggregator.toMetricData(e, s, a, r);
  }
  ...
  _getMergedUnreportedAccumulations(t) {
    ...
    for (const r of n) e = Ao.merge(e, r, this._aggregator);
    return e;
  }
  static merge(t, e, n) {
    const r = t,
...
class Co extends So {
  ...
  constructor(t, e, n, r, i) {
    (super(t),
      ...
      (this._deltaMetricStorage = new To(e, this._aggregationCardinalityLimit)),
      (this._temporalMetricStorage = new Ao(e, r)));
  }
  record(t, e) {
    const n = new Eo();
...
class Ro {
  ...
  observe(t, e, n = {}) {
    ...
    (null == r && ((r = new Eo()), this._buffer.set(t, r)),
      "number" == typeof e
        ? (t._descriptor.valueType !== P.INT ||
            Number.isInteger(e) ||
            (It.warn(
...
class No {
  ...
  _observeCallbacks(t, e) {
    return this._callbacks.map(async ({ callback: n, instrument: r }) => {
      const i = new Mo(r._descriptor.name, r._descriptor.valueType);
...
class jo {
  ...
  metricStorageRegistry = new ko();
  observableRegistry = new No();
  meter;
  constructor(t, e) {
    ((this._meterProviderSharedState = t),
      (this._instrumentationScope = e),
      (this.meter = new wo(this)));
  }
  registerMetricStorage(t) {
    const e = this._registerMetricStorage(t, Io);
    return 1 === e.length ? e[0] : new Lo(e);
  }
  registerAsyncMetricStorage(t) {
    return this._registerMetricStorage(t, Co);
  }
  async collect(t, e, n) {
    const r = await this.observableRegistry.observe(e, n?.timeoutMillis),
      i = this.metricStorageRegistry.getStorages(t);
    if (0 === i.length) return null;
    const s = i.map((n) => n.collect(t, e)).filter(ps);
    return 0 === s.length
      ? { errors: r }
      : {
          scopeMetrics: { scope: this._instrumentationScope, metrics: s },
          errors: r,
        };
  }
      ...
      const r = this._meterProviderSharedState
        ...
        .map(([n, r]) => {
          ...
          const s = r.createAggregator(t),
            o = n.selectCardinalityLimit(t.type),
            a = new e(t, s, Uo(), [n], o);
...
class Bo {
  ...
  getMeterSharedState(t) {
    ...
    return (
      null == n && ((n = new jo(this, t)), this.meterSharedStates.set(e, n)),
      n
    );
  }
  selectAggregations(t) {
    ...
    for (const n of this.metricCollectors)
      e.push([n, to(n.selectAggregation(t))]);
    return e;
  }
}
class Fo {
    ...
    const e = or(Date.now()),
      ...
      i = Array.from(this._sharedState.meterSharedStates.values()).map(
        async (i) => {
          ...
          (null != s?.scopeMetrics && n.push(s.scopeMetrics),
            null != s?.errors && r.push(...s.errors));
        },
      );
    return (
      await Promise.all(i),
...
class zo {
  ...
  constructor(t) {
    "*" === t
      ...
      : ((this._matchAll = !1),
        (this._regexp = new RegExp(zo.escapePattern(t))));
  }
  match(t) {
    return !!this._matchAll || this._regexp.test(t);
  }
  static escapePattern(t) {
    return `^${t.replace(Go, "\\$&").replace("*", ".*")}$`;
  }
...
class Ho {
  ...
  _unitFilter;
  constructor(t) {
    ((this._nameFilter = new zo(t?.name ?? "*")),
      (this._type = t?.type),
      (this._unitFilter = new Vo(t?.unit)));
  }
  getType() {
    return this._type;
  }
...
class Wo {
  ...
  _schemaUrlFilter;
  constructor(t) {
    ((this._nameFilter = new Vo(t?.name)),
      (this._versionFilter = new Vo(t?.version)),
      (this._schemaUrlFilter = new Vo(t?.schemaUrl)));
  }
  getNameFilter() {
    return this._nameFilter;
  }
...
class qo {
  ...
  constructor(t) {
    ...
    (!(function (t) {
      ...
      if (
        null != t.name &&
        (null == t?.instrumentName || zo.hasWildcard(t.instrumentName))
      )
        throw new Error(
      ...
      null != t.attributesProcessors
        ? (this.attributesProcessor = ((e = t.attributesProcessors), new Do(e)))
        : (this.attributesProcessor = Uo()),
      (this.name = t.name),
      (this.description = t.description),
      (this.aggregation = to(t.aggregation ?? { type: Zs.DEFAULT })),
      (this.instrumentSelector = new Ho({
        name: t.instrumentName,
        type: t.instrumentType,
        unit: t.instrumentUnit,
      })),
      (this.meterSelector = new Wo({
        name: t.meterName,
...
class Ko {
  ...
  async shutdown(t) {
    this._shutdown
      ? It.warn("shutdown may only be called once per MeterProvider")
      : ((this._shutdown = !0),
        await Promise.all(
  ...
  async forceFlush(t) {
    this._shutdown
      ? It.warn("invalid attempt to force flush after MeterProvider shutdown")
      : await Promise.all(
...
class Qo {
  ...
  _getLogger() {
    ...
    return t ? ((this._delegate = t), this._delegate) : Yo;
  }
}
class Zo {
  getLogger(t, e, n) {
  ...
  getDelegate() {
    var t;
    return null !== (t = this._delegate) && void 0 !== t ? t : Jo;
  }
  setDelegate(t) {
    this._delegate = t;
  }
      ...
      : "object" == typeof self
        ...
        : "object" == typeof window
          ...
          : "object" == typeof global
            ? global
            : {},
  ea = Symbol.for("io.opentelemetry.js.api.logs"),
  na = ta;
class ra {
  constructor() {
    this._proxyLoggerProvider = new Zo();
  }
  static getInstance() {
  ...
  getLoggerProvider() {
    var t, e;
    return null !==
      (e = null === (t = na[ea]) || void 0 === t ? void 0 : t.call(na, 1)) &&
      void 0 !== e
      ? e
      : this._proxyLoggerProvider;
  }
  ...
  disable() {
    (delete na[ea], (this._proxyLoggerProvider = new Zo()));
  }
}
const ia = ra.getInstance();
class sa {
  hrTime;
  hrTimeObserved;
  spanContext;
  ...
  constructor(t, e, n) {
    const {
      ...
      d = Date.now();
    if (((this.hrTime = ur(r ?? d)), (this.hrTimeObserved = ur(i ?? d)), l)) {
      const t = Xt.getSpanContext(l);
      t && yt(t) && (this.spanContext = t);
    }
  ...
  setAttribute(t, e) {
    return this._isLogRecordReadonly() || null === e
      ? this
      : 0 === t.length
        ? (It.warn(`Invalid attribute key: ${t}`), this)
        : Zn(e) ||
            ("object" == typeof e &&
              !Array.isArray(e) &&
          ...
          ? ((this.totalAttributesCount += 1),
            ...
            !Object.prototype.hasOwnProperty.call(this.attributes, t)
              ? (1 === this.droppedAttributesCount &&
                  It.warn("Dropping extra attributes."),
                this)
              : (Zn(e)
                  ? (this.attributes[t] = this._truncateToSize(e))
                  : (this.attributes[t] = e),
                this))
          : (It.warn(`Invalid attribute value set for key: ${t}`), this);
  }
  setAttributes(t) {
    for (const [e, n] of Object.entries(t)) this.setAttribute(e, n);
    return this;
  ...
  _isLogRecordReadonly() {
    return (
      this._isReadonly &&
        It.warn("Can not execute the operation on emitted log record"),
      this._isReadonly
    );
  }
}
class oa {
  ...
  emit(t) {
    const e = t.context || Nt.active(),
      n = new sa(this._sharedState, this.instrumentationScope, {
        context: e,
        ...t,
      });
...
class la {
  ...
  constructor(t = {}) {
    const e = (function (...t) {
        let e = t.shift();
        const n = new WeakMap();
        for (; t.length > 0; ) e = xr(e, t.shift(), 0, n);
        return e;
      })(
        {},
        {
  ...
  getLogger(t, e, n) {
    if (this._shutdownOnce.isCalled)
      return (It.warn("A shutdown LoggerProvider cannot provide a Logger"), Yo);
    t || It.warn("Logger requested without instrumentation scope name.");
    const r = t || "unknown",
      i = `${r}@${e || ""}:${n?.schemaUrl || ""}`;
    return (
  ...
  shutdown() {
    return this._shutdownOnce.isCalled
      ? (It.warn("shutdown may only be called once per LoggerProvider"),
        this._shutdownOnce.promise)
  ...
  onEmit(t) {
    ...
    if (t.resource.asyncAttributesPending) {
      const n = t.resource
        ...
        .then(() => (this._unresolvedExports.delete(n), e()), nr);
...
class pa {
  constructor(t = {}) {
    var e, n, r;
    if (
      ((this._resource = fe().merge(
        null !== (e = t.resource) && void 0 !== e ? e : pe({}),
      )),
      (this._resourceDetectors =
        null !== (n = t.resourceDetectors) && void 0 !== n ? n : [Jn]),
      ...
      (t.traceExporter && n.push(new mn(t.traceExporter)),
  ...
  start() {
    ...
    if (this._autoDetectResources) {
      ...
      this._resource = this._resource.merge(_e(t));
    }
    ((this._resource =
      void 0 === this._serviceName
        ? this._resource
        : this._resource.merge(pe({ [zn]: this._serviceName }))),
      void 0 !== this._serviceVersion &&
        (this._resource = this._resource.merge(
          pe({ [Vn]: this._serviceVersion }),
        )));
    const s = [];
    ((null === (t = this._tracerProviderConfig) || void 0 === t
      ? void 0
      : t.spanProcessor) && s.push(this._tracerProviderConfig.spanProcessor),
    ...
    const o = new jn(
      Object.assign(
        ...
        { resource: this._resource, spanProcessors: s },
      ),
    );
    if (
      ...
      ((this._meterProvider = new Ko({ resource: this._resource, readers: t })),
        $t.setGlobalMeterProvider(this._meterProvider));
    }
    if (this._loggerProviderConfig) {
      const t = this._loggerProviderConfig.logExporters.map((t) => new ha(t));
      ((this._loggerProvider = new la({
        resource: this._resource,
        processors: t,
      })),
        ia.setGlobalLoggerProvider(this._loggerProvider));
    }
    !(function (t) {
      const e = t.tracerProvider || Xt.getTracerProvider(),
        n = t.meterProvider || $t.getMeterProvider(),
        r = t.loggerProvider || ie.getLoggerProvider(),
        i = t.instrumentations?.flat() ?? [];
      (function (t, e, n, r) {
        for (let i = 0, s = t.length; i < s; i++) {
          const s = t[i];
          (e && s.setTracerProvider(e),
...
const ma = "https://api.honeycomb.io",
  fa = "v1/traces",
  ga = `${ma}/${fa}`,
  _a = "v1/metrics",
  va = `${ma}/${_a}`,
  ...
  Sa = (t) => `@honeycombio/opentelemetry-web: ${t}`,
  xa = /^[a-f0-9]*$/,
  Ea = /^hc[a-z]ic_[a-z0-9]*$/;
function Ta(t) {
  return (
    null != t &&
    0 !== t.length &&
    (32 === t.length ? xa.test(t) : 64 === t.length && Ea.test(t))
  );
}
function Aa(t, e) {
...
const Ca = (t) =>
  ...
  Ra = Sa(
    `❌ Missing Service Name. Set \`serviceName\` in HoneycombOptions. Defaulting to '${wa.serviceName}'`,
  ),
  Na =
    (Sa("🔕 Dataset is ignored in favor of service name."),
    Sa(
    ...
    Sa("🔕 Default honeycomb exporter disabled but no exporters provided"),
    (t) => {
      var e, n;
      (null == t ? void 0 : t.logLevel) ? t.logLevel : v.DEBUG;
      if (null == t ? void 0 : t.skipOptionsValidation) return void v.DEBUG;
      const r =
      ...
      if (
        ...
        return (
          !(null == t ? void 0 : t.apiKey) && v.WARN,
          !(null == t ? void 0 : t.serviceName) && v.WARN,
          (null == t ? void 0 : t.apiKey) &&
            !Ta(null == t ? void 0 : t.apiKey) &&
          ...
          (null == t ? void 0 : t.apiKey) &&
            ...
            !(null == t ? void 0 : t.dataset) &&
            v.WARN,
          (null == t ? void 0 : t.sampler) && v.DEBUG,
...
function Ia(t) {
  ...
  (It.setLogger(new M(), v.DEBUG),
    It.debug(Sa("🐝 Honeycomb Web SDK Debug Mode Enabled 🐝")));
  const e = Ca(t),
    n = Object.assign(Object.assign(Object.assign({}, wa), t), {
      tracesEndpoint: e,
    });
  (!(function (t) {
    const e = ka(t) || "";
    if (!e) return void It.debug(Ma);
    It.debug(Sa(`API Key configured for traces: '${e}'`));
  })(n),
    (function (t) {
      const e = t.serviceName || wa.serviceName;
      if (e === wa.serviceName) return void It.debug(Ra);
      It.debug(
    ...
    (function (t) {
      const e = Ca(t);
      if (!e) return void It.debug(Sa("No endpoint configured for traces"));
      It.debug(Sa(`Endpoint configured for traces: '${e}'`));
    })(n),
    (function (t) {
      const e = La(t);
      if (!e) return void It.debug("No sampler configured for traces");
      It.debug(Sa(`Sample Rate configured for traces: '${e}'`));
    })(n));
}
const Da = (t) => {
...
class Ua {
  constructor(t) {
    switch (((this._sampleRate = t), t)) {
      case 0:
        this._sampler = new sn();
        break;
      case 1:
        this._sampler = new on();
        break;
      default: {
        const e = 1 / t;
        this._sampler = new cn(e);
        break;
      }
    }
  }
...
const ja = () => {
    ...
    try {
      for (; 9 !== t?.nodeType; ) {
        const n = t,
          r = n.id
            ? "#" + n.id
            : [Fa(n), ...Array.from(n.classList).sort()].join(".");
  ...
  za = new WeakMap();
function Va(t, e) {
  return (za.get(t) || za.set(t, new e()), za.get(t));
}
let Ha = -1;
const Wa = () => Ha,
  qa = (t) => {
    addEventListener(
      "pageshow",
      (e) => {
        e.persisted && ((Ha = e.timeStamp), t(e));
      },
      !0,
    );
  },
...
const ec = () =>
  ...
  nc = (t) => {
    "hidden" === document.visibilityState &&
      tc > -1 &&
      ((tc = "visibilitychange" === t.type ? t.timeStamp : 0), ic());
  },
  rc = () => {
    (addEventListener("visibilitychange", nc, !0),
      addEventListener("prerenderingchange", nc, !0));
  },
  ic = () => {
    (removeEventListener("visibilitychange", nc, !0),
      removeEventListener("prerenderingchange", nc, !0));
  },
  sc = () => {
    if (tc < 0) {
      const t = Ya(),
        ...
        for (const e of t)
          "first-contentful-paint" === e.name &&
            ...
            e.startTime < n.firstHiddenTime &&
              ((i.value = Math.max(e.startTime - Ya(), 0)),
              i.entries.push(e),
              r(!0)));
      });
      s &&
        ((r = Ka(t, i, ac, e.reportAllChanges)),
        qa((n) => {
          ((i = Ja("FCP")),
            (r = Ka(t, i, ac, e.reportAllChanges)),
            Xa(() => {
  ...
  uc = [0.1, 0.25],
  lc = (t) => t.find((t) => 1 === t.node?.nodeType) || t[0];
let dc = 0,
  hc = 1 / 0,
  pc = 0;
const mc = (t) => {
  for (const e of t)
    e.interactionId &&
      ((hc = Math.min(hc, e.interactionId)),
      (pc = Math.max(pc, e.interactionId)),
      (dc = pc ? (pc - hc) / 7 + 1 : 0));
};
let fc;
const gc = () => (fc ? dc : (performance.interactionCount ?? 0));
let _c = 0;
class vc {
  l = [];
  h = new Map();
  ...
  p;
  v() {
    ((_c = gc()), (this.l.length = 0), this.h.clear());
  }
  M() {
    const t = Math.min(this.l.length - 1, Math.floor((gc() - _c) / 50));
    return this.l[t];
  }
  u(t) {
...
const bc = (t) => {
  ...
  yc = [200, 500],
  wc = (t, e = {}) => {
    const n = Va((e = Object.assign({}, e)), vc);
    let r = [],
      i = [],
      s = 0;
    const o = new WeakMap(),
    ...
    const u = () => {
      ...
      l = () => {
        ...
        const a = new Set();
        for (const n of i) {
          const t = d(n.startTime, n.processingEnd);
    ...
    ((n.m = (t) => {
      ...
      (n ||
        ...
        i.push(n)),
        (t.interactionId || "first-input" === t.entryType) && o.set(t, n),
        u());
    }),
      (n.p = (t) => {
        if (!a.get(t)) {
          const n = (e.generateTarget ?? Ga)(t.entries[0].target);
          a.set(t, n);
        }
      }));
    const d = (t, e) => {
      ...
      ((t, e = {}) => {
        globalThis.PerformanceEventTiming &&
          ...
          oc(() => {
            ...
            ((n = Ka(t, r, yc, e.reportAllChanges)),
              o &&
        ...
        const r = ((t) => {
          const e = t.entries[0],
            r = o.get(e),
            i = e.processingStart,
            s = Math.max(e.startTime + e.duration, i),
            c = Math.min(r.processingEnd, s),
            u = r.entries.sort((t, e) => t.processingStart - e.processingStart),
            l = d(e.startTime, c),
            h = n.h.get(e.interactionId),
            p = {
              interactionTarget: a.get(h),
          ...
          return (
            ((t) => {
              ...
              let i,
                ...
                c = 0,
                u = 0;
              for (const h of t.longAnimationFrameEntries) {
                a = a + h.startTime + h.duration - h.styleAndLayoutStart;
                for (const t of h.scripts) {
...
const xc = [2500, 4e3],
  ...
  Tc = (t) => {
    document.prerendering
      ...
      : "complete" !== document.readyState
        ? addEventListener("load", () => Tc(t), !0)
        : setTimeout(t);
  },
  Ac = "browser.name",
  Cc = "browser.version",
  Pc = "browser.touch_screen_enabled",
  Oc = "browser.width",
  kc = "browser.height",
  Lc = "device.type",
  Mc = "network.effectiveType",
  Rc = "screen.width",
  Nc = "screen.height",
  Ic = "screen.size",
  Dc = "page.hash",
  ...
  Gc = "entry_page.url",
  zc = "entry_page.path",
  Vc = "entry_page.search",
  Hc = "entry_page.hash",
  Wc = "entry_page.hostname",
  qc = "entry_page.referrer",
  Kc = "honeycomb.distro.version",
  Xc = "honeycomb.distro.runtime_version",
  Yc = "cls.id",
  Jc = "cls.value",
  Qc = "cls.delta",
  Zc = "cls.rating",
  tu = "cls.navigation_type",
  eu = "lcp.id",
  nu = "lcp.value",
  ru = "lcp.delta",
  iu = "lcp.rating",
  su = "lcp.navigation_type",
  ou = "inp.id",
  au = "inp.value",
  cu = "inp.delta",
  uu = "inp.rating",
  lu = "inp.navigation_type",
  du = "fcp.id",
  hu = "fcp.value",
  pu = "fcp.delta",
  mu = "fcp.rating",
  fu = "fcp.navigation_type",
  gu = "ttfb.id",
  _u = "ttfb.value",
  vu = "ttfb.delta",
  bu = "ttfb.rating",
  yu = "ttfb.navigation_type",
  wu = "cls.largest_shift_target",
  Su = "cls.element",
  xu = "cls.largest_shift_time",
  Eu = "cls.largest_shift_value",
  Tu = "cls.load_state",
  Au = "cls.had_recent_input",
  Cu = "lcp.element",
  Pu = "lcp.url",
  Ou = "lcp.time_to_first_byte",
  ku = "lcp.resource_load_delay",
  Lu = "lcp.resource_load_duration",
  Mu = "lcp.element_render_delay",
  Ru = "lcp.resource_load_time",
  Nu = "inp.input_delay",
  Iu = "inp.interaction_target",
  Du = "inp.interaction_time",
  Uu = "inp.interaction_type",
  $u = "inp.load_state",
  ju = "inp.next_paint_time",
  Bu = "inp.presentation_delay",
  Fu = "inp.processing_duration",
  Gu = "inp.duration",
  zu = "inp.element",
  Vu = "inp.event_type",
  Hu = "inp.timing.script.entry_type",
  Wu = "inp.timing.script.start_time",
  qu = "inp.timing.script.execution_start",
  Ku = "inp.timing.script.duration",
  Xu = "inp.timing.script.forced_style_and_layout_duration",
  Yu = "inp.timing.script.invoker",
  Ju = "inp.timing.script.pause_duration",
  Qu = "inp.timing.script.source_url",
  Zu = "inp.timing.script.source_function_name",
  tl = "inp.timing.script.source_char_position",
  el = "inp.timing.script.window_attribution",
  nl = "inp.timing.duration",
  rl = "inp.timing.entryType",
  il = "inp.timing.name",
  sl = "inp.timing.renderStart",
  ol = "inp.timing.startTime",
  al = "fcp.time_to_first_byte",
  cl = "fcp.time_since_first_byte",
  ul = "fcp.load_state",
  ll = "ttfb.waiting_duration",
  dl = "ttfb.dns_duration",
  hl = "ttfb.connection_duration",
  pl = "ttfb.request_duration",
  ml = "ttfb.cache_duration",
  fl = "ttfb.waiting_time",
  gl = "ttfb.dns_time",
  _l = "ttfb.connection_time",
  vl = "ttfb.request_time";
class bl {
  constructor(t, e, n = {}) {
    ((this.instrumentationName = t),
      (this.instrumentationVersion = e),
      (this._wrap = Ur.wrap),
      (this._unwrap = Ur.unwrap),
      (this._massWrap = Ur.massWrap),
      (this._massUnwrap = Ur.massUnwrap),
      (this._config = Object.assign({ enabled: !0 }, n)),
      (this._diag = It.createComponentLogger({ namespace: t })),
      (this._tracer = Xt.getTracer(t, e)),
      (this._meter = $t.getMeter(t, e)),
...
class yl extends bl {
  constructor({
    ...
    (super("@honeycombio/instrumentation-web-vitals", Rr, {
      enabled: t,
      vitalsToTrack: e,
      lcp: n,
      cls: r,
      ...
      (this.onReportCLS = (t, e = {}) => {
        ...
        (l.setAttributes({
          ...
          [Eu]: a,
          [Tu]: c,
          [Au]: null == u ? void 0 : u.hadRecentInput,
        }),
          n && n(t, l),
          l.end());
      }),
      (this.onReportLCP = (t, e = {}) => {
        ...
        (p.setAttributes({
          ...
          this.addDataAttributes(null == h ? void 0 : h.element, p, r, "lcp"),
          n && n(t, p),
          p.end());
      }),
        ...
        const { name: s, attribution: o } = t,
          {
            ...
            nextPaintTime: h,
            presentationDelay: p,
            processingDuration: m,
            longAnimationFrameEntries: f,
          } = o,
          g = a + m + p;
        this.tracer.startActiveSpan(s, { startTime: u }, (e) => {
          const s = {
            [ou]: t.id,
            [cu]: t.delta,
            [au]: t.value,
      ...
      (this.onReportFCP = (t, e = {}) => {
        ...
        if (!this.isEnabled()) return;
        const { name: r, attribution: i } = t,
          { timeToFirstByte: s, firstByteToFCP: o, loadState: a } = i,
      ...
      (this.onReportTTFB = (t, e = {}) => {
        ...
        const { name: r, attribution: i } = t,
          ...
          d = this.tracer.startSpan(r);
        (d.setAttributes(l), n && n(t, d), d.end());
      }),
  ...
  _setupWebVitalsCallbacks() {
    (this.vitalsToTrack.includes("CLS") &&
      ((t, e = {}) => {
        const n = Va((e = Object.assign({}, e)), $a),
          r = new WeakMap();
        ((n.t = (t) => {
          if (t?.sources?.length) {
            const n = lc(t.sources);
            if (n) {
              const t = (e.generateTarget ?? Ga)(n.node);
              r.set(n, t);
            }
          }
        }),
            ...
            cc(
              Za(() => {
                ...
                const i = Va(e, $a),
                  ...
                  o = Qa("layout-shift", s);
                o &&
                  ((n = Ka(t, r, uc, e.reportAllChanges)),
                  document.addEventListener("visibilitychange", () => {
                    "hidden" === document.visibilityState &&
                      (s(o.takeRecords()), n(!0));
                  }),
      ...
      this.vitalsToTrack.includes("LCP") &&
        ((t, e = {}) => {
          const n = Va((e = Object.assign({}, e)), Sc),
            r = new WeakMap();
          ((n.m = (t) => {
            if (t.element) {
            ...
            ((t, e = {}) => {
              oc(() => {
                ...
                const s = Va(e, Sc),
                  ...
                  a = Qa("largest-contentful-paint", o);
                if (a) {
                  r = Ka(t, i, xc, e.reportAllChanges);
                  const n = Za(() => {
                    (o(a.takeRecords()), a.disconnect(), r(!0));
                  });
                  for (const t of ["keydown", "click", "visibilitychange"])
                    addEventListener(t, () => bc(n), { capture: !0, once: !0 });
                  qa((n) => {
                    ((i = Ja("LCP")),
                      (r = Ka(t, i, xc, e.reportAllChanges)),
                      Xa(() => {
                    ...
                    const i = n.activationStart || 0,
                      ...
                      o =
                        ...
                        performance
                          ...
                          .filter((t) => t.name === s.url)[0],
                      a = Math.max(0, n.responseStart - i),
                      c = Math.max(
                        a,
                        o ? (o.requestStart || o.startTime) - i : 0,
                      ),
                      u = Math.min(
                        t.value,
                        Math.max(c, o ? o.responseEnd - i : 0),
                      );
                    ((e = {
                      target: r.get(s),
                      timeToFirstByte: a,
      ...
      this.vitalsToTrack.includes("TTFB") &&
        ((t, e = {}) => {
          ((t, e = {}) => {
            let n = Ja("TTFB"),
              r = Ka(t, n, Ec, e.reportAllChanges);
            Tc(() => {
              const i = ja();
              i &&
                ((n.value = Math.max(i.responseStart - Ya(), 0)),
                (n.entries = [i]),
                r(!0),
                qa(() => {
                  ((n = Ja("TTFB", 0)),
            ...
            const n = ((t) => {
              ...
              if (t.entries.length) {
                const n = t.entries[0],
                  ...
                  s = Math.max(n.domainLookupStart - r, 0),
              ...
              if (t.entries.length) {
                ...
                if (n) {
                  ...
                  e = {
                    ...
                    loadState: Ba(t.entries[0].startTime),
                    navigationEntry: n,
                    fcpEntry: r,
                  };
                }
  ...
  getAttributesForPerformanceScriptTiming(t) {
    return {
      ...
      [qu]: t.executionStart,
      [Ku]: t.duration,
      [Xu]: t.forcedStyleAndLayoutDuration,
      [Yu]: t.invoker,
      [Ju]: t.pauseDuration,
      [Qu]: t.sourceURL,
      [Zu]: t.sourceFunctionName,
      [tl]: t.sourceCharPosition,
      [el]: t.windowAttribution,
    };
  }
...
const wl = "@honeycombio/instrumentation-global-errors";
function Sl(t, e = {}, n = Xt.getTracer(wl), r) {
  const i = t.message,
    s = t.name,
    o = Object.assign(
      Object.assign(
        { [Gn]: s, [Bn]: i, [Fn]: t.stack },
        (function (t) {
          if (!t) return {};
          const e = Fr.computeStackTrace(t).stack,
            n = [],
            r = [],
            i = [],
            s = [];
    ...
    a = n.startSpan("exception", { attributes: o }, Nt.active());
  (r && r(a, t), a.setStatus({ code: Pt.ERROR, message: i }), a.end());
}
class xl extends bl {
  constructor({ enabled: t = !0, applyCustomAttributesOnSpan: e } = {}) {
    (super(wl, Rr, { enabled: t, applyCustomAttributesOnSpan: e }),
      (this.onError = (t) => {
        const e = "reason" in t ? t.reason : t.error;
        e && Sl(e, {}, this.tracer, this.applyCustomAttributesOnSpan);
      }),
      t && this.enable(),
      (this._isEnabled = t),
...
const El = "x-honeycomb-team",
  Tl = "x-honeycomb-dataset";
  ...
  return (
    ...
    Ta(e) &&
      (r && (null == t ? void 0 : t.metricsDataset)
        ? (i[Tl] = null == t ? void 0 : t.metricsDataset)
        : (null == t ? void 0 : t.dataset) &&
          (i[Tl] = null == t ? void 0 : t.dataset)),
    i
  );
}
const Cl = (t = "") => {
...
class Pl {
  constructor(t, e, n, r, i) {
    if (
      ((this._traceUrl = ""),
      (this._logLevel = v.DEBUG),
      n && (this._logLevel = n),
      !t || !e)
    )
      return (this._logLevel, void v.DEBUG);
    if (!r || !i) return (this._logLevel, void v.DEBUG);
    fetch(r, { headers: { "x-honeycomb-team": e } })
      ...
      .then((n) => {
        ...
        this._traceUrl = (function (t, e, n, r, i) {
          let s = `${i}/${n}`;
          !Ta(t) && r && (s += `/environments/${r}`);
          return ((s += `/datasets/${e}/trace?trace_id`), s);
        })(
          e,
          t,
          null === (s = a.team) || void 0 === s ? void 0 : s.slug,
          null === (o = a.environment) || void 0 === o ? void 0 : o.slug,
          i,
        );
      })
      .catch(() => {
        (this._logLevel, v.INFO);
      });
  }
  export(t, e) {
    (this._traceUrl &&
      t.forEach((t) => {
        ...
        !(null === (e = t.parentSpanContext) || void 0 === e
          ? void 0
          : e.spanId) && (this._logLevel, v.INFO);
      }),
      e({ code: dr.SUCCESS }));
  }
  shutdown() {
  ...
  return (
    (null == t ? void 0 : t.localVisualizations) &&
      e.push(
        (function (t) {
          const e = ka(t),
            { authRoot: n, uiRoot: r } = Cl(
              (null == t ? void 0 : t.tracesEndpoint) || Ca(t),
            );
          return new Pl(
    ...
    !0 !== (null == t ? void 0 : t.disableDefaultTraceExporter) &&
      e.unshift(
        (function (t) {
          ...
          return new Hi({
            url: Ca(t),
            headers: Al(t, e, null == t ? void 0 : t.tracesHeaders),
            timeoutMillis:
...
function kl(t) {
  ...
  return (
    ...
    !0 !== (null == t ? void 0 : t.disableDefaultMetricExporter) &&
      e.unshift(
        (function (t) {
          ...
          return new ts({
            url: Pa(t),
            headers: Al(t, e, null == t ? void 0 : t.metricsHeaders, !0),
            timeoutMillis:
    ...
    (null == t ? void 0 : t.localVisualizations) && e.push(new so()),
    e
  );
}
function Ll(t) {
  ...
  return (
    e.push(
      (function (t) {
        ...
        return new es({
          url: Oa(t),
          headers: Al(t, e, null == t ? void 0 : t.logsHeaders),
          timeoutMillis:
    ...
    (null == t ? void 0 : t.localVisualizations) && e.push(new da()),
    e
  );
}
class Ml {
  ...
  export(t, e) {
    (this._exporters.forEach((n) => n.export(t, e)), e({ code: dr.SUCCESS }));
  }
  async shutdown() {
    const t = [];
...
class Rl {
  ...
  onStart(t, e) {
    ...
    (null !==
      (r =
        null === (n = qt.getBaggage(e)) || void 0 === n
          ? void 0
...
const Il = new fn().generateTraceId(),
  Dl = { getSessionId: () => Il },
  Ul = (t) => {
    const e = [];
    var n;
    return (
      (null == t ? void 0 : t.disableBrowserAttributes) || e.push(new Nl()),
      e.push(
        new Rl(),
        ((n = (null == t ? void 0 : t.sessionProvider) || Dl), new ns(n)),
  ...
  $l = "browser.language",
  jl = "browser.mobile",
  Bl = "telemetry.distro.name",
  Fl = "telemetry.distro.version";
const Gl = {
  path: !0,
  hash: !0,
  hostname: !0,
...
function zl(t) {
  ...
  const e = (function (t) {
      if (!t) return Gl;
      return Object.assign(Object.assign({}, Gl), t);
    })(t),
    { href: n, pathname: r, search: i, hash: s, hostname: o } = window.location;
  return pe({
    [Gc]: Vl(e.url, n),
    [zc]: Vl(e.path, r),
    [Vc]: Vl(e.search, i),
    [Hc]: Vl(e.hash, s),
    [Wc]: Vl(e.hostname, o),
    [qc]: Vl(e.referrer, document.referrer),
  });
}
function Vl(t, e) {
  if (t) return e;
  ...
  const {
    ...
    return {
      ...
      deviceType:
        ((i = e.getDevice().type),
        (s = n),
        i || s ? i || "desktop" : "unknown"),
    };
    var i, s;
  })(navigator.userAgent);
  var r, i, s;
  return pe({
    [Hn]: navigator.userAgent,
    [jl]: navigator.userAgent.includes("Mobi"),
    [Pc]: navigator.maxTouchPoints > 0,
    ...
    [Mc]:
      ...
      null !== (s = null == i ? void 0 : i.effectiveType) && void 0 !== s
        ? s
        : "unknown"),
    [Rc]: window.screen.width,
    [Nc]: window.screen.height,
    [Ic]:
...
const Wl = (t) => {
  ...
  return (
    (null == t ? void 0 : t.disableBrowserAttributes) ||
      (e = e.merge(zl(null == t ? void 0 : t.entryPageAttributes)).merge(Hl())),
    (e = e.merge(
      pe({
        [Kc]: Rr,
        [Xc]: "browser",
        [Bl]: "@honeycombio/opentelemetry-web",
        [Fl]: Rr,
      }),
    )),
    (null == t ? void 0 : t.resource) && (e = e.merge(t.resource)),
    (null == t ? void 0 : t.resourceAttributes) &&
      (e = e.merge(pe(t.resourceAttributes))),
    e
  );
};
class ql extends pa {
  constructor(t) {
    ...
    (!1 !==
      ...
      void 0 === e
        ? void 0
        : e.enabled) &&
      r.push(new yl(null == t ? void 0 : t.webVitalsInstrumentationConfig)),
      !1 !==
        (null ===
        ...
        void 0 === n
          ...
          : n.enabled) &&
        r.push(
          new xl(null == t ? void 0 : t.globalErrorsInstrumentationConfig),
        ),
      super(
        Object.assign(Object.assign({}, t), {
          ...
          spanProcessors: Ul(t),
          traceExporter: Ol(t),
          metricExporters: kl(t),
          logExporters: Ll(t),
        }),
      ),
      Na(t),
      (null == t ? void 0 : t.debug) && Ia(t));
  }
}
const Kl = "claude-browser-extension";
async function Xl(t, e, n) {
  return Xt.getTracer(Kl).startActiveSpan(
    t,
    { kind: At.INTERNAL },
    n ? Xt.setSpan(Nt.active(), n) : Nt.active(),
    async (t) => {
      try {
        const n = await e(t);
        return (t.setStatus({ code: Pt.OK }), n);
      } catch (n) {
        throw (
          t.setStatus({ code: Pt.ERROR, message: n.message }),
          t.recordException(n),
          n
        );
      } finally {
...
class Ql {
  ...
  async checkPermission(t, n) {
    ...
    const { host: r } = new URL(t);
    if (!this.forcePrompt && this.isTurnApprovedDomain(r))
      return { allowed: !0, needsPrompt: !1 };
    await this.loadPermissions();
    const i = this.findApplicablePermission(r, n);
    return i
      ? ((i.lastUsed = Date.now()),
        await this.savePermissions(),
        { allowed: i.action === e.ALLOW, permission: i })
      : (this.forcePrompt, { allowed: !1, needsPrompt: !0 });
  }
  async checkDomainTransition(t, n) {
    if (this.bypassLocalhostForMcp) {
      const e = this.isLocalhostDomain(t),
        r = this.isLocalhostDomain(n);
      if (r) return { allowed: !0, needsPrompt: !1 };
      if (e && !r) return { allowed: !1, needsPrompt: !0 };
    }
    if (this.forcePrompt) return { allowed: !1, needsPrompt: !0 };
    if (this.isTurnApprovedDomain(n)) return { allowed: !0, needsPrompt: !1 };
    await this.loadPermissions();
    const r = this.permissions.filter(
        (e) =>
          "domain_transition" === e.scope.type &&
          e.scope.fromDomain === t &&
          e.scope.toDomain === n,
      ),
      i = r.find((t) => t.action === e.DENY);
    if (i)
      return (
        (i.lastUsed = Date.now()),
        await this.savePermissions(),
        { allowed: !1, permission: i }
      );
    const s = r.find((t) => t.action === e.ALLOW);
    return s
      ? ((s.lastUsed = Date.now()),
        await this.savePermissions(),
        { allowed: !0, permission: s })
      : { allowed: !1, needsPrompt: !0 };
  }
  async grantPermission(t, r, i) {
    const s = {
      ...
      duration: r,
      createdAt: Date.now(),
      toolUseId: r === n.ONCE ? i : void 0,
    };
    (this.permissions.push(s), await this.savePermissions(), this.clearCache());
  }
  async denyPermission(t, r) {
    if (r === n.ONCE) return;
    const i = {
      id: crypto.randomUUID(),
      scope: t,
    ...
    (r === n.ALWAYS && this.permissions.push(i),
      await this.savePermissions(),
      this.clearCache());
  }
  ...
  async clearOncePermissions() {
    ...
    this.permissions = this.permissions.filter((t) => t.duration !== n.ONCE);
  ...
  findApplicablePermission(t, r) {
    const i = `${t}:${r || "no-tool"}`;
    if (this.cache.has(i)) return this.cache.get(i);
    if (r) {
      const e = this.permissions.find(
        (e) =>
          e.duration === n.ONCE &&
          e.toolUseId === r &&
          "netloc" === e.scope.type &&
      ...
      if (e) return (this.revokePermission(e.id), e);
    }
    this.permissions.forEach((t) => {});
    const s = this.permissions.filter(
        (e) =>
          "netloc" === e.scope.type &&
          e.duration !== n.ONCE &&
          e.scope.netloc &&
      ...
      o = s.find((t) => t.action === e.DENY);
    if (o) return (this.cache.set(i, o), o);
    const a = s.find((t) => t.action === e.ALLOW);
    return a ? (this.cache.set(i, a), a) : null;
  }
    ...
    return (
      ...
      this.permissions.some(
        (r) =>
          ...
          r.action === e.ALLOW &&
          r.scope.netloc &&
          this.matchesNetloc(t, r.scope.netloc),
      )
    );
  }
  matchesNetloc(t, e) {
  ...
  async loadPermissions() {
    try {
      const t = await r(i.PERMISSION_STORAGE);
  ...
  async savePermissions() {
    try {
      ...
      await s(i.PERMISSION_STORAGE, t);
    } catch (t) {}
  }
  setupStorageListener() {
    chrome.storage.onChanged.addListener((t, e) => {
      "local" === e &&
        t[i.PERMISSION_STORAGE] &&
...
const Zl = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__,
  td = globalThis,
  ed = "10.22.0";
function nd() {
  return (rd(td), td);
...
function rd(t) {
  ...
  return ((e.version = e.version || ed), (e[ed] = e[ed] || {}));
}
function id(t, e, n = td) {
  const r = (n.__SENTRY__ = n.__SENTRY__ || {}),
    i = (r[ed] = r[ed] || {});
  return i[t] || (i[t] = e());
}
const sd = ["debug", "info", "warn", "error", "log", "assert", "trace"],
  od = {};
function ad(t) {
  if (!("console" in td)) return t();
  const e = td.console,
    n = {},
    r = Object.keys(od);
  r.forEach((t) => {
...
function ud(t, ...e) {
  Zl &&
    cd() &&
    ad(() => {
      td.console[t](`Sentry Logger [${t}]:`, ...e);
    });
}
function ld() {
  return Zl ? id("loggerSettings", () => ({ enabled: !1 })) : { enabled: !1 };
}
const dd = {
    enable: function () {
      ld().enabled = !0;
...
function fd(...t) {
  ...
  return (t, n = 0, r = 0) => {
    ...
    for (let o = n; o < s.length; o++) {
      ...
      const n = pd.test(t) ? t.replace(pd, "$1") : t;
      if (!n.match(/\S*Error: /)) {
        for (const t of e) {
          const e = t(n);
          if (e) {
    ...
    return (function (t) {
      ...
      /sentryWrapped/.test(gd(e).function || "") && e.pop();
      (e.reverse(),
        md.test(gd(e).function || "") &&
          (e.pop(), md.test(gd(e).function || "") && e.pop()));
      return e
        .slice(0, 50)
        .map((t) => ({
          ...t,
          filename: t.filename || gd(e).filename,
          function: t.function || hd,
        }));
    })(i.slice(r));
  };
}
...
function vd(t) {
  try {
    return (t && "function" == typeof t && t.name) || _d;
  } catch {
    return _d;
  }
}
...
function xd(t, e) {
  if (!wd[t]) {
    ...
    try {
      ...
      Zl && dd.error(`Error while instrumenting ${t}`, n);
    }
  }
}
function Ed(t, e) {
...
function Ad() {
  ((Td = td.onerror),
    (td.onerror = function (t, e, n, r, i) {
      return (
        Ed("error", { column: r, error: i, line: n, msg: t, url: e }),
        !!Td && Td.apply(this, arguments)
      );
    }),
    (td.onerror.__SENTRY_INSTRUMENTED__ = !0));
}
let Cd = null;
function Pd() {
  ((Cd = td.onunhandledrejection),
    (td.onunhandledrejection = function (t) {
      return (Ed("unhandledrejection", t), !Cd || Cd.apply(this, arguments));
    }),
    (td.onunhandledrejection.__SENTRY_INSTRUMENTED__ = !0));
}
...
function Ld(t, e) {
  return Od.call(t) === `[object ${e}]`;
}
function Md(t) {
  return Ld(t, "ErrorEvent");
}
function Rd(t) {
  return Ld(t, "DOMError");
}
function Nd(t) {
  return Ld(t, "String");
}
...
function Dd(t) {
  return (
    null === t || Id(t) || ("object" != typeof t && "function" != typeof t)
  );
}
function Ud(t) {
  return Ld(t, "Object");
...
function $d(t) {
  return "undefined" != typeof Event && Bd(t, Event);
}
function jd(t) {
...
function zd(t, e = {}) {
  ...
  try {
    ...
    for (
      ...
      s++ < r &&
      ((u = Vd(n, l)),
      !("html" === u || (s > 1 && o + i.length * c + u.length >= d)));
    )
...
function Vd(t, e) {
  const n = t,
    r = [];
  if (!n?.tagName) return "";
  if (Gd.HTMLElement && n instanceof HTMLElement && n.dataset) {
...
function Hd() {
  try {
    return Gd.document.location.href;
  } catch {
    return "";
  }
}
...
function qd(t, e) {
  ...
  for (let r = 0; r < t.length; r++) {
    const e = t[r];
    try {
      Fd(e) ? n.push("[VueViewModel]") : n.push(String(e));
    } catch {
...
function Kd(t, e, n = !1) {
  return (
    !!Nd(t) &&
    (Ld(e, "RegExp") ? e.test(t) : !!Nd(e) && (n ? t === e : t.includes(e)))
  );
}
function Xd(t, e = [], n = !1) {
  return e.some((e) => Kd(t, e, n));
}
function Yd(t, e, n) {
  if (!(e in t)) return;
  const r = t[e];
  ...
  const i = n(r);
  "function" == typeof i && Qd(i, r);
  try {
    t[e] = i;
  } catch {
    Zl && dd.log(`Failed to replace method "${e}" in object`, t);
  }
}
function Jd(t, e, n) {
  try {
    ...
    Zl && dd.log(`Failed to add non-enumerable property "${e}" to object`, t);
  }
}
function Qd(t, e) {
  try {
    const n = e.prototype || {};
    ((t.prototype = e.prototype = n), Jd(t, "__sentry_original__", e));
  } catch {}
}
function Zd(t) {
...
function th(t) {
  if (kd(t))
    return { message: t.message, name: t.name, stack: t.stack, ...nh(t) };
  if ($d(t)) {
    const e = {
      type: t.type,
      target: eh(t.target),
      currentTarget: eh(t.currentTarget),
      ...nh(t),
    };
    return (
...
function eh(t) {
  try {
    return (
      (e = t),
      "undefined" != typeof Element && Bd(e, Element)
        ? zd(t)
...
function ih(
  ...
  return (
    rh || (rh = "10000000100040008000100000000000"),
    rh.replace(/[018]/g, (t) =>
...
function hh() {
  return (
    dh ??
    (dh = (function () {
      const { performance: t } = td;
      if (!t?.now || !t.timeOrigin) return lh;
...
function _h() {
  return ih().substring(16);
}
const vh = "_sentrySpan";
function bh(t, e) {
  e ? Jd(t, vh, e) : delete t[vh];
}
function yh(t) {
  return t[vh];
}
class wh {
  ...
  setUser(t) {
    return (
      ...
      this._session && mh(this._session, { user: t }),
  ...
  update(t) {
    ...
    const e = "function" == typeof t ? t(this) : t,
      n = e instanceof wh ? e.getScopeData() : Ud(e) ? t : void 0,
      {
        tags: r,
        extra: i,
        user: s,
  ...
  clear() {
    return (
      ...
      bh(this, void 0),
      (this._attachments = []),
      this.setPropagationContext({ traceId: gh(), sampleRand: Math.random() }),
      this._notifyScopeListeners(),
      this
    );
  }
  addBreadcrumb(t, e) {
    ...
    const r = {
      timestamp: lh(),
      ...t,
      message: t.message ? Wd(t.message, 2048) : t.message,
    };
    return (
  ...
  setSDKProcessingMetadata(t) {
    return (
      (this._sdkProcessingMetadata = fh(this._sdkProcessingMetadata, t, 2)),
      this
    );
  }
  ...
  captureMessage(t, e, n) {
    const r = n?.event_id || ih();
    if (!this._client)
      return (
        Zl &&
          dd.warn("No client configured on scope - will not capture message!"),
        r
      );
    const i = new Error(t);
    return (
  ...
  captureEvent(t, e) {
    ...
    return this._client
      ...
      : (Zl &&
          dd.warn("No client configured on scope - will not capture event!"),
        n);
  }
...
function xh() {
  ...
  return (t.stack =
    t.stack ||
    new Sh(
      id("defaultCurrentScope", () => new wh()),
      id("defaultIsolationScope", () => new wh()),
    ));
}
function Eh(t) {
  return xh().withScope(t);
}
function Th(t, e) {
  const n = xh();
...
function Ah(t) {
  return xh().withScope(() => t(xh().getIsolationScope()));
}
function Ch(t) {
  const e = rd(t);
  return e.acs
    ? e.acs
    : {
        withIsolationScope: Ah,
        withScope: Eh,
        withSetScope: Th,
        withSetIsolationScope: (t, e) => Ah(e),
        getCurrentScope: () => xh().getScope(),
        getIsolationScope: () => xh().getIsolationScope(),
      };
}
function Ph() {
  return Ch(nd()).getCurrentScope();
}
function Oh() {
  return Ch(nd()).getIsolationScope();
}
function kh() {
  return Ph().getClient();
}
function Lh(t) {
  const e = t.getPropagationContext(),
    ...
    s = { trace_id: n, span_id: i || _h() };
  return (r && (s.parent_span_id = r), s);
}
const Mh = "sentry.profile_id",
  Rh = "sentry.exclusive_time";
function Nh(t) {
  if (t) {
...
function Ih(t) {
  const e = t;
  return { scope: e._sentryScope, isolationScope: Nh(e._sentryIsolationScope) };
}
const Dh = /^sentry-/;
function Uh(t) {
  const e = (function (t) {
    if (!t || (!Nd(t) && !Array.isArray(t))) return;
    if (Array.isArray(t))
      return t.reduce((t, e) => {
        const n = $h(e);
        return (
    ...
    (function (t) {
      ...
      return !(
        ["protocol", "publicKey", "host", "projectId"].find(
          (e) => !t[e] && (dd.error(`Invalid Sentry Dsn: ${e} missing`), !0),
        ) ||
        (n.match(/^\d+$/)
          ? (function (t) {
            ...
            ? e &&
              isNaN(parseInt(e, 10)) &&
              (dd.error(`Invalid Sentry Dsn: Invalid port ${e}`), 1)
            : (dd.error(`Invalid Sentry Dsn: Invalid protocol ${r}`), 1)
          : (dd.error(`Invalid Sentry Dsn: Invalid projectId ${n}`), 1))
      );
    })(e)
  )
    return e;
...
function Wh(t) {
  const { spanId: e, traceId: n, isRemote: r } = t.spanContext(),
    i = r ? e : Yh(t).parent_span_id,
    s = Ih(t).scope;
  return {
    parent_span_id: i,
    span_id: r ? s?.getPropagationContext().propagationSpanId || _h() : e,
    trace_id: n,
  };
}
function qh(t) {
      ...
      parent_span_id:
        "parentSpanId" in t
          ...
          : "parentSpanContext" in t
            ...
            : void 0,
      start_timestamp: Kh(i),
      timestamp: Kh(o) || void 0,
      status: Jh(a),
      op: r["sentry.op"],
...
function ep(t, e) {
  ...
  for (const n of e) {
    if (rp(n)) {
      if (Kd(t.description, n)) return (Zl && tp(t), !0);
      continue;
    }
    if (!n.name && !n.op) continue;
    const e = !n.name || Kd(t.description, n.name),
      r = !n.op || (t.op && Kd(t.op, n.op));
    if (e && r) return (Zl && tp(t), !0);
  }
  return !1;
}
function np(t, e) {
...
function op(t) {
  ...
  const u = s?.get("sentry.dsc"),
    l = u && Uh(u);
  if (l) return a(l);
  const d = sp(t.spanContext().traceId, e),
    h = i["sentry.source"],
    p = r.description;
  return (
    "url" !== h && p && (d.transaction = p),
    (function () {
      if ("boolean" == typeof __SENTRY_TRACING__ && !__SENTRY_TRACING__)
        return !1;
      const t = kh()?.getOptions();
      ...
      (d.sample_rand =
        ...
        Ih(n).scope?.getPropagationContext().sampleRand.toString())),
    a(d),
    e.emit("createDsc", d, n),
    d
  );
}
function ap(t, e = 100, n = 1 / 0) {
  try {
    return up("", t, e, n);
  } catch (r) {
...
function up(
  ...
  const a = (function (t, e) {
    try {
      ...
      if ("function" == typeof e) return `[Function: ${vd(e)}]`;
...
function mp(t) {
  ...
  function i(t) {
    "string" == typeof r
      ? (r = "string" == typeof t ? r + t : [pp(r), t])
      : r.push("string" == typeof t ? pp(t) : t);
  }
  for (const s of n) {
    const [t, e] = s;
    if (
...
function fp(t) {
  const e = "string" == typeof t.data ? pp(t.data) : t.data;
  return [
    {
      type: "attachment",
      length: e.length,
...
function Ep(t, e, n, r) {
  ...
  return (
    Zl &&
      null === s &&
      dd.log(`Event processor "${i.id || "?"}" dropped event`),
    jd(s) ? s.then((t) => Ep(t, e, n, r + 1)) : Ep(s, e, n, r + 1)
  );
}
function Tp(t, e) {
  const {
  ...
  (!(function (t, e) {
    ...
    r &&
      (function (t, e) {
        ((t.contexts = { trace: Wh(e), ...t.contexts }),
          (t.sdkProcessingMetadata = {
            dynamicSamplingContext: op(e),
            ...t.sdkProcessingMetadata,
          }));
        const n = Qh(e),
          r = Yh(n).description;
...
function Ap(t, e) {
  ...
  (Cp(t, "extra", n),
    ...
    Cp(t, "user", i),
    Cp(t, "contexts", s),
    (t.sdkProcessingMetadata = fh(t.sdkProcessingMetadata, a, 2)),
    o && (t.level = o),
...
function Mp(t, e, n, r, i, s) {
  ...
  (!(function (t, e) {
    ...
    void 0 === e.type &&
      (function (t, e) {
        const n = (function (t) {
          const e = td._sentryDebugIds,
            n = td._debugIds;
          if (!e && !n) return {};
          const r = e ? Object.keys(e) : [],
            i = n ? Object.keys(n) : [];
          if (Lp && r.length === Op && i.length === kp) return Lp;
          ((Op = r.length), (kp = i.length), (Lp = {}), Pp || (Pp = {}));
          const s = (e, n) => {
            for (const r of e) {
              const e = n[r],
                i = Pp?.[r];
              if (i && Lp && e) ((Lp[i[0]] = e), Pp && (Pp[r] = [i[0], e]));
              else if (e) {
                const n = t(r);
  ...
  const l = (function (t, e) {
    if (!e) return t;
    const n = t ? t.clone() : new wh();
    return (n.update(e), n);
  })(r, n.captureContext);
  n.mechanism && ch(c, n.mechanism);
  const d = i ? i.getEventProcessors() : [],
    h = id("globalScope", () => new wh()).getScopeData();
  if (s) {
    Ap(h, s.getScopeData());
  }
  if (l) {
  ...
  (p.length && (n.attachments = p), Tp(c, h));
  return xp([...d, ...h.eventProcessors], c, n).then(
    (t) => (
      t &&
        (function (t) {
          const e = {};
      ...
      "number" == typeof o && o > 0
        ? (function (t, e, n) {
            ...
            const r = {
              ...
              ...(t.breadcrumbs && {
                breadcrumbs: t.breadcrumbs.map((t) => ({
                  ...t,
                  ...(t.data && { data: ap(t.data, e, n) }),
                })),
              }),
              ...(t.user && { user: ap(t.user, e, n) }),
              ...(t.contexts && { contexts: ap(t.contexts, e, n) }),
              ...(t.extra && { extra: ap(t.extra, e, n) }),
            };
            t.contexts?.trace &&
              r.contexts &&
              ((r.contexts.trace = t.contexts.trace),
              t.contexts.trace.data &&
                (r.contexts.trace.data = ap(t.contexts.trace.data, e, n)));
            t.spans &&
            ...
            t.contexts?.flags &&
              r.contexts &&
              (r.contexts.flags = ap(t.contexts.flags, 3, n));
            return r;
          })(t, o, a)
        : t
    ),
...
function Rp(t, e) {
  return Ph().captureEvent(t, e);
}
function Np(t) {
  const e = Oh(),
    n = Ph(),
    { userAgent: r } = td.navigator || {},
    i = ph({
    ...
    s = e.getSession();
  return (
    "ok" === s?.status && mh(s, { status: "exited" }),
    Ip(),
    e.setSession(i),
    i
  );
...
function Ip() {
  const t = Oh(),
    e = Ph().getSession() || t.getSession();
  (e &&
    (function (t) {
      let e = {};
      ("ok" === t.status && (e = { status: "exited" }), mh(t, e));
    })(e),
    Dp(),
    t.setSession());
}
...
function Gp(t, e, n) {
  if (n[e.name])
    Zl &&
      dd.log(`Integration skipped because it was already installed: ${e.name}`);
  else {
    if (
      ((n[e.name] = e),
      -1 === jp.indexOf(e.name) &&
        "function" == typeof e.setupOnce &&
        (e.setupOnce(), jp.push(e.name)),
    ...
    Zl && dd.log(`Integration installed: ${e.name}`);
  }
}
function zp(t, e) {
  const n =
  ...
  (Vp().set(t, []), t.emit("flushLogs"), t.sendEnvelope(i));
}
function Vp() {
  return id("clientToLogBufferMap", () => new WeakMap());
}
function Hp(t, e) {
  const n =
    e ??
  ...
  (Wp().set(t, []), t.emit("flushMetrics"), t.sendEnvelope(i));
}
function Wp() {
  return id("clientToMetricBufferMap", () => new WeakMap());
}
function qp(t) {
  const e = [];
...
const Kp = "Not capturing exception because it's already been captured.",
  Xp = "Discarded session because of missing or non-string release",
  Yp = Symbol.for("SentryInternalError"),
  Jp = Symbol.for("SentryDoNotSendEventError");
function Qp(t) {
  return { message: t, [Yp]: !0 };
}
function Zp(t) {
  return { message: t, [Jp]: !0 };
}
function tm(t) {
  return !!t && "object" == typeof t && Yp in t;
}
function em(t) {
  return !!t && "object" == typeof t && Jp in t;
}
...
class rm {
  constructor(t) {
    if (
      ...
      t.dsn
        ? (this._dsn = Vh(t.dsn))
        : Zl && dd.warn("No DSN provided, client will not send events."),
      this._dsn)
    ) {
      const e = $p(this._dsn, t.tunnel, t._metadata ? t._metadata.sdk : void 0);
    ...
    (this._options.enableLogs &&
      nm(this, "afterCaptureLog", "flushLogs", am, zp),
      this._options._experiments?.enableMetrics &&
        nm(this, "afterCaptureMetric", "flushMetrics", om, Hp));
  }
  captureException(t, e, n) {
    const r = ih();
    if (uh(t)) return (Zl && dd.log(Kp), r);
  ...
  captureMessage(t, e, n, r) {
    const i = { event_id: ih(), ...n },
      s = Id(t) ? t : String(t),
      o = Dd(t)
        ? this.eventFromMessage(s, e, i)
  ...
  captureEvent(t, e, n) {
    const r = ih();
    if (e?.originalException && uh(e.originalException))
      return (Zl && dd.log(Kp), r);
    const i = { event_id: r, ...e },
      s = t.sdkProcessingMetadata || {},
      o = s.capturedSpanScope,
      a = s.capturedSpanIsolationScope;
    return (this._process(this._captureEvent(t, i, o || n, a)), i.event_id);
  }
  captureSession(t) {
    (this.sendSession(t), mh(t, { init: !1 }));
  }
  getDsn() {
    return this._dsn;
  }
  ...
  addIntegration(t) {
    ...
    (Gp(this, t, this._integrations), e || Fp(this, [t]));
  }
  sendEvent(t, e = {}) {
    this.emit("beforeSendEvent", t, e);
    let n = bp(t, this._dsn, this._options._metadata, this._options.tunnel);
    for (const r of e.attachments || []) n = dp(n, fp(r));
    this.sendEnvelope(n).then((e) => this.emit("afterSendEvent", t, e));
  }
  sendSession(t) {
    const { release: e, environment: n = ip } = this._options;
    if ("aggregates" in t) {
      const r = t.attrs || {};
      if (!r.release && !e) return void (Zl && dd.warn(Xp));
      ((r.release = r.release || e),
        (r.environment = r.environment || n),
        (t.attrs = r));
    } else {
      if (!t.release && !e) return void (Zl && dd.warn(Xp));
  ...
  recordDroppedEvent(t, e, n = 1) {
    if (this._options.sendClientReports) {
      const r = `${t}:${e}`;
      (Zl && dd.log(`Recording outcome: "${r}"${n > 1 ? ` (${n} times)` : ""}`),
  ...
  async sendEnvelope(t) {
    if ((this.emit("beforeEnvelope", t), this._isEnabled() && this._transport))
      try {
        ...
        return (Zl && dd.error("Error while sending envelope:", e), {});
      }
    return (Zl && dd.error("Transport disabled"), {});
  }
  _setupIntegrations() {
  ...
  _prepareEvent(t, e, n, r) {
    ...
    return (
      !e.integrations && s?.length && (e.integrations = s),
      this.emit("preprocessEvent", t, e),
      t.type || r.setLastEventId(t.event_id || e.event_id),
      Mp(i, t, e, n, this, r).then((t) => {
        if (null === t) return t;
        (this.emit("postprocessEvent", t, e),
          (t.contexts = { trace: Lh(n), ...t.contexts }));
        const r = (function (t, e) {
          const n = e.getPropagationContext();
          return n.dsc || sp(n.traceId, t);
        })(this, n);
        return (
          (t.sdkProcessingMetadata = {
  ...
  _captureEvent(t, e = {}, n = Ph(), r = Oh()) {
    return (
      Zl &&
        im(t) &&
        dd.log(`Captured error event \`${qp(t)[0] || "<unknown>"}\``),
    ...
    return this._prepareEvent(t, e, n, r)
      .then((t) => {
        if (null === t)
          throw (
            ...
            Zp("An event processor returned `null`, will not send event.")
          );
        ...
        const n = (function (t, e, n, r) {
          ...
          if (sm(c)) {
            if (o || a) {
              ...
              if (a?.length && ep(e, a)) return null;
              if (o) {
                const t = o(e);
                t
                  ? (c = fh(n, {
                      ...
                      contexts: {
                        trace: {
                          ...
                          data: {
                            ...u.data,
                            ...(u.profile_id && { [Mh]: u.profile_id }),
                            ...(u.exclusive_time && { [Rh]: u.exclusive_time }),
                          },
                        },
                      },
              ...
              if (c.spans) {
                const e = [],
                  n = c.spans;
                for (const t of n)
                  if (a?.length && ep(t, a)) np(n, t);
                  else if (o) {
                    const n = o(t);
                    n ? e.push(n) : (Zh(), e.push(t));
                  } else e.push(t);
        ...
        return (function (t, e) {
          ...
          if (jd(t))
            return t.then(
              (t) => {
                if (!Ud(t) && null !== t) throw Qp(n);
                return t;
              },
              (t) => {
                throw Qp(`${e} rejected with ${t}`);
              },
            );
          if (!Ud(t) && null !== t) throw Qp(n);
          return t;
      ...
      .then((i) => {
        if (null === i) {
          ...
          throw Zp(`${u} returned \`null\`, will not send event.`);
        }
  ...
  _flushOutcomes() {
    Zl && dd.log("Flushing outcomes...");
    const t = this._clearOutcomes();
    if (0 === t.length) return void (Zl && dd.log("No outcomes to send"));
    if (!this._dsn)
      return void (Zl && dd.log("No dsn provided, will not send outcomes"));
    Zl && dd.log("Sending outcomes:", t);
    const e =
      ((n = t),
      lp((r = this._options.tunnel && Fh(this._dsn)) ? { dsn: r } : {}, [
        [{ type: "client_report" }, { timestamp: lh(), discarded_events: n }],
      ]));
    var n, r;
    this.sendEnvelope(e);
  }
...
function am(t) {
  let e = 0;
  return (t.message && (e += 2 * t.message.length), e + cm(t.attributes));
}
function cm(t) {
  if (!t) return 0;
  let e = 0;
...
function lm(t, e) {
  !0 === e.debug && (Zl ? dd.enable() : ad(() => {}));
  Ph().update(e.initialScope);
  const n = new t(e);
  return (
    (function (t) {
      Ph().setClient(t);
...
const dm = Symbol.for("SentryBufferFullError");
function hm(t = 100) {
  const e = new Set();
  function n(t) {
    e.delete(t);
...
function pm(t, { statusCode: e, headers: n }, r = Date.now()) {
  const i = { ...t },
...
function mm(t, e, n = hm(t.bufferSize || 64)) {
  let r = {};
  return {
    send: function (i) {
      const s = [];
      ...
      return n
          ...
          e({ body: mp(o) }).then(
            ...
            (t) => {
              throw (
                a("network_error"),
                Zl &&
                  dd.error("Encountered error running transport request:", t),
                t
              );
            },
          ),
        ...
        .then(
          ...
          (t) => {
            if (t === dm)
              return (
                Zl && dd.error("Skipped sending event because buffer is full."),
                a("queue_overflow"),
                Promise.resolve({})
              );
            throw t;
...
function vm(t, e) {
  const n = kh(),
    r = Oh();
  if (!n) return;
  const { beforeBreadcrumb: i = null, maxBreadcrumbs: s = _m } = n.getOptions();
  if (s <= 0) return;
  const o = { timestamp: lh(), ...t },
    a = i ? ad(() => i(o, e)) : o;
  null !== a &&
    (n.emit && n.emit("beforeAddBreadcrumb", a, e), r.addBreadcrumb(a, s));
}
let bm;
const ym = new WeakMap(),
  wm = () => ({
    ...
    setupOnce() {
      bm = Function.prototype.toString;
      try {
        Function.prototype.toString = function (...t) {
          const e = Zd(this),
            n = ym.has(kh()) && void 0 !== e ? e : this;
          return bm.apply(n, t);
        };
      } catch {}
    },
...
function Am(t) {
  try {
    ...
    return (Zl && dd.error(`Cannot extract url for event ${oh(t)}`), null);
  }
}
function Cm(t, e, n, r, i, s) {
  if (!i.exception?.values || !s || !Bd(s.originalException, Error)) return;
  const o =
    i.exception.values.length > 0
      ? i.exception.values[i.exception.values.length - 1]
      : void 0;
  o &&
    (i.exception.values = Pm(
      t,
      e,
      r,
      s.originalException,
...
function Pm(t, e, n, r, i, s, o, a) {
  ...
  if (Bd(r[i], Error)) {
    ...
    const s = t(e, r[i]),
      u = c.length;
    (km(s, i, u, a), (c = Pm(t, e, n, r[i], i, [s, ...c], s, u)));
  }
  return (
...
function Lm() {
  "console" in td &&
    sd.forEach(function (t) {
      t in td.console &&
        Yd(td.console, t, function (e) {
          return (
            (od[t] = e),
            function (...e) {
              Ed("console", { args: e, level: t });
              const n = od[t];
              n?.apply(td.console, e);
            }
          );
        });
    });
  ...
  if (e && "function" == typeof e.createElement)
    try {
      ...
      ((n.hidden = !0),
        ...
        n.contentWindow?.fetch && (t = jm(n.contentWindow.fetch)),
        ...
        Yd(td, "fetch", function (t) {
          return function (...e) {
            ...
            return (
              ...
              t.apply(td, e).then(
                async (t) => (
                  Ed("fetch", { ...s, endTimestamp: 1e3 * hh(), response: t }),
                  t
                ),
                (t) => {
                  if (
                    (Ed("fetch", { ...s, endTimestamp: 1e3 * hh(), error: t }),
                    kd(t) &&
                      void 0 === t.stack &&
                      ((t.stack = n.stack), Jd(t, "framesToPop", 1)),
...
function Vm(t) {
  ...
  try {
    ...
    if (((r = e), "undefined" != typeof Request && Bd(r, Request)))
...
function Km(t, e = {}) {
    ...
    try {
      ...
      throw (
        ...
        (function (...t) {
          ...
          (t.addEventProcessor(
            (t) => (
              e.mechanism && (ah(t, void 0), ch(t, e.mechanism)),
              (t.extra = { ...t.extra, arguments: n }),
              t
            ),
          ),
            (i = r),
            Ph().captureException(i, void 0));
        }),
        r
      );
    }
  ...
  (Qd(n, t), Jd(t, "__sentry_wrapped__", n));
  try {
...
function Ym(t, e, n, r) {
  const i = kh(),
    ...
    a = { __serialized__: cp(e, s) };
  if (o) return { exception: { values: [Xm(t, o)] }, extra: a };
  const c = {
    exception: {
      values: [
        {
          type: $d(e) ? e.constructor.name : r ? "UnhandledRejection" : "Error",
          value: of(e, { isUnhandledRejection: r }),
        },
      ],
    },
    extra: a,
...
function Jm(t, e) {
  return { exception: { values: [Xm(t, e)] } };
}
function Qm(t, e) {
  const n = e.stacktrace || e.stack || "",
    r = (function (t) {
      if (t && Zm.test(t.message)) return 1;
      return 0;
    })(e),
    i = (function (t) {
...
const Zm = /Minified React error #\d+;/i;
function tf(t) {
  return (
...
function rf(t, e, n, r, i) {
  ...
  if (Rd(e) || Ld(e, "DOMException")) {
    const i = e;
    if ("stack" in e) s = Jm(t, e);
    else {
      const e = i.name || (Rd(i) ? "DOMError" : "DOMException"),
  ...
  if (kd(e)) return Jm(t, e);
  if (Ud(e) || $d(e)) {
    return ((s = Ym(t, e, n, i)), ch(s, { synthetic: !0 }), s);
  }
  return ((s = sf(t, e, n, r)), ah(s, `${e}`), ch(s, { synthetic: !0 }), s);
}
function sf(t, e, n, r) {
  const i = {};
  if (r && n) {
...
function of(t, { isUnhandledRejection: e }) {
  const n = (function (t, e = 40) {
      const n = Object.keys(th(t));
      n.sort();
      const r = n[0];
      if (!r) return "[object has no keys]";
      if (r.length >= e) return Wd(r, e);
      for (let i = n.length; i > 0; i--) {
        const t = n.slice(0, i).join(", ");
        if (!(t.length > e)) return i === n.length ? t : Wd(t, e);
      }
      return "";
    })(t),
...
class af extends rm {
  constructor(t) {
    ...
    (!(function (t, e, n = [e], r = "npm") {
      ...
      (i.sdk ||
        (i.sdk = {
          ...
          packages: n.map((t) => ({ name: `${r}:@sentry/${t}`, version: ed })),
          version: ed,
        }),
        (t._metadata = i));
    })(e, "browser", ["browser"], Hm.SENTRY_SDK_SOURCE || "npm"),
      e._metadata?.sdk &&
    ...
    (Hm.document &&
      (i || s || o?.enableMetrics) &&
      Hm.document.addEventListener("visibilitychange", () => {
        "hidden" === Hm.document.visibilityState &&
          (i && this._flushOutcomes(),
          s && zp(this),
          o?.enableMetrics && Hp(this));
      }),
      r && this.on("beforeSendSession", gm));
  }
  eventFromException(t, e) {
    return (function (t, e, n, r) {
      const i = rf(t, e, n?.syntheticException || void 0, r);
      return (
        ch(i),
        (i.level = "error"),
  ...
  eventFromMessage(t, e = "info", n) {
    return (function (t, e, n = "info", r, i) {
      const s = sf(t, e, r?.syntheticException || void 0, i);
      return ((s.level = n), r?.event_id && (s.event_id = r.event_id), yp(s));
...
const cf = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__,
  uf = td;
let lf, df, hf, pf;
function mf() {
  if (!uf.document) return;
  const t = Ed.bind(null, "dom"),
    e = ff(t, !0);
  (uf.document.addEventListener("click", e, !1),
    uf.document.addEventListener("keypress", e, !1),
    ["EventTarget", "Node"].forEach((e) => {
      const n = uf,
        r = n[e]?.prototype;
      r?.hasOwnProperty?.("addEventListener") &&
        (Yd(r, "addEventListener", function (e) {
        ...
        Yd(r, "removeEventListener", function (t) {
...
function ff(t, e = !1) {
  return (n) => {
    ...
    if (
      ...
      return;
    (Jd(n, "_sentryCaptured", !0),
      r && !r._sentryId && Jd(r, "_sentryId", ih()));
    const i = "keypress" === n.type ? "input" : n.type;
    if (
      !(function (t) {
        if (t.type !== df) return !1;
        try {
          if (!t.target || t.target._sentryId !== hf) return !1;
        } catch {}
        return !0;
      })(n)
    ) {
    ...
    return function (...e) {
      ...
      if (n) {
        const r = pf,
          i = (function (t) {
            try {
              return new URL(t, uf.location.origin).toString();
            } catch {
              return t;
            }
          })(String(n));
        if (((pf = i), r === i)) return t.apply(this, e);
        Ed("history", { from: r, to: i });
      }
      return t.apply(this, e);
    };
  }
  (uf.addEventListener("popstate", () => {
    const t = uf.location.href,
      e = pf;
    if (((pf = t), e === t)) return;
    Ed("history", { from: e, to: t });
  }),
    "history" in $m &&
      $m.history &&
      (Yd(uf.history, "pushState", t), Yd(uf.history, "replaceState", t)));
}
const vf = {};
const bf = "__sentry_xhr_v3__";
function yf() {
  if (!uf.XMLHttpRequest) return;
  const t = XMLHttpRequest.prototype;
  ((t.open = new Proxy(t.open, {
    apply(t, e, n) {
      const r = new Error(),
        i = 1e3 * hh(),
        s = Nd(n[0]) ? n[0].toUpperCase() : void 0,
        o = (function (t) {
          if (Nd(t)) return t;
          try {
            return t.toString();
      ...
      if (!s || !o) return t.apply(e, n);
      ((e[bf] = { method: s, url: o, request_headers: {} }),
        "POST" === s &&
          o.match(/sentry_key/) &&
        ...
        (e.setRequestHeader = new Proxy(e.setRequestHeader, {
          apply(t, e, n) {
            const [r, i] = n,
              s = e[bf];
            return (
              s && Nd(r) && Nd(i) && (s.request_headers[r.toLowerCase()] = i),
              t.apply(e, n)
            );
          },
        })),
    ...
    (t.send = new Proxy(t.send, {
      apply(t, e, n) {
        ...
        return (
          Ed("xhr", { startTimestamp: 1e3 * hh(), xhr: e }),
          t.apply(e, n)
        );
      },
    })));
...
function wf(
  ...
  e = (function (t) {
    ...
    return n ? (vf[t] = n.bind(uf)) : n;
  })("fetch"),
) {
  let n = 0,
    r = 0;
  return mm(t, async function (i) {
...
function Sf(t, e, n, r) {
  const i = { filename: t, function: "<anonymous>" === e ? hd : e, in_app: !0 };
  return (void 0 !== n && (i.lineno = n), void 0 !== r && (i.colno = r), i);
}
const xf = /^\s*at (\S+?)(?::(\d+))(?::(\d+))\s*$/i,
  Ef =
  ...
  Pf = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i,
  Of = fd(
    ...[
      [
        30,
        (t) => {
          ...
          if (r) {
            ...
            const [t, e] = kf(r[1] || hd, r[2]);
            return Sf(e, t, r[3] ? +r[3] : void 0, r[4] ? +r[4] : void 0);
          }
        },
      ],
      [
        ...
        (t) => {
          ...
          if (e) {
            ...
            return (
              ([n, t] = kf(n, t)),
              Sf(t, n, e[4] ? +e[4] : void 0, e[5] ? +e[5] : void 0)
            );
          }
        },
      ],
  ...
  kf = (t, e) => {
    ...
    return n || r
      ? [
          -1 !== t.indexOf("@") ? t.split("@")[0] : hd,
          n ? `safari-extension:${e}` : `safari-web-extension:${e}`,
        ]
      : [t, e];
  },
  Lf = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__,
  Mf = 1024,
  Rf = (t = {}) => {
    const e = {
      console: !0,
            ...
            (function (t) {
              return function (e) {
                ...
                if ("assert" === e.level) {
                  ...
                  ((n.message = `Assertion failed: ${qd(e.args.slice(1), " ") || "console.assert"}`),
                    (n.data.arguments = e.args.slice(1)));
                }
                vm(n, { input: e.args, level: e.level });
              };
            })(t),
          ),
          e.dom &&
            ((n = (function (t, e) {
              return function (n) {
                ...
                let r,
                  i,
                  s = "object" == typeof e ? e.serializeAttribute : void 0,
                  o =
                ...
                try {
                  const t = n.event,
                    e = (function (t) {
                      ...
                      ? t.target
                      : t;
                  ((r = zd(e, { keyAttrs: s, maxStringLength: o })),
                    (i = (function (t) {
                      if (!Gd.HTMLElement) return null;
                      let e = t;
                      for (let n = 0; n < 5; n++) {
                        if (!e) return null;
                ...
                (i && (a.data = { "ui.component_name": i }),
                  vm(a, { event: n.event, name: n.name, global: n.global }));
              };
            })(t, e.dom)),
            Sd("dom", n),
            xd("dom", mf)),
              ...
              (function (t) {
                return function (e) {
                  ...
                  const { startTimestamp: n, endTimestamp: r } = e,
                    i = e.xhr[bf];
                  if (!n || !r || !i) return;
                  const { method: s, url: o, status_code: a, body: c } = i,
                    u = { method: s, url: o, status_code: a },
                    l = {
                      xhr: e.xhr,
                      input: c,
                      startTimestamp: n,
                  ...
                  (t.emit("beforeOutgoingRequestBreadcrumb", d, l), vm(d, l));
                };
              })(t),
            ),
          e.fetch &&
                ...
                return function (e) {
                  ...
                  if (
                    ...
                    if ((e.fetchData.method, e.fetchData.url, e.error)) {
                      ...
                      const i = e.response,
                        s = { ...e.fetchData, status_code: i?.status };
                ...
                return function (e) {
                  ...
                  (s?.path || (s = i),
                    ...
                    i.protocol === s.protocol &&
                      i.host === s.host &&
                      (n = s.relative),
                    vm({ category: "navigation", data: { from: n, to: r } }));
                };
              })(t),
            ),
          e.sentry &&
...
const Nf = [
  ...
  If = (t = {}) => {
    ...
    return {
      ...
      setupOnce() {
        (e.setTimeout && Yd(Hm, "setTimeout", Df),
          e.setInterval && Yd(Hm, "setInterval", Df),
          e.requestAnimationFrame && Yd(Hm, "requestAnimationFrame", Uf),
          e.XMLHttpRequest &&
            "XMLHttpRequest" in Hm &&
            Yd(XMLHttpRequest.prototype, "send", $f));
        const t = e.eventTarget;
        if (t) {
          (Array.isArray(t) ? t : Nf).forEach((t) =>
            (function (t, e) {
              const n = Hm,
                r = n[t]?.prototype;
              if (!r?.hasOwnProperty?.("addEventListener")) return;
              (Yd(r, "addEventListener", function (n) {
                return function (r, i, s) {
                  try {
                    "function" == typeof i.handleEvent &&
                      (i.handleEvent = Km(i.handleEvent, {
                        mechanism: {
                          data: { handler: vd(i), target: t },
                          handled: !1,
  ...
  return function (...e) {
    ...
    return (
      (e[0] = Km(n, {
        mechanism: {
          handled: !1,
          type: `auto.browser.browserapierrors.${vd(t)}`,
        },
      })),
      t.apply(this, e)
    );
        ...
        t in n &&
          ...
          Yd(n, t, function (e) {
            const n = {
              ...
              r = Zd(e);
            return (r && (n.mechanism.data.handler = vd(r)), Km(e, n));
          });
      }),
      t.apply(this, e)
    );
    ...
    setupOnce() {
      void 0 !== Hm.document
        ? (Np({ ignoreDuration: !0 }),
          Up(),
          gf(({ from: t, to: e }) => {
            void 0 !== t && t !== e && (Np({ ignoreDuration: !0 }), Up());
          }))
        : Lf &&
          dd.warn(
        ...
        (e.onerror &&
          (!(function (t) {
            !(function (t) {
              ...
              const { stackParser: n, attachStacktrace: r } = Gf();
              if (kh() !== t || qm()) return;
          ...
          e.onunhandledrejection &&
            ...
            Ff("onunhandledrejection")));
      },
    };
  };
function Ff(t) {
  Lf && dd.log(`Global Handler attached: ${t}`);
}
function Gf() {
  const t = kh();
...
const zf = () => ({
    name: "HttpContext",
    preprocessEvent(t) {
      if (!Hm.navigator && !Hm.location && !Hm.document) return;
      const e = (function () {
          const t = Hd(),
            { referrer: e } = Hm.document || {},
            { userAgent: n } = Hm.navigator || {};
          return {
            url: t,
            headers: {
              ...(e && { Referer: e }),
  ...
  Vf = (t = {}) => {
    ...
    return {
      ...
      preprocessEvent(t, r, i) {
        Cm(Xm, i.getOptions().stackParser, n, e, t, r);
      },
    };
  };
function Hf() {
  return (
    !!(function () {
      ...
      return !(Hm === Hm.top && r.some((t) => n.startsWith(`${t}://`)));
    })() && (Lf && ad(() => {}), !0)
  );
}
function Wf(t) {
  return [Em(), wm(), If(), Rf(), Bf(), Vf(), Rm(), zf(), jf()];
}
const qf = () => {
  const t = Wf().filter(
    (t) =>
  ...
  !(function (t = {}) {
    const e = !t.skipBrowserExtensionCheck && Hf(),
      n = {
        ...t,
        enabled: !e && t.enabled,
        stackParser:
          ((r = t.stackParser || Of), Array.isArray(r) ? fd(...r) : r),
        integrations: Bp({
          integrations: t.integrations,
          defaultIntegrations:
            null == t.defaultIntegrations ? Wf() : t.defaultIntegrations,
        }),
        transport: t.transport || wf,
      };
    var r;
    lm(af, n);
  })({
...
export { Ql as P, Pt as S, Jl as a, Yl as g, qf as i, Xl as w };
