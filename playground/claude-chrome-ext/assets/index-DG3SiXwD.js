import { o as e, l as t, f as n, m as a } from "./sidepanel-bCn1l1gz.js";
import "./index-D6M7XaCF.js";
import "./index-BVS4T5_D.js";
import "./mcpPermissions-DLQdIXHM.js";
import "./SavedPromptsService-Ca57zNuQ.js";
import "./mcpServersStore-BoqleVOc.js";
import "./SentryService-D9HBmlSt.js";
import "./Main-Baot3sP1.js";
import "./ModelSelector-BiIwkTdr.js";
import "./punycode.es6-D49_gIz_.js";
import "./datadog-z19OuTVm.js";
import "./PairingPrompt-ChanX0Ez.js";
const i = {
    tokenize: function (e, t, i) {
      const o = this,
        c = o.events[o.events.length - 1],
        s =
      ...
      function l(t) {
        return 36 === t
          ...
          : u < 2
            ? i(t)
            : (e.exit("mathFlowFenceSequence"), n(e, h, "whitespace")(t));
      }
      function h(t) {
        return null === t || a(t)
          ? f(t)
      ...
      function m(t) {
        return null === t || a(t)
          ? (e.exit("chunkString"), e.exit("mathFlowFenceMeta"), f(t))
          : 36 === t
            ? i(t)
            : (e.consume(t), m);
      }
      function f(n) {
        return (
          ...
          o.interrupt ? t(n) : e.attempt(r, p, g)(n)
        );
      }
      function p(t) {
        return e.attempt({ tokenize: w, partial: !0 }, g, d)(t);
      }
      function d(t) {
      ...
      function w(e, t, i) {
        ...
        function c(t) {
          return 36 === t
            ...
            : r < u
              ? i(t)
              : (e.exit("mathFlowFenceSequence"), n(e, s, "whitespace")(t));
        }
        function s(n) {
          return null === n || a(n) ? (e.exit("mathFlowFence"), t(n)) : i(n);
        }
      }
    },
    concrete: !0,
    ...
    null == t && (t = !0),
    {
      tokenize: function (e, n, i) {
        let r,
          ...
          c = 0;
        return function (t) {
          return (e.enter("mathText"), e.enter("mathTextSequence"), s(t));
        };
        function s(n) {
          return 36 === n
            ? (e.consume(n), c++, s)
            : c < 2 && !t
              ? i(n)
              : (e.exit("mathTextSequence"), u(n));
        }
        function u(t) {
          return null === t
            ? i(t)
            : 36 === t
              ? ((o = e.enter("mathTextSequence")), (r = 0), h(t))
              : 32 === t
...
function c(e) {
  ...
  for (t = i - 1, a++; ++t <= a; )
    void 0 === n
      ? t !== a && "lineEnding" !== e[t][1].type && (n = t)
      : (t !== a && "lineEnding" !== e[t][1].type) ||
        ...
        return {
          ...
          exit: {
            mathFlow: function (t) {
              ...
              (e("math" === a.type), this.exit(t), (a.value = n));
              const i = a.data.hChildren[0];
              (e("element" === i.type),
                e("code" === i.tagName),
                i.children.push({ type: "text", value: n }),
            ...
            mathText: function (t) {
              ...
              (e("inlineMath" === a.type),
                this.exit(t),
                (a.value = n),
                a.data.hChildren.push({ type: "text", value: n }));
            },
            mathTextData: t,
          },
        };
      ...
      (function (e) {
        ...
        function a(e, t, a) {
          ...
          for (; ++c < a.unsafe.length; ) {
            ...
            for (; (n = t.exec(i)); ) {
              let e = n.index;
              (10 === i.codePointAt(e) && 13 === i.codePointAt(e - 1) && e--,
