(function () {
  !(function () {
    ...
    function p() {
      ((i = !0),
        (function () {
          ...
          ((e.id = "claude-agent-animation-styles"),
            (e.textContent =
        ...
        r ||
          (n
            ...
            : ((n = (function () {
                const e = document.createElement("div");
                ((e.id = "claude-agent-stop-container"),
                  (e.style.cssText =
                    "\n      position: fixed;\n      bottom: 16px;\n      left: 50%;\n      transform: translateX(-50%);\n      display: flex;\n      justify-content: center;\n      align-items: center;\n      pointer-events: none;\n      z-index: 2147483647;\n    "));
                const n = document.createElement("button");
                return (
                  (n.id = "claude-agent-stop-button"),
                  (n.innerHTML =
        ...
        requestAnimationFrame(() => {
          if ((e && (e.style.opacity = "1"), n)) {
            const e = n.querySelector("#claude-agent-stop-button");
            e &&
      ...
      ((a = !0),
        t
          ...
          : ((t = (function () {
              ...
              const n = e.querySelector("#claude-static-chat-button"),
                t = e.querySelector("#claude-static-chat-tooltip");
              n &&
                (n.addEventListener("mouseenter", () => {
                  ((n.style.background = "#F0EEE6"),
                    t && (t.style.opacity = "1"));
                }),
                n.addEventListener("mouseleave", () => {
              ...
              const i = e.querySelector("#claude-static-close-button"),
                a = e.querySelector("#claude-static-close-tooltip");
              return (
                i &&
                  (i.addEventListener("mouseenter", () => {
                    ((i.style.background = "#F0EEE6"),
                      a && (a.style.opacity = "1"));
                  }),
    ...
    (chrome.runtime.onMessage.addListener((l, u, y) => {
      "SHOW_AGENT_INDICATORS" === l.type
        ? ((r = r || !0 === l.isMcp), p(), y({ success: !0 }))
        : "HIDE_AGENT_INDICATORS" === l.type
          ? (c(), y({ success: !0 }))
          : "HIDE_FOR_TOOL_USE" === l.type
            ? ((s = i),
              (o = a),
              e && (e.style.display = "none"),
              n && (n.style.display = "none"),
              t && a && (t.style.display = "none"),
              y({ success: !0 }))
            : "SHOW_AFTER_TOOL_USE" === l.type
              ? (s &&
                ...
                (o = !1),
                y({ success: !0 }))
              : "SHOW_STATIC_INDICATOR" === l.type
                ? (d(), y({ success: !0 }))
                : "HIDE_STATIC_INDICATOR" === l.type &&
                  (L(), y({ success: !0 }));
    }),
