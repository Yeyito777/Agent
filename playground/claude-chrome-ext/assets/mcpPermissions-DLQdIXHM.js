...
import { g as k, A as T } from "./mcpServersStore-BoqleVOc.js";
import { w as E, P as x } from "./SentryService-D9HBmlSt.js";
  ...
  (M ||
    ...
    (function (e) {
      const t = (function () {
          ...
          ((C = 1),
            ...
            (A.toByteArray = function (e) {
              ...
              for (n = 0; n < d; n += 4)
                ((o =
                  (t[e.charCodeAt(n)] << 18) |
                  (t[e.charCodeAt(n + 1)] << 12) |
                  (t[e.charCodeAt(n + 2)] << 6) |
                  t[e.charCodeAt(n + 3)]),
                  (u[l++] = (o >> 16) & 255),
                  (u[l++] = (o >> 8) & 255),
                  (u[l++] = 255 & o));
              return (
                2 === c &&
                  ((o =
                    (t[e.charCodeAt(n)] << 2) | (t[e.charCodeAt(n + 1)] >> 4)),
                  (u[l++] = 255 & o)),
                1 === c &&
                  ((o =
                    (t[e.charCodeAt(n)] << 10) |
                    (t[e.charCodeAt(n + 1)] << 4) |
                    (t[e.charCodeAt(n + 2)] >> 2)),
                  (u[l++] = (o >> 8) & 255),
                  (u[l++] = 255 & o)),
                u
              );
          ...
          return ((t["-".charCodeAt(0)] = 62), (t["_".charCodeAt(0)] = 63), A);
        })(),
        r =
          (D ||
            ((D = 1),
                ...
                t = Math.abs(t),
                  isNaN(t) || t === 1 / 0
                    ...
                    : ((a = Math.floor(Math.log(t) / Math.LN2)),
                      ...
                      (t += a + d >= 1 ? h / c : h * Math.pow(2, 1 - d)) * c >=
                        2 && (a++, (c /= 2)),
                      a + d >= l
                        ? ((s = 0), (a = l))
                        : a + d >= 1
                          ? ((s = (t * c - 1) * Math.pow(2, n)), (a += d))
                          : ((s = t * Math.pow(2, d - 1) * Math.pow(2, n)),
                            (a = 0)));
                n >= 8;
                e[r + p] = 255 & s, p += f, s /= 256, n -= 8
              );
              for (
                a = (a << n) | s, u += n;
                u > 0;
                e[r + p] = 255 & a, p += f, a /= 256, u -= 8
              );
              e[r + p - f] |= 128 * m;
            })),
          R),
      ...
      function b(e, t, r, o, n) {
        ...
        if (n) {
          let o = -1;
          for (i = r; i < s; i++)
            if (u(e, i) === u(t, -1 === o ? 0 : i - o)) {
              if ((-1 === o && (o = i), i - o + 1 === c)) return o * a;
            } else (-1 !== o && (i -= i - o), (o = -1));
        } else
      ...
      function k(e, r, o) {
        return 0 === r && o === e.length
          ? t.fromByteArray(e)
          : t.fromByteArray(e.slice(r, o));
      }
      function T(e, t, r) {
        ...
        return (function (e) {
          ...
          let r = "",
            o = 0;
          for (; o < t; )
            r += String.fromCharCode.apply(String, e.slice(o, (o += E)));
          return r;
        })(o);
      }
      ((e.kMaxLength = n),
        ...
        (a.compare = function (e, t) {
          if (
            (X(e, Uint8Array) && (e = a.from(e, e.offset, e.byteLength)),
      ...
      ((a.prototype.slice = function (e, t) {
        ...
        (a.prototype.readBigUInt64LE = ee(function (e) {
          z((e >>>= 0), "offset");
          const t = this[e],
            r = this[e + 7];
        ...
        (a.prototype.readBigUInt64BE = ee(function (e) {
          z((e >>>= 0), "offset");
          const t = this[e],
            r = this[e + 7];
          (void 0 !== t && void 0 !== r) || H(e, this.length - 8);
        ...
        (a.prototype.readBigInt64LE = ee(function (e) {
          z((e >>>= 0), "offset");
          const t = this[e],
            r = this[e + 7];
          (void 0 !== t && void 0 !== r) || H(e, this.length - 8);
        ...
        (a.prototype.readBigInt64BE = ee(function (e) {
          z((e >>>= 0), "offset");
          const t = this[e],
            r = this[e + 7];
          (void 0 !== t && void 0 !== r) || H(e, this.length - 8);
        ...
        (a.prototype.writeUintLE = a.prototype.writeUIntLE =
          function (e, t, r, o) {
            ((e = +e),
              (t >>>= 0),
              (r >>>= 0),
              o || G(this, e, t, r, Math.pow(2, 8 * r) - 1, 0));
            let n = 1,
              i = 0;
        ...
        (a.prototype.writeBigUInt64LE = ee(function (e, t = 0) {
          return B(this, e, t, BigInt(0), BigInt("0xffffffffffffffff"));
        })),
        (a.prototype.writeBigUInt64BE = ee(function (e, t = 0) {
        ...
        (a.prototype.writeBigInt64LE = ee(function (e, t = 0) {
          return B(
            this,
            e,
            t,
        ...
        (a.prototype.writeBigInt64BE = ee(function (e, t = 0) {
          return $(
            this,
            e,
            t,
        ...
        (a.prototype.fill = function (e, t, r, o) {
          ...
          if (
            ...
            const i = a.isBuffer(e) ? e : a.from(e, o),
              s = i.length;
            if (0 === s)
              throw new TypeError(
      ...
      function j(e, t, r, o, n, i) {
        if (e > r || e < t) {
          ...
          throw (
            ...
            new q.ERR_OUT_OF_RANGE("value", o, e)
          );
        }
        !(function (e, t, r) {
          (z(t, "offset"),
      ...
      function H(e, t, r) {
        if (Math.floor(e) !== e)
          throw (z(e, r), new q.ERR_OUT_OF_RANGE("offset", "an integer", e));
      ...
      function ee(e) {
        return "undefined" == typeof BigInt ? te : e;
      }
      function te() {
...
const G = () => P.getInstance();
function B(e, t, r) {
  const o = {
    availableTabs: e.map((e) => ({ tabId: e.id, title: e.title, url: e.url })),
  };
  return (
    void 0 !== r && (o.selectedTabId = r),
    void 0 !== t && (o.tabGroupId = t),
    JSON.stringify(o)
  );
}
function $(e) {
...
function q(e, t, r) {
  ...
  if (e <= n && t <= n && L(e, t, o) <= i) return [e, t];
  if (t > e) {
    const [o, n] = q(t, e, r);
    return [n, o];
  }
...
class V {
  ...
  async updateTabBlocklistStatus(e, t) {
    ...
    const o = t.includes("blocked.html"),
      n = o ? "category1" : await H.getCategory(t);
  ...
  async getGroupBlocklistStatus(e) {
    ...
    if (!t) {
      const t = await chrome.tabs.get(e);
      return await H.getCategory(t.url || "");
    }
  ...
  async getBlockedTabsInfo(e) {
    ...
    if (!t) {
      ...
      if (t.url?.includes("blocked.html"))
        ...
        const n = await H.getCategory(t.url || "");
        n &&
          "category0" !== n &&
          ((o = !0),
          r.push({
    ...
    for (const o of t)
      if (o.id && o.url)
        if (o.url.includes("blocked.html"))
          ...
          const e = await H.getCategory(o.url);
  ...
  async updateGroupTitle(e, t, r = !1) {
    ...
    if (o)
      try {
        if ((await chrome.tabGroups.get(o.chromeGroupId)).title !== K) return;
    ...
    if ((await this.initialize(), await this.loadMcpTabGroupId(), void 0 !== e))
      try {
        ...
        if (t) {
          ...
          if (n)
            try {
              o = new URL(n).hostname || void 0;
            } catch {}
          return { tabId: e, domain: o, url: n };
        }
      } catch {
  ...
  async isTabMcp(e) {
    if (
      !(
        !0 ===
        (await chrome.storage.local.get(t.MCP_CONNECTED))[t.MCP_CONNECTED]
      )
    )
      return !1;
  ...
  async ensureMcpGroupCharacteristics(e) {
    try {
      ...
      (t.title === Y && t.color === chrome.tabGroups.Color.YELLOW) ||
  ...
  async findMcpTabGroupByCharacteristics() {
    try {
      const e = await chrome.tabGroups.query({});
      for (const t of e)
        if (t.color === chrome.tabGroups.Color.YELLOW && t.title?.includes(Y)) {
...
class Z {
      ...
      ((globalThis.__cdpDebuggerEventHandler = (e, t, r) => {
        ...
        if (o) {
          ...
          if ("Network.responseReceived" === t) {
            const e = r.requestId,
              t = r.response,
              n = Z.networkRequestsByTab.get(o);
            if (n) {
          ...
          if ("Network.loadingFailed" === t) {
            const e = r.requestId,
              t = Z.networkRequestsByTab.get(o);
            if (t) {
  ...
  initializeDebuggerEventListener() {
    Z.debuggerListenerRegistered ||
      ((Z.debuggerListenerRegistered = !0),
  ...
  async attachDebugger(e) {
    const t = { tabId: e },
      r = Z.networkTrackingEnabled.has(e),
      o = Z.consoleTrackingEnabled.has(e);
    try {
  ...
  async click(e, t, r, o = "left", n = 1, i = 0, a) {
    a?.skipIndicator ||
      (await J.hideIndicatorForToolUse(e),
    ...
    try {
      ...
      ("left" === o
        ...
        a?.skipIndicator || (await new Promise((e) => setTimeout(e, 100))));
      for (let c = 1; c <= n; c++)
        (await this.dispatchMouseEvent(e, {
          type: "mousePressed",
          x: t,
          ...
          a?.skipIndicator || (await new Promise((e) => setTimeout(e, 12))),
          await this.dispatchMouseEvent(e, {
            type: "mouseReleased",
            x: t,
            y: r,
      ...
      a?.skipIndicator || (await J.restoreIndicatorAfterToolUse(e));
    }
  }
  async type(e, t) {
    for (const r of t) {
  ...
  addConsoleMessage(e, t, r) {
    let o = Z.consoleMessagesByTab.get(e);
    if (
      (o && o.domain !== t
        ? ((o = { domain: t, messages: [] }), Z.consoleMessagesByTab.set(e, o))
        : o ||
          ((o = { domain: t, messages: [] }), Z.consoleMessagesByTab.set(e, o)),
      o.messages.length > 0)
    ) {
    ...
    if ((o.messages.push(r), o.messages.length > Z.MAX_LOGS_PER_TAB)) {
      const e = o.messages.length - Z.MAX_LOGS_PER_TAB;
  ...
  async enableConsoleTracking(e) {
    try {
      (await this.sendCommand(e, "Runtime.enable"),
        Z.consoleTrackingEnabled.add(e));
    } catch (t) {
      throw t;
    }
  }
  getConsoleMessages(e, t = !1, r) {
    const o = Z.consoleMessagesByTab.get(e);
    if (!o) return [];
    let n = o.messages;
    if (
  ...
  clearConsoleMessages(e) {
    Z.consoleMessagesByTab.delete(e);
  }
  addNetworkRequest(e, t, r) {
    let o = Z.networkRequestsByTab.get(e);
    if (
      (o
        ? o.domain !== t && ((o.domain = t), (o.requests = []))
        : ((o = { domain: t, requests: [] }), Z.networkRequestsByTab.set(e, o)),
      o.requests.push(r),
      o.requests.length > Z.MAX_REQUESTS_PER_TAB)
    ) {
      const e = o.requests.length - Z.MAX_REQUESTS_PER_TAB;
      o.requests.splice(0, e);
    }
  }
  async enableNetworkTracking(e) {
    try {
      Z.debuggerListenerRegistered || this.initializeDebuggerEventListener();
      try {
        (await this.sendCommand(e, "Network.disable"),
          await new Promise((e) => setTimeout(e, 50)));
      } catch {}
      (await this.sendCommand(e, "Network.enable", { maxPostDataSize: 65536 }),
        Z.networkTrackingEnabled.add(e));
    } catch (t) {
      throw t;
    }
  }
  getNetworkRequests(e, t) {
    const r = Z.networkRequestsByTab.get(e);
    if (!r) return [];
    let o = r.requests;
    return (t && (o = o.filter((e) => e.url.includes(t))), o);
  }
  clearNetworkRequests(e) {
    Z.networkRequestsByTab.delete(e);
  }
  isNetworkTrackingEnabled(e) {
    return Z.networkTrackingEnabled.has(e);
  }
  async screenshot(e, t, r) {
    const o = t || this.defaultResizeParams,
      n = r?.format ?? "png",
      i = r?.quality ?? 100 * Z.INITIAL_JPEG_QUALITY;
    r?.skipIndicator ||
      (await J.hideIndicatorForToolUse(e),
      await new Promise((e) => setTimeout(e, 50)));
    try {
      ...
      const { width: r, height: a, devicePixelRatio: s } = t[0].result,
        c = await this.sendCommand(e, "Page.captureScreenshot", {
          format: n,
          ...(("jpeg" === n || "webp" === n) && { quality: i }),
      ...
      if ("undefined" == typeof Image)
        return await this.processScreenshotInContentScript(e, u, r, a, s, o);
      const l = `data:image/${n};base64,${u}`,
        d = await new Promise((e, t) => {
          ...
          ((i.onload = () => {
            ...
            const p = s > 1;
            p &&
              ((c = Math.round(i.width / s)), (l = Math.round(i.height / s)));
            const [f, m] = q(c, l, o),
              g = c !== f || l !== m;
            if (!p && !g)
              return void e({
            ...
            if (
              ...
              (d.height = l),
              p
                ? h.drawImage(i, 0, 0, i.width, i.height, 0, 0, c, l)
                : h.drawImage(i, 0, 0),
              !g)
            ) {
              const t = d.toDataURL(`image/${n}`).split(",")[1];
              return void e({
                base64: t,
                width: c,
                height: l,
            ...
            ((b.width = f),
              (b.height = m),
              w.drawImage(d, 0, 0, c, l, 0, 0, f, m));
            const y = b.toDataURL(`image/${n}`).split(",")[1];
            e({
              base64: y,
              width: f,
              height: m,
      ...
      return (F.setContext(e, d), d);
    } finally {
      r?.skipIndicator || (await J.restoreIndicatorAfterToolUse(e));
    }
  }
...
const oe = {
  ...
  execute: async (e, t) => {
    try {
      const n = e || {};
      if (!n.action) throw new Error("Action parameter is required");
      if (!t?.tabId) throw new Error("No active tab found in context");
      const i = await J.getEffectiveTabId(n.tabId, t.tabId),
        a = await chrome.tabs.get(i);
      if (!a.id) throw new Error("Active tab has no ID");
      if (!["wait"].includes(n.action)) {
        const e = a.url;
        if (!e) throw new Error("No URL available for active tab");
        const s = (function (e) {
            const t = {
              screenshot: r.READ_PAGE_CONTENT,
              scroll: r.READ_PAGE_CONTENT,
              scroll_to: r.READ_PAGE_CONTENT,
              zoom: r.READ_PAGE_CONTENT,
              hover: r.READ_PAGE_CONTENT,
              left_click: r.CLICK,
              right_click: r.CLICK,
              double_click: r.CLICK,
              triple_click: r.CLICK,
              left_click_drag: r.CLICK,
              type: r.TYPE,
              key: r.TYPE,
            };
        ...
        if (!u.allowed) {
          if (u.needsPrompt) {
            ...
            if (
              "left_click" === n.action ||
              "right_click" === n.action ||
              "double_click" === n.action ||
              "triple_click" === n.action
            )
              try {
                const e = await ee.screenshot(i);
                ((t.actionData = {
                  screenshot: `data:image/${e.format};base64,${e.base64}`,
                }),
                  n.coordinate && (t.actionData.coordinate = n.coordinate));
              } catch (o) {
                ((t.actionData = {}),
                  n.coordinate && (t.actionData.coordinate = n.coordinate));
              }
            else
              "type" === n.action && n.text
                ? (t.actionData = { text: n.text })
                : "left_click_drag" === n.action &&
                  n.start_coordinate &&
                  n.coordinate &&
                  (t.actionData = {
                    start_coordinate: n.start_coordinate,
      ...
      const s = a.url;
      let c;
      const u = t.skipIndicator ? { skipIndicator: !0 } : void 0;
      switch (n.action) {
        case "left_click":
        case "right_click":
          c = await ie(i, n, 1, s, u);
          break;
        case "type":
          c = await (async function (e, t, r) {
            if (!t.text)
              throw new Error("Text parameter is required for type action");
            try {
              const o = await z(e, r, "type action");
              return (
                o || (await ee.type(e, t.text), { output: `Typed "${t.text}"` })
              );
            } catch (o) {
              return {
                error: `Failed to type: ${o instanceof Error ? o.message : "Unknown error"}`,
              };
            }
          })(i, n, s);
          break;
        ...
        case "scroll":
          c = await (async function (e, t, r, n) {
            ...
            let [i, a] = t.coordinate;
            const s = F.getContext(e);
            if (s) {
              const [e, t] = te(i, a, s);
              ((i = e), (a = t));
            }
            ...
            try {
              ...
              if (n?.skipIndicator) await ee.scrollWheel(e, i, a, t, s);
              else {
                const r = await se(e),
                  n = await chrome.tabs.get(e);
                if (n.active ?? !1)
                  try {
                    const o = ee.scrollWheel(e, i, a, t, s),
                      n = new Promise((e, t) => {
              ...
              if (!n?.skipIndicator) {
                const t = await (async function (e, t, r) {
                  try {
                    const o = await chrome.tabs.get(e);
                    if (!o?.url) return;
                    if ((await t.checkPermission(o.url, void 0)).allowed)
                      try {
                ...
                return {
                  output: `Scrolled ${c} by ${u} ticks at (${i}, ${a})`,
                  ...(t && {
                    base64Image: t.base64Image,
              ...
              return { output: `Scrolled ${c} by ${u} ticks at (${i}, ${a})` };
            } catch (o) {
              return {
                error: `Error scrolling: ${o instanceof Error ? o.message : "Unknown error"}`,
              };
            }
          })(i, n, t.permissionManager, u);
          break;
        case "key":
          c = await (async function (e, t, r) {
            if (!t.text)
            ...
            try {
              const o = await z(e, r, "key action");
              if (o) return o;
              const i = t.text
                .trim()
                .split(/\s+/)
              ...
              for (let t = 0; t < n; t++)
                for (const r of i)
                  if (r.includes("+")) await ee.pressKeyChord(e, r);
                  else {
                    const t = ee.getKeyCode(r);
                    t ? await ee.pressKey(e, t) : await ee.insertText(e, r);
                  }
              ...
              return {
                error: `Error pressing key: ${o instanceof Error ? o.message : "Unknown error"}`,
              };
            }
          })(i, n, s);
          break;
        case "left_click_drag":
          c = await (async function (e, t, r) {
            ...
            try {
              const t = await z(e, r, "drag action");
              return (
                t ||
                (await ee.dispatchMouseEvent(e, {
                  type: "mouseMoved",
                  x: n,
                  y: i,
                  button: "none",
              ...
              return {
                error: `Error performing drag: ${o instanceof Error ? o.message : "Unknown error"}`,
              };
            }
          })(i, n, s);
          break;
        case "double_click":
          c = await ie(i, n, 2, s, u);
          break;
        case "triple_click":
          c = await ie(i, n, 3, s, u);
          break;
        case "zoom":
          c = await (async function (e, t) {
            ...
            try {
              ...
              const { width: s, height: c } = o[0].result;
              if (i > s || a > c)
                throw new Error(
              ...
              const u = i - r,
                l = a - n,
                d = await ee.sendCommand(e, "Page.captureScreenshot", {
                  format: "png",
                  captureBeyondViewport: !1,
                  fromSurface: !0,
                  clip: { x: r, y: n, width: u, height: l, scale: 1 },
                });
              if (!d || !d.data)
                throw new Error("Failed to capture zoomed screenshot via CDP");
              return {
                output: `Successfully captured zoomed screenshot of region (${r},${n}) to (${i},${a}) - ${u}x${l} pixels`,
                base64Image: d.data,
                imageFormat: "png",
              };
            } catch (o) {
              return {
                error: `Error capturing zoomed screenshot: ${o instanceof Error ? o.message : "Unknown error"}`,
              };
            }
          })(i, n);
          break;
        case "scroll_to":
          c = await (async function (e, t, r) {
            ...
            try {
              const o = await z(e, r, "scroll_to action");
              if (o) return o;
              const n = await ne(e, t.ref);
              return n.success
                ? { output: `Scrolled to element with reference: ${t.ref}` }
                : { error: n.error };
            } catch (o) {
              return {
                error: `Failed to scroll to element: ${o instanceof Error ? o.message : "Unknown error"}`,
              };
            }
          })(i, n, s);
          break;
        case "hover":
          c = await (async function (e, t, r) {
            ...
            try {
              const o = await z(e, r, "hover action");
              return (
                o ||
                (await ee.dispatchMouseEvent(e, {
                  type: "mouseMoved",
              ...
              return {
                error: `Error hovering: ${o instanceof Error ? o.message : "Unknown error"}`,
              };
            }
          })(i, n, s);
          break;
      ...
      const l = await J.getValidTabsWithMetadata(t.tabId);
      return {
        ...c,
        tabContext: {
      ...
      return {
        error: `Failed to execute action: ${o instanceof Error ? o.message : "Unknown error"}`,
      };
    }
  },
...
async function ie(e, t, r = 1, o, n) {
  ...
  try {
    const u = await z(e, o, "click action");
    if (u) return u;
    await ee.click(e, i, a, s, r, c, n);
    const l =
    ...
    return {
      error: `Error clicking: ${u instanceof Error ? u.message : "Unknown error"}`,
    };
  }
}
async function ae(e, t) {
  try {
    const r = await ee.screenshot(e, void 0, t),
      o = k();
    return (
...
const ce = {
    ...
    execute: async (e, t) => {
      try {
        const { url: n, tabId: i } = e;
        if (!n) throw new Error("URL parameter is required");
        if (!t?.tabId) throw new Error("No active tab found");
        const a = await J.getEffectiveTabId(i, t.tabId);
        if (n && !["back", "forward"].includes(n.toLowerCase()))
          try {
            const e = await H.getCategory(n);
            if (
              e &&
              ("category1" === e ||
                "category2" === e ||
        ...
        if ("back" === n.toLowerCase()) {
          (await chrome.tabs.goBack(s.id),
            await new Promise((e) => setTimeout(e, 100)));
          const e = await chrome.tabs.get(s.id),
            r = await J.getValidTabsWithMetadata(t.tabId);
          return {
        ...
        (await chrome.tabs.update(a, { url: c }),
          await new Promise((e) => setTimeout(e, 100)));
        const d = await J.getValidTabsWithMetadata(t.tabId);
        return {
        ...
        return {
          error: `Failed to navigate: ${n instanceof Error ? n.message : "Unknown error"}`,
        };
      }
    },
    toAnthropicSchema: async () => ({
  ...
  ue = {
    ...
    execute: async (e, t) => {
      try {
        const { action: o, text: n, tabId: i } = e;
        if ("javascript_exec" !== o)
          throw new Error("'javascript_exec' is the only supported action");
        if (!n) throw new Error("Code parameter is required");
        if (!t?.tabId) throw new Error("No active tab found");
        const a = await J.getEffectiveTabId(i, t.tabId),
        ...
        const l = await z(a, s, "JavaScript execution");
        if (l) return l;
        const d = `\n        (function() {\n          'use strict';\n          try {\n            return eval(${JSON.stringify(n)});\n          } catch (e) {\n            throw e;\n          }\n        })()\n      `,
          h = await ee.sendCommand(a, "Runtime.evaluate", {
            expression: d,
            returnByValue: !0,
            awaitPromise: !0,
            timeout: 1e4,
        ...
        const w = await J.getValidTabsWithMetadata(t.tabId);
        return f
          ? {
        ...
        return {
          error: `Failed to execute JavaScript: ${o instanceof Error ? o.message : "Unknown error"}`,
        };
      }
    },
    toAnthropicSchema: async () => ({
...
async function pe(e, t) {
  ...
  const { approved: r, filtered: o } = await he(e);
...
const ye = {
    ...
    execute: async (e, t) => {
      ...
      if (!t?.tabId) throw new Error("No active tab found");
      const c = await J.getEffectiveTabId(n, t.tabId),
      ...
      (await J.hideIndicatorForToolUse(c),
        await new Promise((e) => setTimeout(e, 50)));
      try {
        const e = await chrome.scripting.executeScript({
          ...
          args: [o || null, i ?? null, s ?? 5e4, a ?? null],
        });
        if (!e || 0 === e.length)
        ...
        if (!e[0].result) throw new Error("Page script returned empty result");
        const n = `Viewport: ${r.viewport.width}x${r.viewport.height}`,
          l = await J.getValidTabsWithMetadata(t.tabId);
        return {
          output: `${r.pageContent}\n\n${n}`,
          tabContext: {
            currentTabId: t.tabId,
            executedOnTabId: c,
            availableTabs: l,
        ...
        await J.restoreIndicatorAfterToolUse(c);
      }
    },
    toAnthropicSchema: async () => ({
      name: "read_page",
  ...
  ve = {
    ...
    execute: async (e, t) => {
      try {
        ...
        if (!t?.tabId) throw new Error("No active tab found");
        const n = await J.getEffectiveTabId(o.tabId, t.tabId),
          i = await chrome.tabs.get(n);
        ...
        const l = await z(i.id, u, "form input action");
        if (l) return l;
        ...
        const h = await J.getValidTabsWithMetadata(t.tabId);
        return {
          ...d[0].result,
          tabContext: {
            currentTabId: t.tabId,
        ...
        return {
          error: `Failed to execute form input: ${o instanceof Error ? o.message : "Unknown error"}`,
        };
      }
    },
    toAnthropicSchema: async () => ({
  ...
  Ie = {
    ...
    execute: async (e, t) => {
      const { tabId: o, max_chars: n } = e || {};
      if (!t?.tabId) throw new Error("No active tab found");
      const i = await J.getEffectiveTabId(o, t.tabId),
      ...
      (await J.hideIndicatorForToolUse(i),
        await new Promise((e) => setTimeout(e, 50)));
      try {
        const e = await chrome.scripting.executeScript({
          target: { tabId: i },
        ...
        if (!e[0].result) throw new Error("Page script returned empty result");
        const r = e[0].result,
          o = await J.getValidTabsWithMetadata(t.tabId);
        return r.error
          ? {
              error: r.error,
              tabContext: {
        ...
        await J.restoreIndicatorAfterToolUse(i);
      }
    },
    toAnthropicSchema: async () => ({
      name: "get_page_text",
  ...
  _e = {
    ...
    execute: async (e, t) => {
      try {
        const { query: o, tabId: n } = e;
        if (!o) throw new Error("Query parameter is required");
        if (!t?.tabId) throw new Error("No active tab found");
        const i = await J.getEffectiveTabId(n, t.tabId),
          a = await chrome.tabs.get(i);
        if (!a.id) throw new Error("Active tab has no ID");
        const s = a.url;
        if (!s) throw new Error("No URL available for active tab");
        ...
        if ("error" in l[0] && l[0].error)
          throw new Error(
            `Script execution failed: ${l[0].error.message || "Unknown error"}`,
          );
        ...
        y &&
          (v += ` (showing first ${b.length}, use a more specific query to narrow results)`);
        const I = b
          .map(
            (e) =>
          ...
          .join("\n");
        b.length;
        const _ = await J.getValidTabsWithMetadata(t.tabId);
        return {
          output: `${v}\n\n${I}`,
          tabContext: {
            currentTabId: t.tabId,
        ...
        return {
          error: `Failed to find element: ${o instanceof Error ? o.message : "Unknown error"}`,
        };
      }
    },
    toAnthropicSchema: async () => ({
  ...
  Ee = {
    ...
    execute: async (e, t) => {
      try {
        ...
        const o = await J.getValidTabsWithMetadata(t.tabId);
        return {
...
const Ce = {
    ...
    async execute(e, t) {
      ...
      if (o) return { error: JSON.stringify(o.error) };
      const { domains: n, approach: i } = e,
        a = await (async function (e) {
          const t = [];
          for (const o of e)
            try {
              const e = o.startsWith("http") ? o : `https://${o}`,
                r = await H.getCategory(e);
  ...
  Se = {
    ...
    execute: async (e, t) => {
      try {
        const o = e;
        if (!o?.imageId) throw new Error("imageId parameter is required");
        if (!o?.ref && !o?.coordinate)
          throw new Error(
        ...
        (console.info(`[Upload-Image] Looking for image with ID: ${o.imageId}`),
          console.info(
            `[Upload-Image] Messages available: ${t.messages.length}`,
          ));
        const l = be(t.messages, o.imageId);
        if (!l)
          return {
            error: `Image not found with ID: ${o.imageId}. Please ensure the image was captured or uploaded earlier in this conversation.`,
          };
        const d = l.base64,
          h = await z(i.id, u, "upload image action");
        if (h) return h;
        const p = await chrome.scripting.executeScript({
          ...
          args: [
            ...
            o.coordinate || null,
            d,
            o.filename || "image.png",
          ],
        });
        if (!p || 0 === p.length)
          throw new Error("Failed to execute upload image");
        const f = await J.getValidTabsWithMetadata(t.tabId);
        return {
          ...p[0].result,
          tabContext: {
            currentTabId: t.tabId,
        ...
        return {
          error: `Failed to upload image: ${o instanceof Error ? o.message : "Unknown error"}`,
        };
      }
    },
    toAnthropicSchema: async () => ({
  ...
  Ae = {
    ...
    execute: async (e, t) => {
      try {
        ...
        if (!i.id) throw new Error("Active tab has no ID");
        const a = i.url;
        if (!a) throw new Error("No URL available for tab");
        const s = t?.toolUseId,
          c = await t.permissionManager.checkPermission(a, s);
        if (!c.allowed) {
          if (c.needsPrompt) {
        ...
        if (!u)
          return { error: "Unable to get original URL for security check" };
        const l = await z(i.id, u, "file upload action");
        if (l) return l;
        const d = `data-claude-upload-${Date.now()}`,
          h = await chrome.scripting.executeScript({
            target: { tabId: i.id },
            func: (e, t) => {
        ...
        const f = await ee.sendCommand(i.id, "Runtime.evaluate", {
          expression: `document.querySelector('[${d}="1"]')`,
          returnByValue: !1,
        });
        ...
        const m = f.result?.objectId;
        if (!m) return { error: "Failed to get object reference for element" };
        (await ee.sendCommand(i.id, "DOM.enable"),
          await ee.sendCommand(i.id, "DOM.setFileInputFiles", {
            files: o.paths,
            objectId: m,
          }),
          await ee.sendCommand(i.id, "DOM.disable"),
          await chrome.scripting.executeScript({
            target: { tabId: i.id },
            func: (e, t) => {
              const r = window.__claudeElementMap;
        ...
        const g = o.paths.map((e) => {
            const t = e.split(/[/\\]/);
            return t[t.length - 1];
          }),
          b = await J.getValidTabsWithMetadata(t.tabId);
        return {
          output: `Uploaded ${o.paths.length} file(s) to file input: ${g.join(", ")}`,
          tabContext: {
            currentTabId: t.tabId,
            executedOnTabId: n,
            availableTabs: b,
  ...
  De = {
    ...
    execute: async (e, t) => {
      try {
        ...
        if (!t?.tabId) throw new Error("No active tab found");
        const u = await J.getEffectiveTabId(n, t.tabId),
        ...
        try {
          await ee.enableConsoleTracking(l.id);
        } catch (o) {}
        const f = ee.getConsoleMessages(l.id, i, s);
        if ((a && ee.clearConsoleMessages(l.id), 0 === f.length)) {
          return {
            ...
            tabContext: {
              currentTabId: t.tabId,
              executedOnTabId: u,
              availableTabs: await J.getValidTabsWithMetadata(t.tabId),
              tabCount: (await J.getValidTabsWithMetadata(t.tabId)).length,
            },
          };
        }
        const m = f.slice(0, c),
          ...
          I = await J.getValidTabsWithMetadata(t.tabId);
        return {
          output: `${v}\n\n${b}`,
          tabContext: {
            currentTabId: t.tabId,
        ...
        return {
          error: `Failed to read console messages: ${o instanceof Error ? o.message : "Unknown error"}`,
        };
      }
    },
    toAnthropicSchema: async () => ({
  ...
  Me = {
    ...
    execute: async (e, t) => {
      try {
        const { tabId: n, urlPattern: i, clear: a = !1, limit: s = 100 } = e;
        if (!t?.tabId) throw new Error("No active tab found");
        const c = await J.getEffectiveTabId(n, t.tabId),
          u = await chrome.tabs.get(c);
        if (!u.id) throw new Error("Active tab has no ID");
        ...
        try {
          await ee.enableNetworkTracking(u.id);
        } catch (o) {}
        const p = ee.getNetworkRequests(u.id, i);
        if ((a && ee.clearNetworkRequests(u.id), 0 === p.length)) {
        ...
        return {
          error: `Failed to read network requests: ${o instanceof Error ? o.message : "Unknown error"}`,
        };
      }
    },
    toAnthropicSchema: async () => ({
  ...
  Pe = {
    ...
    execute: async (e, o) => {
      try {
        const n = e;
        if (!n?.action) throw new Error("action parameter is required");
        if (!o?.tabId) throw new Error("No active tab found in context");
        const i = await chrome.tabs.get(n.tabId);
        if (!i) throw new Error(`Tab ${n.tabId} not found`);
        const a = i.groupId ?? -1;
        if (o.sessionId === ke) {
          const e = await chrome.storage.local.get(t.MCP_TAB_GROUP_ID);
          if (a !== e[t.MCP_TAB_GROUP_ID])
            return {
              error: `Tab ${n.tabId} is not in the MCP tab group. GIF recording only works for tabs within the MCP tab group.`,
            };
        }
        switch (n.action) {
          case "start_recording":
            return await (async function (e) {
              const t = Ue.isRecording(e);
              if (t)
                return {
                  output:
          ...
          case "export":
            return await (async function (e, t, o, n) {
              ...
              if (!i) {
                const o = t.url,
                  i = n?.toolUseId,
                  a = await n.permissionManager.checkPermission(o, i);
                if (!a.allowed) {
                  if (a.needsPrompt) {
                    return {
                      type: "permission_required",
              ...
              const c = a.map((e) => ({
                  ...
                  format: "png",
                  action: e.action,
                  delay: e.action ? Ge(e.action.type) : 800,
              ...
              if (i) {
                ...
                const r = await z(t.id, s, "GIF export upload action");
                if (r) return r;
                const o = await chrome.scripting.executeScript({
                  target: { tabId: t.id },
                  func: (e, t, r, o) => {
              ...
              Ue.clearFrames(o);
              const f = await J.getValidTabsWithMetadata(n.tabId);
              return {
                output: p,
                tabContext: {
                  currentTabId: n.tabId,
          ...
          default:
            throw new Error(
              `Unknown action: ${n.action}. Must be one of: start_recording, stop_recording, export, clear`,
            );
        }
      } catch (n) {
        return {
          error: `Failed to execute gif_creator: ${n instanceof Error ? n.message : "Unknown error"}`,
        };
      }
    },
    toAnthropicSchema: async () => ({
...
const Be = { type: "object", properties: {}, required: [] },
  $e = {
...
async function Oe(e, t) {
  const r = t === e;
  await J.initialize();
  const o = await J.findGroupByTab(t);
  return {
    isMainTab: r,
...
async function Fe(e, t) {
  const r = await H.getCategory(t);
  return (await J.updateTabBlocklistStatus(e, t), r ?? null);
}
function We(e) {
...
async function He() {
  const r = n(),
    o = await e();
  if (!o) throw new Error("No valid OAuth token available for feature fetch");
  const a = await fetch(
    `${r.apiBaseUrl}/api/bootstrap/features/claude_in_chrome`,
    {
      headers: {
  ...
  if (401 === a.status)
    throw (
      await i([t.ACCESS_TOKEN, t.TOKEN_EXPIRY]),
      new Error("OAuth token rejected by server (401)")
    );
  if (!a.ok) throw new Error(`Failed to fetch features: ${a.status}`);
  return a.json();
}
function Ke() {
  return (ze || (ze = new o({ fetchFeatures: He })), ze);
}
async function Ye(e) {
  const t = Ke();
  await t.initialize();
  const r = await t.getFeatureValueAsync(e, {});
  return (o = r) &&
    "object" == typeof o &&
    Object.keys(o).some((e) => void 0 !== o[e] && null !== o[e])
    ? r
    : {};
  var o;
}
...
var Je = (function (e) {
  function t(t, r) {
    var o = e.call(this, "".concat(t, " ").concat(r)) || this;
    return ((o.field = t), o);
  }
  return (a(t, e), t);
})(Error);
...
function Ze(e) {
  return (
    "object" === Object.prototype.toString.call(e).slice(8, -1).toLowerCase()
  );
}
var et = "is not a string",
  tt = "is not an object",
  rt = "is nil";
function ot(e) {
  (!(function (e) {
    if (!Qe(e)) throw new Je("Event", rt);
    if ("object" != typeof e) throw new Je("Event", tt);
  })(e),
    (function (e) {
      if (!Xe(e.type)) throw new Je(".type", et);
    })(e),
    "track" === e.type &&
      ((function (e) {
        if (!Xe(e.event)) throw new Je(".event", et);
      })(e),
      (function (e) {
        if (!Ze(e.properties)) throw new Je(".properties", tt);
      })(e)),
    ["group", "identify"].includes(e.type) &&
      (function (e) {
        if (!Ze(e.traits)) throw new Je(".traits", tt);
      })(e),
    (function (e) {
      var t,
        r,
        ...
        a =
          null !==
            (n =
              null !==
                (o =
                  null !== (r = (t = e).userId) && void 0 !== r
                    ? r
                    : t.anonymousId) && void 0 !== o
                ? o
                : t.groupId) && void 0 !== n
            ? n
            : t.previousId;
      if (!Qe(a)) throw new Je(i, rt);
      if (!Xe(a)) throw new Je(i, et);
    })(e));
}
var nt = (function () {
  function e(e) {
    ((this.user = e.user), (this.createMessageId = e.createMessageId));
  }
  return (
    (e.prototype.track = function (e, t, r, o) {
    ...
    (e.prototype.page = function (e, t, r, o, n) {
      var i,
        a = {
          type: "page",
          properties: s({}, r),
      ...
      return (
        null !== e &&
          ((a.category = e),
          (a.properties = null !== (i = a.properties) && void 0 !== i ? i : {}),
          (a.properties.category = e)),
        null !== t && (a.name = t),
        this.normalize(s(s({}, this.baseEvent()), a))
      );
    }),
    (e.prototype.screen = function (e, t, r, o, n) {
      var i = {
        type: "screen",
        properties: s({}, r),
        options: s({}, o),
    ...
    (e.prototype.identify = function (e, t, r, o) {
      return this.normalize(
        s(s({}, this.baseEvent()), {
          type: "identify",
          userId: e,
    ...
    (e.prototype.group = function (e, t, r, o) {
      return this.normalize(
        s(s({}, this.baseEvent()), {
          type: "group",
          traits: null != t ? t : {},
    ...
    (e.prototype.alias = function (e, t, r, o) {
      var n = {
        userId: e,
        type: "alias",
        options: s({}, r),
      ...
      return (
        null !== t && (n.previousId = t),
        void 0 === e
          ? this.normalize(s(s({}, n), this.baseEvent()))
          : this.normalize(s(s({}, this.baseEvent()), n))
      );
    }),
    (e.prototype.baseEvent = function () {
      var e = { integrations: {}, options: {} };
      if (!this.user) return e;
      var t = this.user;
      return (
        t.id() && (e.userId = t.id()),
        t.anonymousId() && (e.anonymousId = t.anonymousId()),
        e
      );
    }),
    (e.prototype.context = function (e) {
      var t,
        r = ["userId", "anonymousId", "timestamp"];
      delete e.integrations;
      var o = Object.keys(e),
        n = null !== (t = e.context) && void 0 !== t ? t : {},
        i = {};
      return (
        o.forEach(function (t) {
          "context" !== t && (r.includes(t) ? c(i, t, e[t]) : c(n, t, e[t]));
        }),
        [n, i]
      );
    }),
    (e.prototype.normalize = function (e) {
      var t,
        ...
        n,
        i = Object.keys(
          null !== (t = e.integrations) && void 0 !== t ? t : {},
        ).reduce(function (t, r) {
          var o, n;
          return s(
            s({}, t),
            (((o = {})[r] = Boolean(
              null === (n = e.integrations) || void 0 === n ? void 0 : n[r],
            )),
            o),
          );
        }, {});
      ...
      var a = s(
        ...
        c = e.options ? this.context(e.options) : [],
        l = c[0],
        d = c[1];
      e.options;
      var h = u(e, ["options"]),
        p = s(
          s(s({ timestamp: new Date() }, h), { integrations: a, context: l }),
          d,
        ),
        f = s(s({}, p), { messageId: this.createMessageId() });
      return (ot(f), f);
    }),
    e
  );
...
function it(e, t) {
  return new Promise(function (r, o) {
    var n = setTimeout(function () {
      o(Error("Promise timed out"));
    }, t);
    e.then(function (e) {
      return (clearTimeout(n), r(e));
    }).catch(o);
  });
}
function at(e, t, r) {
...
var st = (function () {
  function e(e) {
    ...
    ((this.callbacks = {}),
      (this.warned = !1),
      (this.maxListeners =
        null !== (t = null == e ? void 0 : e.maxListeners) && void 0 !== t
          ? t
          : 10));
  }
  return (
      ...
      var r = this,
        o = function () {
          for (var n = [], i = 0; i < arguments.length; i++)
            n[i] = arguments[i];
          (r.off(e, o), t.apply(r, n));
        };
      return (this.on(e, o), this);
    }),
    (e.prototype.off = function (e, t) {
      var r,
        o = (null !== (r = this.callbacks[e]) && void 0 !== r ? r : []).filter(
          function (e) {
            return e !== t;
          },
        );
    ...
    (e.prototype.emit = function (e) {
      for (var t, r = this, o = [], n = 1; n < arguments.length; n++)
        o[n - 1] = arguments[n];
      return (
        (null !== (t = this.callbacks[e]) && void 0 !== t ? t : []).forEach(
          function (e) {
            e.apply(r, o);
          },
        ),
...
function ct(e) {
  var t = Math.random() + 1,
    ...
    s = e.maxTimeout,
    c = void 0 === s ? 1 / 0 : s;
  return Math.min(t * o * Math.pow(i, a), c);
}
var ut = "onRemoveFromFuture",
  lt = (function (e) {
    function t(t, r, o) {
  ...
  dt = (function () {
    ...
    return (
      (e.prototype.log = function (e, t, r) {
        var o = new Date();
        this._logs.push({ level: e, message: t, time: o, extras: r });
      }),
        ...
        if (this.logs.length > 1) {
          var e = this._logs.reduce(function (e, t) {
            ...
            var a =
              null !==
                (n =
                  null === (o = t.time) || void 0 === o
                    ? void 0
                    : o.toISOString()) && void 0 !== n
                ? n
                : "";
            return (
          ...
          console.table && console.table(e);
        } else
          this.logs.forEach(function (e) {
            var t = e.level,
              r = e.message,
              o = e.extras;
            "info" === t || "debug" === t || console[t](r, null != o ? o : "");
          });
        this._logs = [];
      }),
      e
    ...
    (function () {
      ...
      return (
        ...
        (e.prototype.flush = function () {
          ...
          (console.table && console.table(e), (this.metrics = []));
        }),
        (e.prototype.serialize = function () {
          return this.metrics.map(function (e) {
            return {
              ...
              v: e.value,
              t: e.tags,
              k: ((t = e.type), { gauge: "g", counter: "c" }[t]),
              e: e.timestamp,
            };
            var t;
          });
  ...
  pt = (function () {
    return function (e) {
      ...
      ((this.retry = null === (t = e.retry) || void 0 === t || t),
        (this.type =
          null !== (r = e.type) && void 0 !== r ? r : "plugin Error"),
        (this.reason = null !== (o = e.reason) && void 0 !== o ? o : ""));
    };
  })(),
  ft = (function () {
    function e(e, t, r, o) {
    ...
    return (
      ...
      (e.prototype.cancel = function (e) {
        if (e) throw e;
        throw new pt({ reason: "Context Cancel" });
      }),
      (e.prototype.log = function (e, t, r) {
      ...
      (e.prototype.updateEvent = function (e, t) {
        ...
        if ("integrations" === e.split(".")[0]) {
          ...
          if (
            !1 ===
            (null === (r = this.event.integrations) || void 0 === r
              ? void 0
              : r[o])
          )
            return this.event;
        }
        return (c(this.event, e, t), this.event);
      }),
  ...
  return void 0 === o
    ...
    : (function (e) {
        ...
        .then(function (e) {
          ...
          return (
            e.stats.gauge("plugin_time", o, ["plugin:".concat(t.name)]),
            e
          );
        })
        .catch(function (r) {
          if (r instanceof pt && "middleware_cancellation" === r.type) throw r;
          return r instanceof pt
            ? (e.log("warn", r.type, { plugin: t.name, error: r }), r)
...
var bt = (function (e) {
  ...
  return (
                  ...
                  .catch(function (r) {
                    if ("destination" === t.type)
                      return (
                        ...
                        void e.log("warn", "Failed to load destination", {
                          plugin: t.name,
                          error: r,
                        })
                      );
          ...
          switch (i.label) {
            ...
            case 4:
              throw (
                (o = i.sent()),
                (n = o),
                e.log("error", "Failed to deliver", n),
                this.emit("delivery_failure", e, n),
    ...
    (t.prototype.enqueuRetry = function (e, t) {
      return !(e instanceof pt && !e.retry) && this.queue.pushWithBackoff(t);
    }),
    (t.prototype.flush = function () {
      return h(this, void 0, void 0, function () {
        var e, t;
      ...
      var t,
        ...
        o = this.plugins.filter(function (t) {
          ...
          return (
            ...
            null !== (n = null !== (o = e[t.name]) && void 0 !== o ? o : i) &&
            void 0 !== n
              ? n
        ...
        n =
          ...
          o.forEach(function (e) {
            var o,
              n,
              i = e[t];
            void 0 !== (n = "string" != typeof i ? JSON.stringify(i) : i) &&
              (r[n] = d(
                d([], null !== (o = r[n]) && void 0 !== o ? o : [], !0),
                [e],
                !1,
              ));
          }),
          ...
          switch (p.label) {
            case 0:
              ...
              (e.attempts > 1 && this.emit("delivery_retry", e),
                ...
                (p.label = 1));
            case 1:
              return a < s.length ? ((c = s[a]), [4, gt(e, c)]) : [3, 4];
            case 2:
              ((h = p.sent()) instanceof ft && (e = h),
            ...
            case 4:
              ((u = 0), (l = i), (p.label = 5));
            case 5:
              return u < l.length ? ((d = l[u]), [4, mt(e, d)]) : [3, 8];
            case 6:
              ((h = p.sent()) instanceof ft && (e = h),
...
class yt {
  constructor(e) {
    ((this.id = l()),
      (this.items = []),
      (this.sizeInBytes = 0),
      (this.maxEventCount = Math.max(1, e)));
  }
  tryAdd(e) {
    ...
    const t = this.calculateSize(e.context);
    return t > 32768
      ? { success: !1, message: "Event exceeds maximum event size of 32 KB" }
      : this.sizeInBytes + t > 491520
        ? {
            success: !1,
            message: "Event has caused batch size to exceed 480 KB",
          }
        : (this.items.push(e), (this.sizeInBytes += t), { success: !0 });
  }
  get length() {
    return this.items.length;
  }
  calculateSize(e) {
    return encodeURI(JSON.stringify(e.event)).split(/%..|i/).length;
  }
  getEvents() {
    return this.items.map(({ context: e }) => e.event);
  }
  getContexts() {
    return this.items.map((e) => e.context);
  }
  resolveEvents() {
    this.items.forEach(({ resolver: e, context: t }) => e(t));
  }
}
function vt(e) {
...
class _t {
  constructor(
    ...
    ((this._emitter = u),
      (this._maxRetries = r),
      (this._flushAt = Math.max(o, 1)),
      (this._flushInterval = n),
      (this._auth = ((l = `${i}:`), U.Buffer.from(l).toString("base64"))),
      (this._url = ((e, t) => new URL(t || "", e).href.replace(/\/$/, ""))(
        e ?? "https://api.segment.io",
        t ?? "/v1/batch",
      )),
      (this._httpRequestTimeout = a ?? 1e4),
      (this._disable = Boolean(c)),
      (this._httpClient = s));
  }
  createBatch() {
    this.pendingFlushTimeout && clearTimeout(this.pendingFlushTimeout);
    const e = new yt(this._flushAt);
    return (
      (this._batch = e),
      (this.pendingFlushTimeout = setTimeout(() => {
        (e === this._batch && (this._batch = void 0),
          (this.pendingFlushTimeout = void 0),
          e.length && this.send(e).catch(It));
      }, this._flushInterval)),
      e
    );
  }
  ...
  flush(e) {
    if (!e) return;
    if (((this._flushPendingItemsCount = e), !this._batch)) return;
    this._batch.length === e &&
      (this.send(this._batch).catch(It), this.clearBatch());
  }
  enqueue(e) {
    const t = this._batch ?? this.createBatch(),
      { promise: r, resolve: o } = (function () {
        var e,
          t,
      ...
      n = { context: e, resolver: o };
    if (t.tryAdd(n).success) {
      const e = t.length === this._flushPendingItemsCount;
      return (
        (t.length === this._flushAt || e) &&
          (this.send(t).catch(It), this.clearBatch()),
        r
      );
    }
    t.length && (this.send(t).catch(It), this.clearBatch());
    const i = this.createBatch(),
      a = i.tryAdd(n);
    if (a.success) {
      return (
        i.length === this._flushPendingItemsCount &&
          (this.send(i).catch(It), this.clearBatch()),
        r
      );
    }
    return (
      e.setFailedDelivery({ reason: new Error(a.message) }),
      Promise.resolve(e)
    );
  }
  async send(e) {
    this._flushPendingItemsCount && (this._flushPendingItemsCount -= e.length);
    const t = e.getEvents(),
      r = this._maxRetries + 1;
    let o = 0;
    for (; o < r; ) {
      let i;
      o++;
      try {
        if (this._disable) return e.resolveEvents();
        const r = {
          url: this._url,
          method: "POST",
          headers: {
        ...
        const o = await this._httpClient.makeRequest(r);
        if (o.status >= 200 && o.status < 300) return void e.resolveEvents();
        if (400 === o.status)
          return void kt(e, new Error(`[${o.status}] ${o.statusText}`));
        i = new Error(`[${o.status}] ${o.statusText}`);
      } catch (n) {
        i = n;
      }
      if (o === r) return void kt(e, i);
      await vt(ct({ attempt: o, minTimeout: 25, maxTimeout: 1e3 }));
    }
  }
}
function kt(e, t) {
  (e.getContexts().forEach((e) => e.setFailedDelivery({ reason: t })),
    e.resolveEvents());
}
var Tt = {};
const Et = () =>
...
function xt(e) {
  function t(t) {
    return (
      (function (e) {
        (e.updateEvent("context.library.name", "@segment/analytics-node"),
          e.updateEvent("context.library.version", wt));
        const t = Et();
        ("node" === t &&
          e.updateEvent("_metadata.nodeVersion", process.version),
          e.updateEvent("_metadata.jsRuntime", t));
      })(t),
      e.enqueue(t)
    );
  }
...
const Ct = () => `node-next-${Date.now()}-${l()}`;
class St extends nt {
  constructor() {
    super({ createMessageId: Ct });
  }
}
class At extends ft {
  static system() {
...
const Dt = async (e, t, r, o) => {
  try {
    const i = new At(e),
      a = await (function (e, t, r, o) {
        return h(this, void 0, void 0, function () {
          var n, i;
          return p(this, function (a) {
            switch (a.label) {
              ...
              case 3:
                ((i = a.sent()), (a.label = 4));
              case 4:
                return (null == o ? void 0 : o.callback)
                  ? [
                      4,
                      at(
                        i,
              ...
              case 5:
                ((i = a.sent()), (a.label = 6));
              case 6:
                return ((null == o ? void 0 : o.debug) && i.flush(), [2, i]);
            }
            var s, c, u;
          });
        });
        ...
        ...(o
          ? {
              callback:
                ((n = o),
                (e) => {
                  const t = e.failedDelivery();
                  return n(t ? t.reason : void 0, e);
                }),
            }
          : {}),
      }),
      s = a.failedDelivery();
    s
      ? r.emit("error", { code: "delivery_failure", reason: s.reason, ctx: a })
      : r.emit(e.type, a);
  } catch (i) {
    r.emit("error", { code: "unknown", reason: i });
  }
  var n;
};
class Mt extends st {}
...
class Pt {
  ...
  dispatchEvent(e) {
    const t = { type: e, target: this },
      r = `on${e}`;
    ("function" == typeof this[r] && this[r](t), this.eventEmitter.emit(e, t));
  }
}
class Gt {
  constructor() {
...
const Bt = async (...e) => {
  if (globalThis.fetch) return globalThis.fetch(...e);
  if ("string" != typeof EdgeRuntime)
    return (
      await f(
        async () => {
          const { default: e } = await import("./index-DeoomIOo.js");
          return { default: e };
        },
...
class $t {
  ...
  async makeRequest(e) {
    const [t, r] = ((e) => {
        if ("cloudflare-worker" === Et()) return [];
        const t = new (globalThis.AbortController || Gt)(),
          r = setTimeout(() => {
            t.abort();
          }, e);
        return (r?.unref?.(), [t.signal, r]);
      })(e.httpRequestTimeout),
      o = {
        url: e.url,
        method: e.method,
        headers: e.headers,
    ...
    return this._fetch(e.url, o).finally(() => clearTimeout(r));
  }
}
class Ot extends Mt {
  constructor(e) {
    (super(),
      ...
      (this._isFlushing = !1),
      ((e) => {
        if (!e.writeKey) throw new Je("writeKey", "writeKey is missing.");
      })(e),
      (this._eventFactory = new St()),
      (this._queue = new Ut()));
    const t = e.flushInterval ?? 1e4;
    this._closeAndFlushDefaultTimeout = 1.25 * t;
    const { plugin: r, publisher: o } = ((e, t) => {
      const r = new _t(e, t);
      return { publisher: r, plugin: xt(r) };
    })(
      {
        writeKey: e.writeKey,
        host: e.host,
        ...
        flushAt: e.flushAt ?? e.maxEventsInBatch ?? 15,
        httpRequestTimeout: e.httpRequestTimeout,
        disable: e.disable,
        flushInterval: t,
        httpClient:
          "function" == typeof e.httpClient
            ? new $t(e.httpClient)
            : (e.httpClient ?? new $t()),
      },
      this,
    ...
    ((this._publisher = o),
      (this.ready = this.register(r).then(() => {})),
  ...
  closeAndFlush({ timeout: e = this._closeAndFlushDefaultTimeout } = {}) {
    return this.flush({ timeout: e, close: !0 });
  }
  async flush({ timeout: e, close: t = !1 } = {}) {
    ...
    return e ? it(r, e).catch(() => {}) : r;
  }
  _dispatch(e, t) {
    this._isClosed
      ? this.emit("call_after_close", e)
      : (this._pendingEvents++,
        Dt(e, this._queue, this, t)
          .catch((e) => e)
          .finally(() => {
            (this._pendingEvents--,
  ...
  alias(
    { userId: e, previousId: t, context: r, timestamp: o, integrations: n },
    i,
  ) {
    const a = this._eventFactory.alias(e, t, {
      context: r,
      integrations: n,
      timestamp: o,
    });
  ...
  group(
    ...
    const c = this._eventFactory.group(t, n, {
      context: i,
      anonymousId: o,
      userId: r,
      timestamp: e,
  ...
  identify(
    ...
    const s = this._eventFactory.identify(e, r, {
      context: o,
      anonymousId: t,
      userId: e,
      timestamp: n,
  ...
  page(
    ...
    const u = this._eventFactory.page(r ?? null, o ?? null, n, {
      context: i,
      anonymousId: t,
      userId: e,
      timestamp: a,
  ...
  screen(
    ...
    const u = this._eventFactory.screen(r ?? null, o ?? null, n, {
      context: i,
      anonymousId: t,
      userId: e,
      timestamp: a,
  ...
  track(
    ...
    const c = this._eventFactory.track(r, o, {
      context: n,
      userId: e,
      anonymousId: t,
      timestamp: i,
  ...
  register(...e) {
    return this._queue.criticalTasks.run(async () => {
      const t = At.system(),
        r = e.map((e) => this._queue.register(t, e, this));
      (await Promise.all(r),
        this.emit(
          "register",
          e.map((e) => e.name),
  ...
  async deregister(...e) {
    const t = At.system(),
      r = e.map((e) => {
        const r = this._queue.plugins.find((t) => t.name === e);
        if (r) return this._queue.deregister(t, r, this);
        t.log("warn", `plugin ${e} not found`);
      });
    (await Promise.all(r), this.emit("deregister", e));
  }
}
let Nt = null,
  Lt = null,
...
const Ft = async (e, t) => {
      ...
      try {
        const t = await (async () => {
            try {
              const t = await e();
              if (!t) return null;
              const r = `${n().apiBaseUrl}/api/oauth/profile`,
                o = await fetch(r, {
                  headers: {
  ...
  zt = async (e, t = {}) => {
    try {
      if ((Nt || (await Wt()), !Nt)) return;
      const r = await m(),
        o = chrome.runtime.getManifest().version,
        n = {
          anonymousId: r,
          event: e,
          properties: { ...t, extension_version: o },
        };
      (qt && (n.userId = qt), Nt.track(n));
    } catch (r) {}
  };
let Ht = null,
  Kt = !1,
...
async function nr() {
  ...
  return e.bridgeDeviceId
    ? ((Xt = e.bridgeDeviceId), Xt)
    : ((Xt = crypto.randomUUID()),
      await chrome.storage.local.set({ bridgeDeviceId: Xt }),
      Xt);
}
function ir() {
  (ar(),
    (Jt = setInterval(() => {
      Ht?.readyState === WebSocket.OPEN &&
        Ht.send(JSON.stringify({ type: "ping" }));
    }, 2e4)));
}
function ar() {
...
async function sr() {
  ...
  if (
    await (async function (e) {
      const t = Ke();
      return (await t.initialize(), t.isFeatureEnabledAsync(e));
...
async function cr() {
  if (Ht?.readyState === WebSocket.OPEN || Kt) return !1;
  Kt = !0;
  const t = await sr();
  if (!t) return ((Kt = !1), !1);
  const r = n().localBridge;
  let o, i;
  if (((i = await e()), !i)) return ((Kt = !1), pr(), !1);
  if (((o = await w()), !o)) return ((Kt = !1), pr(), !1);
  try {
    const e = await nr();
    Zt = e;
    const n = await er(),
      a = `${t}/chrome/${o}`;
    Ht && ((Ht.onclose = null), Ht.close());
    ...
    return (
      ...
      (s.onopen = () => {
        ...
        (r || (t.oauth_token = i), s.send(JSON.stringify(t)));
      }),
      (s.onmessage = async (e) => {
        if (Ht === s)
          try {
            ...
            await (async function (e) {
              switch (e.type) {
                case "paired":
                  (zt("claude_chrome.bridge.connected", { status: "paired" }),
                    ir(),
                    (Kt = !1),
                    (Vt = 0));
                  break;
                case "waiting":
                  (zt("claude_chrome.bridge.connected", { status: "waiting" }),
                    ir(),
                    (Kt = !1),
                    (Vt = 0));
                  break;
                ...
                case "pong":
                  break;
                case "peer_connected":
                  zt("claude_chrome.bridge.peer_connected");
                  break;
                case "peer_disconnected":
                  zt("claude_chrome.bridge.peer_disconnected");
                  break;
                case "tool_call":
                  await (async function (e) {
                    ...
                    const r = e.tool_use_id,
                      ...
                      a = e.permission_mode,
                      s = e.allowed_domains,
                      c = !0 === e.handle_permission_prompts;
                    if (!r || !o) return;
                    const u = i.tabId;
                    if (void 0 !== u)
                      try {
                        await chrome.tabs.get(u);
                      } catch {
                        return;
                      }
                    const l = { tool_name: o, client_type: n };
                    try {
                      const e = await Gr({
                        toolName: o,
                        args: i,
                        ...
                        allowedDomains: s,
                        toolUseId: r,
                        handlePermissionPrompts: c,
                      });
                      (zt("claude_chrome.bridge.tool_call", {
                        ...l,
                        success: !0,
                      }),
                        fr({ ...e, type: "tool_result", tool_use_id: r }));
                    } catch (d) {
                      (zt("claude_chrome.bridge.tool_call", {
                        ...l,
                        success: !1,
                ...
                case "permission_response":
                  !(function (e) {
                    ...
                    const r = rr.get(t);
                    if (!r) return;
                    (rr.delete(t), r.resolve(e.allowed ?? !1));
                  })(e);
                  break;
                case "error":
                  Kt = !1;
      ...
      (s.onclose = (e) => {
        (zt("claude_chrome.bridge.disconnected", {
          code: e.code,
          reason: e.reason,
          reconnect_attempt: Vt,
        }),
          Ht === s && (ar(), (Kt = !1), (Ht = null), hr(), pr()));
      }),
      (s.onerror = (e) => {
        (zt("claude_chrome.bridge.error", { error: String(e) }),
          Ht === s && (Kt = !1));
      }),
      !0
    );
...
function ur() {
  (Yt && (clearTimeout(Yt), (Yt = null)),
    ...
    (Kt = !1),
    hr(),
    Ht && ((Ht.onclose = null), Ht.close(), (Ht = null)));
}
function lr() {
  return Ht?.readyState === WebSocket.OPEN;
}
function dr(e, t) {
  return (
    !!lr() && (fr({ type: "notification", method: e, params: t || {} }), !0)
  );
}
function hr() {
  for (const [, e] of rr) e.resolve(!1);
  rr.clear();
}
function pr() {
  if (Yt) return;
  Vt++;
  const e = Math.min(2e3 * Math.pow(1.5, Vt - 1), 2e4);
  Yt = setTimeout(() => {
    ((Yt = null), cr());
  }, e);
}
function fr(e) {
  Ht?.readyState === WebSocket.OPEN && Ht.send(JSON.stringify(e));
}
let mr;
(chrome.alarms.create(tr, { periodInMinutes: 0.5 }),
  chrome.alarms.onAlarm.addListener((e) => {
    e.name === tr &&
      (cr(),
      Date.now() - Qt >= 18e5 &&
        ((Qt = Date.now()), b().then(({ isRefreshed: e }) => {})));
  }),
...
async function gr(e) {
  const { tabId: r, prompt: o, taskName: n, skipPermissions: i, model: a } = e,
...
const Ir = [
    ...
    Te,
    {
      ...
      execute: async (e) => {
        try {
          ...
          await J.initialize();
          const r = await J.getOrCreateMcpTabContext({ createIfEmpty: t });
          if (!r)
            return {
              output:
          ...
          const o = r.tabGroupId,
            n = r.availableTabs;
          return { output: B(n, o), tabContext: { ...r, tabGroupId: o } };
        } catch (t) {
          return {
    ...
    Ee,
    {
      ...
      execute: async () => {
        try {
          await J.initialize();
          const e = await J.getOrCreateMcpTabContext({ createIfEmpty: !1 });
          if (!e?.tabGroupId)
            return {
              error:
    ...
    },
    {
      ...
      execute: async (e, t) => {
        try {
          ...
          let i;
          if (r) i = await y.getPromptById(r);
          else if (o) {
            const e = o.startsWith("/") ? o.slice(1) : o;
            i = await y.getPromptByCommand(e);
          }
          if (!i)
            return {
          ...
          await y.recordPromptUsage(i.id);
  ...
  _r = ["tabs_context_mcp", "tabs_create_mcp"];
class kr {
  constructor(e) {
    this.context = e;
  }
  async handleToolCall(e, t, r, o, n, i, a, s) {
    const c = t.action;
    return await E(
      `tool_execution_${e}${c ? "_" + c : ""}`,
      async (i) => {
        if (!this.context.tabId && !_r.includes(e))
        ...
        if (("computer" === e && c && (d.action = c), n && (d.domain = n), a)) {
          const e = vr(a);
          e && (d.app = e);
        }
        try {
          const r = me(e, t, Ir),
            o = await l.execute(r, u);
          return (
            "type" in o
              ? ((d.success = !1),
                i.setAttribute("success", !1),
                i.setAttribute("failure_reason", "needs_permission"))
              : ((d.success = !o.error), i.setAttribute("success", !o.error)),
            "type" in o ||
              o.error ||
              !u.tabId ||
            ...
            this.context.analytics?.track("claude_chrome.chat.tool_called", d),
            o
          );
        } catch (h) {
          throw (
  ...
  createAnthropicMessage() {
    if (this.context.anthropicClient || this.context.refreshClient)
      return async (e) => {
        ...
        let n = this.context.model;
        if ("small_fast" === t) {
          const e = await Ye("chrome_ext_models");
          n = e?.small_fast_model || "claude-haiku-4-5-20251001";
        }
  ...
  async processToolResults(e, t) {
    ...
    for (const a of e)
      try {
        const e = await this.handleToolCall(
          a.name,
          a.input,
          a.id,
          void 0,
        ...
        if ("type" in e && "permission_required" === e.type) {
          ...
          if (!(await o(e, this.context.tabId))) {
            r.push(
              n(a.id, {
                error:
                  "update_plan" === a.name
          ...
          if ("type" in s && "permission_required" === s.type)
            throw new Error("Permission still required after granting");
          r.push(n(a.id, s));
        } else r.push(n(a.id, e));
      } catch (i) {
        r.push(
          n(a.id, { error: i instanceof Error ? i.message : "Unknown error" }),
        );
      }
    return r;
  }
}
let Tr, Er, xr, Cr, Sr, Ar;
const Dr = 6e4;
async function Mr() {
  const [e, r] = await Promise.all([
    _(t.SELECTED_MODEL),
    Ye("chrome_ext_models"),
  ]);
  return e || r?.default || "claude-3-5-sonnet-20241022";
}
async function Rr(e, t) {
  if (Cr) return ((Cr.context.tabId = e), (Cr.context.tabGroupId = t), Cr);
  const [r, o] = await Promise.all([Ur(), Mr()]);
  return (
    (Cr = new kr({
      anthropicClient: r,
      permissionManager: new x(() => !1, {}),
      sessionId: ke,
      tabId: e,
      tabGroupId: t,
      model: o,
      onPermissionRequired: async (e, t) => await Wr(e, t),
      refreshClient: Ur,
    })),
    Cr
  );
...
async function Ur() {
  const [t, { anthropicApiKey: r }] = await Promise.all([
      e(),
      chrome.storage.local.get("anthropicApiKey"),
    ]),
    o = r || void 0;
  if (((Er !== t || xr !== o) && ((Tr = void 0), (Er = t), (xr = o)), Tr))
    return Tr;
  if (!t && !o) return;
  const i = n();
  return (
    (Tr = new T({
      ...
      ...(t ? { authToken: t } : { apiKey: o }),
    })),
    Tr
  );
}
const Pr = (e) => ({ content: [{ type: "text", text: e }], is_error: !0 });
async function Gr(e) {
  ...
  if (Sr && Ar) {
    if (Date.now() - Ar < Dr) {
      ...
      return (
        (Sr = void 0),
        (Ar = void 0),
        zt("claude_chrome.mcp.tool_called", {
  ...
  let i, a, s, c;
  try {
    const t = await J.getTabForMcp(e.tabId, e.tabGroupId);
    ((i = t.tabId), (a = t.domain), (s = t.url));
  } catch {
    return (
      zt("claude_chrome.mcp.tool_called", {
        tool_name: e.toolName,
      ...
      Pr("No tabs available. Please open a new tab or window in Chrome.")
    );
  }
  if (void 0 !== i)
    try {
      const e = await ee.isDebuggerAttached(i);
      (await ee.attachDebugger(i),
  ...
  try {
    void 0 !== i &&
      (await (async function (e, t, r, o) {
        if (
          ...
          await J.addTabToIndicatorGroup({
            tabId: e,
            isRunning: !0,
            isMcp: !0,
          }),
          ...
          const t = $r.get(e);
          (t && clearTimeout(t),
            J.addLoadingPrefix(e).catch(() => {}),
            $r.set(e, null));
        } else (J.addLoadingPrefix(e).catch(() => {}), $r.set(e, null));
      })(i, e.toolName, t, (e) => {
        ((Sr = e), (Ar = Date.now()));
      }));
    const r = await Rr(i, e.tabGroupId),
      o = {};
    if ("bridge" === e.source) {
    ...
    ((l = !0),
      ...
      (h.message.includes("401") ||
        h.message.includes("authentication") ||
        h.message.includes("invalid x-api-key"))
        ? ((Tr = void 0),
          (Er = void 0),
          (xr = void 0),
        ...
        : ((u = "execution_error"),
          (c = Pr(h instanceof Error ? h.message : String(h)))));
  }
  void 0 !== i && Nr(i, r);
  const d = s ? vr(s) : void 0;
  return (
    zt("claude_chrome.mcp.tool_called", {
      tool_name: e.toolName,
      client_id: r,
...
function Nr(e, t) {
  if (Br.has(e)) {
    ...
    const t = setTimeout(async () => {
      if (!Br.has(e) && $r.has(e)) {
        (J.addCompletionPrefix(e).catch(() => {}), $r.set(e, null));
        try {
          await ee.detachDebugger(e);
        } catch (t) {}
      }
    }, Or);
    $r.set(e, t);
...
function Lr(e) {
  const t = $r.get(e);
  (t && clearTimeout(t), $r.delete(e), J.removePrefix(e).catch(() => {}));
}
async function qr() {
  try {
    const e = await J.getAllGroups();
    for (const t of e) Lr(t.mainTabId);
  } catch (e) {}
}
let Fr = Promise.resolve(!0);
async function Wr(e, t) {
  const r = Fr.then(() =>
    (async function (e, t) {
      ...
      n && clearTimeout(n);
      return (
        await J.addPermissionPrefix(t),
        $r.set(t, null),
        await chrome.storage.local.set({
          [`mcp_prompt_${r}`]: { prompt: e, tabId: t, timestamp: Date.now() },
        }),
        zt("claude_chrome.permission.prompted", {
        ...
        new Promise((n) => {
          ...
          const s = async (s = !1) => {
              a ||
                ...
                zt("claude_chrome.permission.responded", {
                  permission_type: e.type,
                  tool_type: e.tool,
                  tab_id: t,
                  allowed: s,
  ...
  return ((Fr = r.catch(() => !1)), r);
}
chrome.webNavigation.onBeforeNavigate.addListener(async (e) => {
  if (0 !== e.frameId || ((t = e.tabId), !Br.has(t))) return;
  var t;
  const r = Br.get(e.tabId);
  if (!r) return;
  const { isMainTab: o, isSecondaryTab: n } = await Oe(e.tabId, e.tabId);
  if (!o && !n) return;
  (await Rr(e.tabId)).context.permissionManager;
  try {
    const t = await Fe(e.tabId, e.url);
    if ("category1" === t) {
      const t = We(e.url);
      return (
