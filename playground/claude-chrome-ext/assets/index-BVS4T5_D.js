      ...
      (i.exports = (function () {
        ...
        function r(t, r, n) {
          ...
          if (
            ...
            for (var u in ((n = {}), r)) "key" !== u && (n[u] = r[u]);
          else n = r;
          return (
            (r = n.ref),
            {
...
function d() {
  ...
  ((g.constructor = S), b(g, _.prototype), (g.isPureReactComponent = !0));
  var E = Array.isArray;
  function j() {}
  ...
  function $(r, n, o, u, i) {
    ...
    if (E(r))
      ...
      "function" ==
      typeof (h =
        null === (p = r) || "object" != typeof p
          ? null
          : "function" == typeof (p = (d && p[d]) || p["@@iterator"])
            ? p
            : null)
    )
      for (r = h.call(r), h = 0; !(u = r.next()).done; )
...
function h() {
  return (s || ((s = 1), (p.exports = d())), p.exports);
}
var b = h();
const v = r(b),
  _ = e({ __proto__: null, default: v }, [b]);
export {
  v as R,
  h as a,
  c as b,
