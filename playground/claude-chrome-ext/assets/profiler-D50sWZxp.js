...
function h(t, e, n) {
  ...
  const { ids: a, names: o } = (function (t) {
    const e = { ids: [], names: [] };
    for (const n of t)
      (e.ids.push(n.viewId), n.viewName && e.names.push(n.viewName));
...
function y(a, o, w, h, y, I, S, j = k) {
  const M = (function (a, o, r, i) {
    const c = t([a.profilingEndpointBuilder], (t) => {
        (o.notify(14, { error: t }),
          s("Error reported to customer", { "error.message": t.message }));
      }),
      u = r(i);
    return {
  ...
  function P() {
    ...
    ((T = t
      ...
      : void 0),
      C.push(
        i(a, window, "visibilitychange", B).stop,
        i(a, window, "beforeunload", z).stop,
      ),
      D());
  }
  async function _(t) {
  ...
  function D() {
    ...
    try {
      n = new t({
        ...
        maxBufferSize: Math.round(
          (1.5 * j.collectIntervalMs) / j.sampleIntervalMs,
        ),
      });
    } catch (s) {
      return void (s instanceof Error &&
    ...
    (h.set({ status: "running", error_reason: void 0 }),
      (E = {
        ...
        startClocks: d(),
        profiler: n,
        timeoutId: l(D, j.collectIntervalMs),
        views: [],
        cleanupTasks: e,
        longTasks: [],
      }),
  ...
  async function x(t) {
    ...
    (p(t.timeoutId), t.profiler.removeEventListener("samplebufferfull", R));
      ...
      .then((t) => {
        ...
        (0 === o.length && (r || i)) ||
          (function (t) {
            var e;
            const n =
                null === (e = w.findTrackedSession()) || void 0 === e
                  ? void 0
                  : e.id,
              s = b(t, a, n);
            M.send(s);
  ...
  function B() {
    "hidden" === document.visibilityState && "running" === E.state
      ...
      : "visible" === document.visibilityState && "paused" === E.state && D();
  }
  function z() {
    D();
  }
  return (
    o.subscribe(9, () => {
      _("session-expired").catch(r);
    }),
    o.subscribe(10, () => {
      "stopped" === E.state && "session-expired" === E.stateReason && P();
    }),
    {
      start: P,
      stop: async function () {
        await _("stopped-by-user");
      },
      isStopped: function () {
