...
import { u as w, M as b } from "./index-D6M7XaCF.js";
import {
  b as C,
  g as M,
  S as k,
...
const A = new Map([
  ...
  D = e.forwardRef((t, s) => e.createElement(a, { ref: s, ...t, weights: A }));
D.displayName = "ListBulletsIcon";
const E = D,
  N = e.forwardRef((t, s) => e.createElement(a, { ref: s, ...t, weights: S }));
N.displayName = "PlusIcon";
const H = N;
function Z({ toast: a, onClose: o }) {
  ...
  return t.jsxs("div", {
    ...
    style: { animation: r ? void 0 : "toast-slide-in 0.3s ease-out" },
    children: [
      "success" === a.type &&
        t.jsx(n, {
          size: 16,
      ...
      t.jsx("button", {
        ...
        children: t.jsx(i, { size: 14, className: "text-text-300" }),
      }),
    ],
  });
}
  ...
  return (
    ...
    0 === a.length
      ...
      : t.jsx("div", {
          ...
          children: a.map((e) => t.jsx(Z, { toast: e, onClose: i }, e.id)),
        })
  );
}
function L() {
...
function F({
  ...
  const d = w(),
    ...
    { showToast: N } = L(),
    Z = async () => {
      const e = await C.getAllPrompts();
      h(e.sort((e, t) => t.createdAt - e.createdAt));
    },
    F = m.filter((e) => e.repeatType && "none" !== e.repeatType),
    I = m.filter((e) => !e.repeatType || "none" === e.repeatType),
    z = (e) => {
      ...
      switch (e.repeatType) {
        case "once":
          if (e.specificDate) {
            const [t, a, i] = e.specificDate.split("-").map(Number);
            return `${s[a - 1]} ${i}, ${t}${n}`;
          }
          return `Once${n}`;
        case "daily":
  ...
  e.useEffect(() => {
    Z();
    (async () => {
      const e = await M(k.PENDING_SCHEDULED_TASK);
      if (e) {
        ...
        (A({
          ...
          D(!0),
          await j(k.PENDING_SCHEDULED_TASK));
      }
    })();
  }, [A, D]);
  const V = async (e) => {
                    ...
                    t.jsxs("div", {
                      children: [
                        t.jsxs("div", {
                          ...
                          children: [
                            t.jsx(r, { size: 16, className: "text-text-300" }),
                            t.jsx("h4", {
...
function O({ prompt: e, scheduleText: a, onEdit: s, onDelete: n }) {
  return t.jsxs("div", {
    onClick: s,
    className:
    ...
    children: [
      ...
      a &&
        t.jsx("div", {
          ...
          children: t.jsx("div", {
            className: "text-text-300",
            children: t.jsx("span", { className: "text-xs", children: a }),
          }),
        }),
    ],
  });
}
function _({ prompt: a, onClose: s, onSave: n }) {
  const i = w(),
    [r, l] = e.useState(a?.command || ""),
    [c, d] = e.useState(a?.prompt || ""),
    [m, h] = e.useState(""),
    [M, k] = e.useState(""),
    [j, A] = e.useState(!1),
    S = !a?.id,
    D = e.useRef(null),
    [E, N] = e.useState(Boolean(a?.repeatType && "none" !== a.repeatType)),
    [H, Z] = e.useState(
      a?.repeatType && "none" !== a.repeatType ? a.repeatType : "once",
    ),
    [T, L] = e.useState(a?.specificTime || "09:00"),
    [F, O] = e.useState(a?.dayOfWeek ?? 0),
    [_, I] = e.useState(a?.dayOfMonth || 1),
    [z, V] = e.useState(
    ...
    [R, $] = e.useState(a?.specificDate || ""),
    [P, U] = e.useState(a?.url || ""),
    G = p(),
    [q, K] = e.useState(a?.model || G.default || "claude-sonnet-4-5-20250929");
  (e.useEffect(() => {
    (setTimeout(() => {
      D.current?.focus();
    }, 100),
        ...
        if (a && !S) {
          ...
          (E
            ? ((e.repeatType = H),
              (e.specificTime = T),
              (e.model = q),
              "once" === H && (e.specificDate = R),
              "weekly" === H && (e.dayOfWeek = F),
              "monthly" === H && (e.dayOfMonth = _),
              "annually" === H &&
                (e.monthAndDay = `${z.toString().padStart(2, "0")}-${B.toString().padStart(2, "0")}`))
            : ((e.repeatType = void 0),
          ...
          (E &&
            ...
            "annually" === H &&
              (e.monthAndDay = `${z.toString().padStart(2, "0")}-${B.toString().padStart(2, "0")}`)),
            await C.savePrompt(e));
        }
        n(!(!a || S));
      } catch (e) {
        h(e instanceof Error ? e.message : "Failed to save");
      }
    }
  };
  return t.jsxs(u, {
    ...
    title:
      a && !S
        ? i.formatMessage({ defaultMessage: "Edit shortcut", id: "R592aOW18A" })
        : i.formatMessage({
            defaultMessage: "Create shortcut",
            id: "AzO4h7b149",
          }),
      ...
      t.jsxs("div", {
        ...
        children: [
          t.jsxs("div", {
            children: [
              ...
              t.jsx(f, {
                ...
                prepend: t.jsx("span", {
                  className: "text-text-300",
                  children: t.jsx(b, { defaultMessage: "/", id: "XIbwNE7SSU" }),
                }),
                ...
                error: (j && !r.trim()) || m?.includes("already in use"),
              }),
              ((j && !r.trim()) || m?.includes("already in use")) &&
                t.jsx(g, {
                  className: "mt-1",
                  children:
                    j && !r.trim()
          ...
          m &&
            ...
            t.jsx("div", { className: "text-danger-000 text-sm", children: m }),
        ],
      }),
      t.jsxs(v, {
        children: [
          t.jsx(o, {
            onClick: s,
            variant: "secondary",
            children: t.jsx(b, { defaultMessage: "Cancel", id: "47FYwba+bI" }),
          }),
          t.jsx(o, {
            onClick: Y,
            children:
              a && !S
                ? t.jsx(b, { defaultMessage: "Save changes", id: "X0ha1a+WYV" })
                : t.jsx(b, {
                    defaultMessage: "Create shortcut",
                    id: "AzO4h7b149",
                  }),
...
export { F as T, T as a, H as n, L as u };
