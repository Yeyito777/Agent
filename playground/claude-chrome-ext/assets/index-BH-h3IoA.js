    ...
    return n(this, function (n) {
      switch (n.label) {
        case 0:
          ((t = _(s)),
            ...
            (d = ""
              ...
              .concat(null != c ? c : t, "/")
              .concat(a, "/")
              .concat(null != c ? c : t, ".dynamic.js.gz")),
            (n.label = 1));
        case 1:
          return (n.trys.push([1, 3, , 4]), [4, r(d)]);
        case 2:
          return (
            n.sent(),
            (function (t, n, e) {
                      ...
                      null ===
                        (r =
                          null === window || void 0 === window
                            ? void 0
                            : window.performance) || void 0 === r
                        ? void 0
                        : r.getEntriesByName(t, "resource")) && void 0 !== o
                    ? o
                    : []
                )[0];
                s &&
        ...
        case 5:
          return (
            n.sent(),
            window["".concat(t, "Loader")](),
            [2, window["".concat(t, "Integration")]]
          );
      }
    });
  });
                    ...
                    function () {
                      return t(o, void 0, void 0, function () {
                        ...
                        return n(this, function (n) {
                          switch (n.label) {
                            case 0:
                              return (t = e.pop()) ? [4, w(t, i)] : [2];
                            case 1:
                              return (
                                (o = n.sent()),
                                o instanceof b || r.push(t),
                                [2]
                              );
                          }
                        });
  ...
  function i(t, n, i, r, o, s) {
    ...
    ((this.options = {}),
      ...
      (this.buffer = o.disableClientPersistence
        ? new g(4, [])
        : new m(4, "".concat(i, ":dest-").concat(t))),
      this.scheduleFlush());
  }
  return (
    ...
    (i.prototype.load = function (i, e) {
      ...
      return t(this, void 0, void 0, function () {
        ...
        return n(this, function (n) {
          switch (n.label) {
            case 0:
              return this._ready || void 0 !== this.onReady
                ? [2]
                : null === (r = this.integrationSource) || void 0 === r
                  ? [3, 1]
                  : ((o = r), [3, 3]);
            case 1:
    ...
    (i.prototype.unload = function (i, e) {
        ...
        return t(this, void 0, void 0, function () {
          ...
          return n(this, function (n) {
            return (
              ...
              (u = P(i, r)),
              (c = ""
                .concat(t, "/integrations/")
                .concat(null != u ? u : a, "/")
                .concat(e, "/")
                .concat(null != u ? u : a, ".dynamic.js.gz")),
              [2, s(c)]
            );
          });
        });
    ...
    (i.prototype.shouldBuffer = function (t) {
      return (
        "page" !== t.event.type &&
        (u() || !0 !== this._ready || !0 !== this._initialized)
      );
    }),
    (i.prototype.send = function (i, r, o) {
      var s, u;
      return t(this, void 0, void 0, function () {
        var t, d, h, v, f, p;
        return n(this, function (n) {
          switch (n.label) {
            case 0:
              return this.shouldBuffer(i)
                ? (this.buffer.push(i), this.scheduleFlush(), [2, i])
                : ((t =
                    null ===
                      (u =
                  ...
                  t &&
                    ...
                    S(t, h)
                      ? i.updateEvent(
                          "integrations",
                          e(
                            e({}, i.event.integrations),
                            null == h ? void 0 : h.integrations,
                          ),
                        )
                      : (i.updateEvent(
                          "integrations",
                          e(e({}, i.event.integrations), {
                            All: !1,
                            "Segment.io": !0,
                          }),
                        ),
                        i.cancel(
                          new c({
                            retry: !1,
                            reason: "Event "
                              .concat(d, " disabled for integration ")
                              .concat(this.name, " in tracking plan"),
                            type: "Dropped by plan",
                          }),
                        )),
                    (null == h ? void 0 : h.enabled) &&
                      !1 === (null == h ? void 0 : h.integrations[this.name]) &&
                      i.cancel(
                        new c({
                          retry: !1,
                          reason: "Event "
                  ...
                  [4, l(this.name, i.event, this.middleware)]);
            case 1:
              if (null === (v = n.sent())) return [2, i];
              ((f = new r(v, { traverse: !this.disableAutoISOConversion })),
                a(i, {
                  integrationName: this.name,
                  methodName: o,
                  type: "classic",
            ...
            case 2:
              return (
                n.trys.push([2, 5, , 6]),
                this.integration
                  ? [4, this.integration.invoke.call(this.integration, o, f)]
                  : [3, 4]
              );
            case 3:
              (n.sent(), (n.label = 4));
      ...
      return t(this, void 0, void 0, function () {
        return n(this, function (t) {
          switch (t.label) {
            case 0:
              return (
                (null === (e = this.integration) || void 0 === e
                  ? void 0
                  : e._assumesPageview) &&
                  !this._initialized &&
                  this.integration.initialize(),
            ...
            case 1:
              return (t.sent(), [2, this.send(i, d.Page, "page")]);
          }
        });
      });
    }),
        ...
        setTimeout(function () {
          return t(i, void 0, void 0, function () {
            ...
            return n(this, function (n) {
              switch (n.label) {
                case 0:
                  return u() || !0 !== this._ready || !0 !== this._initialized
                    ? (this.scheduleFlush(), [2])
                    : ((this.flushing = !0),
                      (t = this),
                      [4, k(this, this.buffer)]);
                case 1:
                  return (
                    (t.buffer = n.sent()),
                    (this.flushing = !1),
...
function j(t, n, r, o, s, a) {
  var u, c;
  if ((void 0 === r && (r = {}), void 0 === o && (o = {}), h())) return [];
  n.plan && ((o = null != o ? o : {}).plan = n.plan);
  var l =
      null !==
        (c =
          null === (u = n.middlewareSettings) || void 0 === u
            ? void 0
            : u.routingRules) && void 0 !== c
        ? c
        : [],
    d = n.integrations,
    p = o.integrations,
      ...
      null == a
        ...
        : a.reduce(function (t, n) {
            ...
            return e(
              ...
              (((i = {})[
                (function (t) {
                  return ("Integration" in t ? t.Integration : t).prototype
                    .name;
                })(n)
              ] = n),
              i),
    ...
    y = new Set(
      i(
        ...
        Object.keys(m || {}).filter(function (t) {
          return f(d[t]) || f(null == p ? void 0 : p[t]);
        }),
        !0,
      ),
    );
      ...
      var i = (function (t) {
          ...
          return null !==
            (r =
              null !==
                (i =
                  null === (n = null == t ? void 0 : t.versionSettings) ||
                  void 0 === n
                    ? void 0
                    : n.override) && void 0 !== i
                ? i
                : null === (e = null == t ? void 0 : t.versionSettings) ||
                    void 0 === e
                  ? void 0
                  : e.version) && void 0 !== r
            ? r
        ...
        e = new N(n, i, t, g[n], o, null == m ? void 0 : m[n]);
      return (
        l.filter(function (t) {
